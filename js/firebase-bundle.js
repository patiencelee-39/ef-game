...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */(e,(e,i)=>{To(i,new lr(t.toString()+"/"+e),n)})}class Io{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Os(this.last_,(e,n)=>{t[e]=t[e]-n}),this.last_=e,t}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class bo{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Io(e);const n=1e4+2e4*Math.random();Vs(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Os(e,(e,i)=>{i>0&&P(this.statsToReport_,e)&&(t[e]=i,n=!0)}),n&&this.server_.reportStats(t),Vs(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */var Co,Eo;function So(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */(Eo=Co||(Co={}))[Eo.OVERWRITE=0]="OVERWRITE",Eo[Eo.MERGE=1]="MERGE",Eo[Eo.ACK_USER_WRITE=2]="ACK_USER_WRITE",Eo[Eo.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class ko{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Co.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(e){if(vr(this.path)){if(null!=this.affectedTree.value)return n(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new lr(e));return new ko(ur(),t,this.revert)}}return n(dr(this.path)===e,"operationForChild called for unrelated child."),new ko(pr(this.path),this.affectedTree,this.revert)}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class No{constructor(e,t){this.source=e,this.path=t,this.type=Co.LISTEN_COMPLETE}operationForChild(e){return vr(this.path)?new No(this.source,ur()):new No(this.source,pr(this.path))}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Ao{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Co.OVERWRITE}operationForChild(e){return vr(this.path)?new Ao(this.source,ur(),this.snap.getImmediateChild(e)):new Ao(this.source,pr(this.path),this.snap)}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Ro{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Co.MERGE}operationForChild(e){if(vr(this.path)){const t=this.children.subtree(new lr(e));return t.isEmpty()?null:t.value?new Ao(this.source,ur(),t.value):new Ro(this.source,ur(),t)}return n(dr(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ro(this.source,pr(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Do{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function xo(e,t,n,s,r,o){const a=s.filter(e=>e.type===n);a.sort((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw i("Should only compare child_ events.");const s=new Rr(t.childName,t.snapshotNode),r=new Rr(n.childName,n.snapshotNode);return e.index_.compare(s,r)}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */(e,t,n)),a.forEach(n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,o);r.forEach(s=>{s.respondsTo(n.type)&&t.push(s.createEvent(i,e.query_))})})}function Oo(e,t){return{eventCache:e,serverCache:t}}function Lo(e,t,n,i){return Oo(new Po(t,n,i),e.serverCache)}function Mo(e,t,n,i){return Oo(e.eventCache,new Po(t,n,i))}function Fo(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Uo(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */let Vo;class qo{constructor(e,t=(()=>(Vo||(Vo=new Ur(Rs)),Vo))()){this.value=e,this.children=t}static fromObject(e){let t=new qo(null);return Os(e,(e,n)=>{t=t.set(new lr(e),n)}),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:ur(),value:this.value};if(vr(e))return null;{const n=dr(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(pr(e),t);if(null!=s){return{path:yr(new lr(n),s.path),value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(vr(e))return this;{const t=dr(e),n=this.children.get(t);return null!==n?n.subtree(pr(e)):new qo(null)}}set(e,t){if(vr(e))return new qo(t,this.children);{const n=dr(e),i=(this.children.get(n)||new qo(null)).set(pr(e),t),s=this.children.insert(n,i);return new qo(this.value,s)}}remove(e){if(vr(e))return this.children.isEmpty()?new qo(null):new qo(null,this.children);{const t=dr(e),n=this.children.get(t);if(n){const i=n.remove(pr(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new qo(null):new qo(this.value,s)}return this}}get(e){if(vr(e))return this.value;{const t=dr(e),n=this.children.get(t);return n?n.get(pr(e)):null}}setTree(e,t){if(vr(e))return t;{const n=dr(e),i=(this.children.get(n)||new qo(null)).setTree(pr(e),t);let s;return s=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new qo(this.value,s)}}fold(e){return this.fold_(ur(),e)}fold_(e,t){const n={};return this.children.inorderTraversal((i,s)=>{n[i]=s.fold_(yr(e,i),t)}),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,ur(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(vr(e))return null;{const i=dr(e),s=this.children.get(i);return s?s.findOnPath_(pr(e),yr(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,ur(),t)}foreachOnPath_(e,t,n){if(vr(e))return this;{this.value&&n(t,this.value);const i=dr(e),s=this.children.get(i);return s?s.foreachOnPath_(pr(e),yr(t,i),n):new qo(null)}}foreach(e){this.foreach_(ur(),e)}foreach_(e,t){this.children.inorderTraversal((n,i)=>{i.foreach_(yr(e,n),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,n)=>{n.value&&e(t,n.value)})}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class jo{constructor(e){this.writeTree_=e}static empty(){return new jo(new qo(null))}}function Bo(e,t,n){if(vr(t))return new jo(new qo(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const s=i.path;let r=i.value;const o=wr(s,t);return r=r.updateChild(o,n),new jo(e.writeTree_.set(s,r))}{const i=new qo(n),s=e.writeTree_.setTree(t,i);return new jo(s)}}}function zo(e,t,n){let i=e;return Os(n,(e,n)=>{i=Bo(i,yr(t,e),n)}),i}function $o(e,t){if(vr(t))return jo.empty();{const n=e.writeTree_.setTree(t,new qo(null));return new jo(n)}}function Wo(e,t){return null!=Ho(e,t)}function Ho(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(wr(n.path,t)):null}function Ko(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Kr,(e,n)=>{t.push(new Rr(e,n))}):e.writeTree_.children.inorderTraversal((e,n)=>{null!=n.value&&t.push(new Rr(e,n.value))}),t}function Go(e,t){if(vr(t))return e;{const n=Ho(e,t);return new jo(null!=n?new qo(n):e.writeTree_.subtree(t))}}function Qo(e){return e.writeTree_.isEmpty()}function Yo(e,t){return Jo(ur(),e.writeTree_,t)}function Jo(e,t,i){if(null!=t.value)return i.updateChild(e,t.value);{let s=null;return t.children.inorderTraversal((t,r)=>{".priority"===t?(n(null!==r.value,"Priority writes must always be leaf nodes"),s=r.value):i=Jo(yr(e,t),r,i)}),i.getChild(e).isEmpty()||null===s||(i=i.updateChild(yr(e,".priority"),s)),i}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function Xo(e,t){return ua(t,e)}function Zo(e,t){const i=e.allWrites.findIndex(e=>e.writeId===t);n(i>=0,"removeWrite called with nonexistent writeId.");const s=e.allWrites[i];e.allWrites.splice(i,1);let r=s.visible,o=!1,a=e.allWrites.length-1;for(;r&&a>=0;){const t=e.allWrites[a];t.visible&&(a>=i&&ea(t,s.path)?r=!1:br(s.path,t.path)&&(o=!0)),a--}if(r){if(o)return function(e){e.visibleWrites=na(e.allWrites,ta,ur()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(s.snap)e.visibleWrites=$o(e.visibleWrites,s.path);else{Os(s.children,t=>{e.visibleWrites=$o(e.visibleWrites,yr(s.path,t))})}return!0}return!1}function ea(e,t){if(e.snap)return br(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&br(yr(e.path,n),t))return!0;return!1}function ta(e){return e.visible}function na(e,t,n){let s=jo.empty();for(let r=0;r<e.length;++r){const o=e[r];if(t(o)){const e=o.path;let t;if(o.snap)br(n,e)?(t=wr(n,e),s=Bo(s,t,o.snap)):br(e,n)&&(t=wr(e,n),s=Bo(s,ur(),o.snap.getChild(t)));else{if(!o.children)throw i("WriteRecord should have .snap or .children");if(br(n,e))t=wr(n,e),s=zo(s,t,o.children);else if(br(e,n))if(t=wr(e,n),vr(t))s=zo(s,ur(),o.children);else{const e=D(o.children,dr(t));if(e){const n=e.getChild(pr(t));s=Bo(s,ur(),n)}}}}}return s}function ia(e,t,n,i,s){if(i||s){const r=Go(e.visibleWrites,t);if(!s&&Qo(r))return n;if(s||null!=n||Wo(r,ur())){const r=function(e){return(e.visible||s)&&(!i||!~i.indexOf(e.writeId))&&(br(e.path,t)||br(t,e.path))};return Yo(na(e.allWrites,r,t),n||to.EMPTY_NODE)}return null}{const i=Ho(e.visibleWrites,t);if(null!=i)return i;{const i=Go(e.visibleWrites,t);if(Qo(i))return n;if(null!=n||Wo(i,ur())){return Yo(i,n||to.EMPTY_NODE)}return null}}}function sa(e,t,n,i){return ia(e.writeTree,e.treePath,t,n,i)}function ra(e,t){return function(e,t,n){let i=to.EMPTY_NODE;const s=Ho(e.visibleWrites,t);if(s)return s.isLeafNode()||s.forEachChild(Kr,(e,t)=>{i=i.updateImmediateChild(e,t)}),i;if(n){const s=Go(e.visibleWrites,t);return n.forEachChild(Kr,(e,t)=>{const n=Yo(Go(s,new lr(e)),t);i=i.updateImmediateChild(e,n)}),Ko(s).forEach(e=>{i=i.updateImmediateChild(e.name,e.node)}),i}return Ko(Go(e.visibleWrites,t)).forEach(e=>{i=i.updateImmediateChild(e.name,e.node)}),i}(e.writeTree,e.treePath,t)}function oa(e,t,i,s){return function(e,t,i,s,r){n(s||r,"Either existingEventSnap or existingServerSnap must exist");const o=yr(t,i);if(Wo(e.visibleWrites,o))return null;{const t=Go(e.visibleWrites,o);return Qo(t)?r.getChild(i):Yo(t,r.getChild(i))}}(e.writeTree,e.treePath,t,i,s)}function aa(e,t){return function(e,t){return Ho(e.visibleWrites,t)}(e.writeTree,yr(e.treePath,t))}function ca(e,t,n,i,s,r){return function(e,t,n,i,s,r,o){let a;const c=Go(e.visibleWrites,t),h=Ho(c,ur());if(null!=h)a=h;else{if(null==n)return[];a=Yo(c,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let c=n.getNext();for(;c&&e.length<s;)0!==t(c,i)&&e.push(c),c=n.getNext();return e}}(e.writeTree,e.treePath,t,n,i,s,r)}function ha(e,t,n){return function(e,t,n,i){const s=yr(t,n),r=Ho(e.visibleWrites,s);if(null!=r)return r;if(i.isCompleteForChild(n))return Yo(Go(e.visibleWrites,s),i.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function la(e,t){return ua(yr(e.treePath,t),e.writeTree)}function ua(e,t){return{treePath:e,writeTree:t}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const fa=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class pa{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Po(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ha(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Uo(this.viewCache_),s=ca(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function ga(e,t,s,r,o){const a=new da;let c,h;if(s.type===Co.OVERWRITE){const i=s;i.source.fromUser?c=ya(e,t,i.path,i.snap,r,o,a):(n(i.source.fromServer,"Unknown source."),h=i.source.tagged||t.serverCache.isFiltered()&&!vr(i.path),c=_a(e,t,i.path,i.snap,r,o,h,a))}else if(s.type===Co.MERGE){const i=s;i.source.fromUser?c=function(e,t,n,i,s,r,o){let a=t;return i.foreach((i,c)=>{const h=yr(n,i);va(t,dr(h))&&(a=ya(e,a,h,c,s,r,o))}),i.foreach((i,c)=>{const h=yr(n,i);va(t,dr(h))||(a=ya(e,a,h,c,s,r,o))}),a}(e,t,i.path,i.children,r,o,a):(n(i.source.fromServer,"Unknown source."),h=i.source.tagged||t.serverCache.isFiltered(),c=Ta(e,t,i.path,i.children,r,o,h,a))}else if(s.type===Co.ACK_USER_WRITE){const i=s;c=i.revert?function(e,t,i,s,r,o){let a;if(null!=aa(s,i))return t;{const c=new pa(s,t,r),h=t.eventCache.getNode();let l;if(vr(i)||".priority"===dr(i)){let i;if(t.serverCache.isFullyInitialized())i=sa(s,Uo(t));else{const e=t.serverCache.getNode();n(e instanceof to,"serverChildren would be complete if leaf node"),i=ra(s,e)}l=e.filter.updateFullNode(h,i,o)}else{const n=dr(i);let r=ha(s,n,t.serverCache);null==r&&t.serverCache.isCompleteForChild(n)&&(r=h.getImmediateChild(n)),l=null!=r?e.filter.updateChild(h,n,r,pr(i),c,o):t.eventCache.getNode().hasChild(n)?e.filter.updateChild(h,n,to.EMPTY_NODE,pr(i),c,o):h,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=sa(s,Uo(t)),a.isLeafNode()&&(l=e.filter.updateFullNode(l,a,o)))}return a=t.serverCache.isFullyInitialized()||null!=aa(s,ur()),Lo(t,l,a,e.filter.filtersNodes())}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */(e,t,i.path,r,o,a):function(e,t,n,i,s,r,o){if(null!=aa(s,n))return t;const a=t.serverCache.isFiltered(),c=t.serverCache;if(null!=i.value){if(vr(n)&&c.isFullyInitialized()||c.isCompleteForPath(n))return _a(e,t,n,c.getNode().getChild(n),s,r,a,o);if(vr(n)){let i=new qo(null);return c.getNode().forEachChild(Or,(e,t)=>{i=i.set(new lr(e),t)}),Ta(e,t,n,i,s,r,a,o)}return t}{let h=new qo(null);return i.foreach((e,t)=>{const i=yr(n,e);c.isCompleteForPath(i)&&(h=h.set(e,c.getNode().getChild(i)))}),Ta(e,t,n,h,s,r,a,o)}}(e,t,i.path,i.affectedTree,r,o,a)}else{if(s.type!==Co.LISTEN_COMPLETE)throw i("Unknown operation type: "+s.type);c=function(e,t,n,i,s){const r=t.serverCache,o=Mo(t,r.getNode(),r.isFullyInitialized()||vr(n),r.isFiltered());return ma(e,o,n,i,fa,s)}(e,t,s.path,r,a)}const l=a.getChanges();return function(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=Fo(e);(n.length>0||!e.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(oo(Fo(t)))}}(t,c,l),{viewCache:c,changes:l}}function ma(e,t,i,s,r,o){const a=t.eventCache;if(null!=aa(s,i))return t;{let c,h;if(vr(i))if(n(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=Uo(t),i=ra(s,n instanceof to?n:to.EMPTY_NODE);c=e.filter.updateFullNode(t.eventCache.getNode(),i,o)}else{const n=sa(s,Uo(t));c=e.filter.updateFullNode(t.eventCache.getNode(),n,o)}else{const l=dr(i);if(".priority"===l){n(1===fr(i),"Can't have a priority with additional path components");const r=a.getNode();h=t.serverCache.getNode();const o=oa(s,i,r,h);c=null!=o?e.filter.updatePriority(r,o):a.getNode()}else{const n=pr(i);let u;if(a.isCompleteForChild(l)){h=t.serverCache.getNode();const e=oa(s,i,a.getNode(),h);u=null!=e?a.getNode().getImmediateChild(l).updateChild(n,e):a.getNode().getImmediateChild(l)}else u=ha(s,l,t.serverCache);c=null!=u?e.filter.updateChild(a.getNode(),l,u,n,r,o):a.getNode()}}return Lo(t,c,a.isFullyInitialized()||vr(i),e.filter.filtersNodes())}}function _a(e,t,n,i,s,r,o,a){const c=t.serverCache;let h;const l=o?e.filter:e.filter.getIndexedFilter();if(vr(n))h=l.updateFullNode(c.getNode(),i,null);else if(l.filtersNodes()&&!c.isFiltered()){const e=c.getNode().updateChild(n,i);h=l.updateFullNode(c.getNode(),e,null)}else{const e=dr(n);if(!c.isCompleteForPath(n)&&fr(n)>1)return t;const s=pr(n),r=c.getNode().getImmediateChild(e).updateChild(s,i);h=".priority"===e?l.updatePriority(c.getNode(),r):l.updateChild(c.getNode(),e,r,s,fa,null)}const u=Mo(t,h,c.isFullyInitialized()||vr(n),l.filtersNodes());return ma(e,u,n,s,new pa(s,u,r),a)}function ya(e,t,n,i,s,r,o){const a=t.eventCache;let c,h;const l=new pa(s,t,r);if(vr(n))h=e.filter.updateFullNode(t.eventCache.getNode(),i,o),c=Lo(t,h,!0,e.filter.filtersNodes());else{const s=dr(n);if(".priority"===s)h=e.filter.updatePriority(t.eventCache.getNode(),i),c=Lo(t,h,a.isFullyInitialized(),a.isFiltered());else{const r=pr(n),h=a.getNode().getImmediateChild(s);let u;if(vr(r))u=i;else{const e=l.getCompleteChild(s);u=null!=e?".priority"===gr(r)&&e.getChild(_r(r)).isEmpty()?e:e.updateChild(r,i):to.EMPTY_NODE}if(h.equals(u))c=t;else{c=Lo(t,e.filter.updateChild(a.getNode(),s,u,r,l,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return c}function va(e,t){return e.eventCache.isCompleteForChild(t)}function wa(e,t,n){return n.foreach((e,n)=>{t=t.updateChild(e,n)}),t}function Ta(e,t,n,i,s,r,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let c,h=t;c=vr(n)?i:new qo(null).setTree(n,i);const l=t.serverCache.getNode();return c.children.inorderTraversal((n,i)=>{if(l.hasChild(n)){const c=wa(0,t.serverCache.getNode().getImmediateChild(n),i);h=_a(e,h,new lr(n),c,s,r,o,a)}}),c.children.inorderTraversal((n,i)=>{const c=!t.serverCache.isCompleteForChild(n)&&null===i.value;if(!l.hasChild(n)&&!c){const c=wa(0,t.serverCache.getNode().getImmediateChild(n),i);h=_a(e,h,new lr(n),c,s,r,o,a)}}),h}class Ia{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,i=new lo(n.getIndex()),s=(r=n).loadsAllData()?new lo(r.getIndex()):r.hasLimit()?new fo(r):new uo(r);var r;this.processor_=function(e){return{filter:e}}(s);const o=t.serverCache,a=t.eventCache,c=i.updateFullNode(to.EMPTY_NODE,o.getNode(),null),h=s.updateFullNode(to.EMPTY_NODE,a.getNode(),null),l=new Po(c,o.isFullyInitialized(),i.filtersNodes()),u=new Po(h,a.isFullyInitialized(),s.filtersNodes());this.viewCache_=Oo(u,l),this.eventGenerator_=new Do(this.query_)}get query(){return this.query_}}function ba(e,t){const n=Uo(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!vr(t)&&!n.getImmediateChild(dr(t)).isEmpty())?n.getChild(t):null}function Ca(e){return 0===e.eventRegistrations_.length}function Ea(e,t,i){const s=[];if(i){n(null==t,"A cancel should cancel all event registrations.");const r=e.query._path;e.eventRegistrations_.forEach(e=>{const t=e.createCancelEvent(i,r);t&&s.push(t)})}if(t){let n=[];for(let i=0;i<e.eventRegistrations_.length;++i){const s=e.eventRegistrations_[i];if(s.matches(t)){if(t.hasAnyCallback()){n=n.concat(e.eventRegistrations_.slice(i+1));break}}else n.push(s)}e.eventRegistrations_=n}else e.eventRegistrations_=[];return s}function Sa(e,t,i,s){t.type===Co.MERGE&&null!==t.source.queryId&&(n(Uo(e.viewCache_),"We should always have a full cache before handling merges"),n(Fo(e.viewCache_),"Missing event cache, even though we have a server cache"));const r=e.viewCache_,o=ga(e.processor_,r,t,i,s);var a,c;return a=e.processor_,c=o.viewCache,n(c.eventCache.getNode().isIndexed(a.filter.getIndex()),"Event snap not indexed"),n(c.serverCache.getNode().isIndexed(a.filter.getIndex()),"Server snap not indexed"),n(o.viewCache.serverCache.isFullyInitialized()||!r.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=o.viewCache,ka(e,o.changes,o.viewCache.eventCache.getNode(),null)}function ka(e,t,n,i){const s=i?[i]:e.eventRegistrations_;return function(e,t,n,i){const s=[],r=[];return t.forEach(t=>{var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&r.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))}),xo(e,s,"child_removed",t,i,n),xo(e,s,"child_added",t,i,n),xo(e,s,"child_moved",r,i,n),xo(e,s,"child_changed",t,i,n),xo(e,s,"value",t,i,n),s}(e.eventGenerator_,t,n,s)}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */let Na,Aa;class Ra{constructor(){this.views=new Map}}function Pa(e,t,i,s){const r=t.source.queryId;if(null!==r){const o=e.views.get(r);return n(null!=o,"SyncTree gave us an op for an invalid query."),Sa(o,t,i,s)}{let n=[];for(const r of e.views.values())n=n.concat(Sa(r,t,i,s));return n}}function Da(e,t,n,i,s){const r=t._queryIdentifier,o=e.views.get(r);if(!o){let e=sa(n,s?i:null),r=!1;e?r=!0:i instanceof to?(e=ra(n,i),r=!1):(e=to.EMPTY_NODE,r=!1);const o=Oo(new Po(e,r,!1),new Po(i,s,!1));return new Ia(t,o)}return o}function xa(e,t,n,i,s,r){const o=Da(e,t,i,s,r);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,o),function(e,t){e.eventRegistrations_.push(t)}(o,n),function(e,t){const n=e.viewCache_.eventCache,i=[];n.getNode().isLeafNode()||n.getNode().forEachChild(Kr,(e,t)=>{i.push(ao(e,t))});return n.isFullyInitialized()&&i.push(oo(n.getNode())),ka(e,i,n.getNode(),t)}(o,n)}function Oa(e,t,i,s){const r=t._queryIdentifier,o=[];let a=[];const c=Va(e);if("default"===r)for(const[n,h]of e.views.entries())a=a.concat(Ea(h,i,s)),Ca(h)&&(e.views.delete(n),h.query._queryParams.loadsAllData()||o.push(h.query));else{const t=e.views.get(r);t&&(a=a.concat(Ea(t,i,s)),Ca(t)&&(e.views.delete(r),t.query._queryParams.loadsAllData()||o.push(t.query)))}return c&&!Va(e)&&o.push(new(n(Na,"Reference.ts has not been loaded"),Na)(t._repo,t._path)),{removed:o,events:a}}function La(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function Ma(e,t){let n=null;for(const i of e.views.values())n=n||ba(i,t);return n}function Fa(e,t){if(t._queryParams.loadsAllData())return qa(e);{const n=t._queryIdentifier;return e.views.get(n)}}function Ua(e,t){return null!=Fa(e,t)}function Va(e){return null!=qa(e)}function qa(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */let ja=1;class Ba{constructor(e){this.listenProvider_=e,this.syncPointTree_=new qo(null),this.pendingWriteTree_={visibleWrites:jo.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function za(e,t,i,s,r){return function(e,t,i,s,r){n(s>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:i,writeId:s,visible:r}),r&&(e.visibleWrites=Bo(e.visibleWrites,t,i)),e.lastWriteId=s}(e.pendingWriteTree_,t,i,s,r),r?Xa(e,new Ao({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,i)):[]}function $a(e,t,i,s){!function(e,t,i,s){n(s>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:i,writeId:s,visible:!0}),e.visibleWrites=zo(e.visibleWrites,t,i),e.lastWriteId=s}(e.pendingWriteTree_,t,i,s);const r=qo.fromObject(i);return Xa(e,new Ro({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,r))}function Wa(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(Zo(e.pendingWriteTree_,t)){let t=new qo(null);return null!=i.snap?t=t.set(ur(),!0):Os(i.children,e=>{t=t.set(new lr(e),!0)}),Xa(e,new ko(i.path,t,n))}return[]}function Ha(e,t,n){return Xa(e,new Ao({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Ka(e,t,n,i,s=!1){const r=t._path,o=e.syncPointTree_.get(r);let a=[];if(o&&("default"===t._queryIdentifier||Ua(o,t))){const c=Oa(o,t,n,i);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(r));const h=c.removed;if(a=c.events,!s){const n=-1!==h.findIndex(e=>e._queryParams.loadsAllData()),s=e.syncPointTree_.findOnPath(r,(e,t)=>Va(t));if(n&&!s){const t=e.syncPointTree_.subtree(r);if(!t.isEmpty()){const n=function(e){return e.fold((e,t,n)=>{if(t&&Va(t)){return[qa(t)]}{let e=[];return t&&(e=La(t)),Os(n,(t,n)=>{e=e.concat(n)}),e}})}(t);for(let t=0;t<n.length;++t){const i=n[t],s=i.query,r=tc(e,i);e.listenProvider_.startListening(ac(s),nc(e,s),r.hashFn,r.onComplete)}}}if(!s&&h.length>0&&!i)if(n){const n=null;e.listenProvider_.stopListening(ac(t),n)}else h.forEach(t=>{const n=e.queryToTagMap.get(ic(t));e.listenProvider_.stopListening(ac(t),n)})}!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=ic(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,h)}return a}function Ga(e,t,n,i){const s=sc(e,i);if(null!=s){const i=rc(s),r=i.path,o=i.queryId,a=wr(r,t);return oc(e,r,new Ao(So(o),a,n))}return[]}function Qa(e,t,i,s=!1){const r=t._path;let o=null,a=!1;e.syncPointTree_.foreachOnPath(r,(e,t)=>{const n=wr(e,r);o=o||Ma(t,n),a=a||Va(t)});let c,h=e.syncPointTree_.get(r);if(h?(a=a||Va(h),o=o||Ma(h,ur())):(h=new Ra,e.syncPointTree_=e.syncPointTree_.set(r,h)),null!=o)c=!0;else{c=!1,o=to.EMPTY_NODE;e.syncPointTree_.subtree(r).foreachChild((e,t)=>{const n=Ma(t,ur());n&&(o=o.updateImmediateChild(e,n))})}const l=Ua(h,t);if(!l&&!t._queryParams.loadsAllData()){const i=ic(t);n(!e.queryToTagMap.has(i),"View does not exist, but we have a tag");const s=ja++;e.queryToTagMap.set(i,s),e.tagToQueryMap.set(s,i)}let u=xa(h,t,i,Xo(e.pendingWriteTree_,r),o,c);if(!l&&!a&&!s){const i=Fa(h,t);u=u.concat(function(e,t,i){const s=t._path,r=nc(e,t),o=tc(e,i),a=e.listenProvider_.startListening(ac(t),r,o.hashFn,o.onComplete),c=e.syncPointTree_.subtree(s);if(r)n(!Va(c.value),"If we're adding a query, it shouldn't be shadowed");else{const t=c.fold((e,t,n)=>{if(!vr(e)&&t&&Va(t))return[qa(t).query];{let e=[];return t&&(e=e.concat(La(t).map(e=>e.query))),Os(n,(t,n)=>{e=e.concat(n)}),e}});for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(ac(i),nc(e,i))}}return a}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */(e,t,i))}return u}function Ya(e,t,n){const i=e.pendingWriteTree_,s=e.syncPointTree_.findOnPath(t,(e,n)=>{const i=Ma(n,wr(e,t));if(i)return i});return ia(i,t,s,n,!0)}function Ja(e,t){const n=t._path;let i=null;e.syncPointTree_.foreachOnPath(n,(e,t)=>{const s=wr(e,n);i=i||Ma(t,s)});let s=e.syncPointTree_.get(n);s?i=i||Ma(s,ur()):(s=new Ra,e.syncPointTree_=e.syncPointTree_.set(n,s));const r=null!=i,o=r?new Po(i,!0,!1):null;return function(e){return Fo(e.viewCache_)}(Da(s,t,Xo(e.pendingWriteTree_,t._path),r?o.getNode():to.EMPTY_NODE,r))}function Xa(e,t){return Za(t,e.syncPointTree_,null,Xo(e.pendingWriteTree_,ur()))}function Za(e,t,n,i){if(vr(e.path))return ec(e,t,n,i);{const s=t.get(ur());null==n&&null!=s&&(n=Ma(s,ur()));let r=[];const o=dr(e.path),a=e.operationForChild(o),c=t.children.get(o);if(c&&a){const e=n?n.getImmediateChild(o):null,t=la(i,o);r=r.concat(Za(a,c,e,t))}return s&&(r=r.concat(Pa(s,e,i,n))),r}}function ec(e,t,n,i){const s=t.get(ur());null==n&&null!=s&&(n=Ma(s,ur()));let r=[];return t.children.inorderTraversal((t,s)=>{const o=n?n.getImmediateChild(t):null,a=la(i,t),c=e.operationForChild(t);c&&(r=r.concat(ec(c,s,o,a)))}),s&&(r=r.concat(Pa(s,e,i,n))),r}function tc(e,t){const n=t.query,i=nc(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||to.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return i?function(e,t,n){const i=sc(e,n);if(i){const n=rc(i),s=n.path,r=n.queryId,o=wr(s,t);return oc(e,s,new No(So(r),o))}return[]}(e,n._path,i):function(e,t){return Xa(e,new No({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return Ka(e,n,null,i)}}}}function nc(e,t){const n=ic(t);return e.queryToTagMap.get(n)}function ic(e){return e._path.toString()+"$"+e._queryIdentifier}function sc(e,t){return e.tagToQueryMap.get(t)}function rc(e){const t=e.indexOf("$");return n(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new lr(e.substr(0,t))}}function oc(e,t,i){const s=e.syncPointTree_.get(t);n(s,"Missing sync point for query tag that we're tracking");return Pa(s,i,Xo(e.pendingWriteTree_,t),null)}function ac(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(n(Aa,"Reference.ts has not been loaded"),Aa)(e._repo,e._path):e}class cc{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new cc(t)}node(){return this.node_}}class hc{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=yr(this.path_,e);return new hc(this.syncTree_,t)}node(){return Ya(this.syncTree_,this.path_)}}const lc=function(e,t,i){return e&&"object"==typeof e?(n(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?uc(e[".sv"],t,i):"object"==typeof e[".sv"]?dc(e[".sv"],t):void n(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},uc=function(e,t,i){if("timestamp"===e)return i.timestamp;n(!1,"Unexpected server value: "+e)},dc=function(e,t,i){e.hasOwnProperty("increment")||n(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const s=e.increment;"number"!=typeof s&&n(!1,"Unexpected increment value: "+s);const r=t.node();if(n(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return s;const o=r.getValue();return"number"!=typeof o?s:o+s},fc=function(e,t,n,i){return gc(t,new hc(n,e),i)},pc=function(e,t,n){return gc(e,new cc(t),n)};function gc(e,t,n){const i=e.getPriority().val(),s=lc(i,t.getImmediateChild(".priority"),n);let r;if(e.isLeafNode()){const i=e,r=lc(i.getValue(),t,n);return r!==i.getValue()||s!==i.getPriority().val()?new Hr(r,io(s)):e}{const i=e;return r=i,s!==i.getPriority().val()&&(r=r.updatePriority(new Hr(s))),i.forEachChild(Kr,(e,i)=>{const s=gc(i,t.getImmediateChild(e),n);s!==i&&(r=r.updateImmediateChild(e,s))}),r}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class mc{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function _c(e,t){let n=t instanceof lr?t:new lr(t),i=e,s=dr(n);for(;null!==s;){const e=D(i.node.children,s)||{children:{},childCount:0};i=new mc(s,i,e),n=pr(n),s=dr(n)}return i}function yc(e){return e.node.value}function vc(e,t){e.node.value=t,Cc(e)}function wc(e){return e.node.childCount>0}function Tc(e,t){Os(e.node.children,(n,i)=>{t(new mc(n,e,i))})}function Ic(e,t,n,i){n&&t(e),Tc(e,e=>{Ic(e,t,!0)})}function bc(e){return new lr(null===e.parent?e.name:bc(e.parent)+"/"+e.name)}function Cc(e){null!==e.parent&&function(e,t,n){const i=function(e){return void 0===yc(e)&&!wc(e)}(n),s=P(e.node.children,t);i&&s?(delete e.node.children[t],e.node.childCount--,Cc(e)):i||s||(e.node.children[t]=n.node,e.node.childCount++,Cc(e))}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */(e.parent,e.name,e)}const Ec=/[\[\].#$\/\u0000-\u001F\u007F]/,Sc=/[\[\].#$\u0000-\u001F\u007F]/,kc=10485760,Nc=function(e){return"string"==typeof e&&0!==e.length&&!Ec.test(e)},Ac=function(e){return"string"==typeof e&&0!==e.length&&!Sc.test(e)},Rc=function(e,t,n,i){i&&void 0===t||Pc(j(e,"value"),t,n)},Pc=function(e,t,n){const i=n instanceof lr?new Cr(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Sr(i));if("function"==typeof t)throw new Error(e+"contains a function "+Sr(i)+" with contents = "+t.toString());if(Ss(t))throw new Error(e+"contains "+t.toString()+" "+Sr(i));if("string"==typeof t&&t.length>kc/3&&B(t)>kc)throw new Error(e+"contains a string greater than "+kc+" utf8 bytes "+Sr(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,s=!1;if(Os(t,(t,r)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(s=!0,!Nc(t)))throw new Error(e+" contains an invalid key ("+t+") "+Sr(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=i).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=B(a),Er(o),Pc(e,r,i),function(e){const t=e.parts_.pop();e.byteLength_-=B(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)}),n&&s)throw new Error(e+' contains ".value" child '+Sr(i)+" in addition to actual children.")}},Dc=function(e,t,n,i){const s=j(e,"values");if(!t||"object"!=typeof t||Array.isArray(t))throw new Error(s+" must be an object containing the children to replace.");const r=[];Os(t,(e,t)=>{const i=new lr(e);if(Pc(s,t,yr(n,i)),".priority"===gr(i)&&!(null===(o=t)||"string"==typeof o||"number"==typeof o&&!Ss(o)||o&&"object"==typeof o&&P(o,".sv")))throw new Error(s+"contains an invalid value for '"+i.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");var o;r.push(i)}),function(e,t){let n,i;for(n=0;n<t.length;n++){i=t[n];const s=mr(i);for(let t=0;t<s.length;t++)if(".priority"===s[t]&&t===s.length-1);else if(!Nc(s[t]))throw new Error(e+"contains an invalid key ("+s[t]+") in path "+i.toString()+'. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"')}t.sort(Tr);let s=null;for(n=0;n<t.length;n++){if(i=t[n],null!==s&&br(s,i))throw new Error(e+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}}(s,r)},xc=function(e,t,n,i){if(!Ac(n))throw new Error(j(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Oc=function(e,t){if(".info"===dr(t))throw new Error(e+" failed = Can't modify data under /.info/")},Lc=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Nc(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Ac(e)}(n))throw new Error(j(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * limitations under the License.
   */
class Mc{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Fc(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Ir(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Uc(e,t,n){Fc(e,n),qc(e,e=>Ir(e,t))}function Vc(e,t,n){Fc(e,n),qc(e,e=>br(e,t)||br(t,e))}function qc(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(jc(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function jc(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();vs&&Ts("event: "+n.toString()),Us(i)}}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Bc{constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Mc,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=vo(),this.transactionQueueTree_=new mc,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function zc(e,t,n){if(e.stats_=Xs(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new _o(e.repoInfo_,(t,n,i,s)=>{Hc(e,t,n,i,s)},e.authTokenProvider_,e.appCheckProvider_),setTimeout(()=>Kc(e,!0),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{A(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}e.persistentConnection_=new Ar(e.repoInfo_,t,(t,n,i,s)=>{Hc(e,t,n,i,s)},t=>{Kc(e,t)},t=>{!function(e,t){Os(t,(t,n)=>{Gc(e,t,n)})}(e,t)},e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener(t=>{e.server_.refreshAuthToken(t)}),e.appCheckProvider_.addTokenChangeListener(t=>{e.server_.refreshAppCheckToken(t.token)}),e.statsReporter_=function(e,t){const n=e.toString();return Js[n]||(Js[n]=t()),Js[n]}(e.repoInfo_,()=>new bo(e.stats_,e.server_)),e.infoData_=new yo,e.infoSyncTree_=new Ba({startListening:(t,n,i,s)=>{let r=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(r=Ha(e.infoSyncTree_,t._path,o),setTimeout(()=>{s("ok")},0)),r},stopListening:()=>{}}),Gc(e,"connected",!1),e.serverSyncTree_=new Ba({startListening:(t,n,i,s)=>(e.server_.listen(t,i,n,(n,i)=>{const r=s(n,i);Vc(e.eventQueue_,t._path,r)}),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function $c(e){const t=e.infoData_.getNode(new lr(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function Wc(e){return(t=(t={timestamp:$c(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function Hc(e,t,n,i,s){e.dataUpdateCount++;const r=new lr(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(s)if(i){const t=O(n,e=>io(e));o=function(e,t,n,i){const s=sc(e,i);if(s){const i=rc(s),r=i.path,o=i.queryId,a=wr(r,t),c=qo.fromObject(n);return oc(e,r,new Ro(So(o),a,c))}return[]}(e.serverSyncTree_,r,t,s)}else{const t=io(n);o=Ga(e.serverSyncTree_,r,t,s)}else if(i){const t=O(n,e=>io(e));o=function(e,t,n){const i=qo.fromObject(n);return Xa(e,new Ro({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,r,t)}else{const t=io(n);o=Ha(e.serverSyncTree_,r,t)}let a=r;o.length>0&&(a=th(e,r)),Vc(e.eventQueue_,a,o)}function Kc(e,t){Gc(e,"connected",t),!1===t&&function(e){Jc(e,"onDisconnectEvents");const t=Wc(e),n=vo();To(e.onDisconnect_,ur(),(i,s)=>{const r=fc(i,s,e.serverSyncTree_,t);wo(n,i,r)});let i=[];To(n,ur(),(t,n)=>{i=i.concat(Ha(e.serverSyncTree_,t,n));const s=oh(e,t);th(e,s)}),e.onDisconnect_=vo(),Vc(e.eventQueue_,ur(),i)}(e)}function Gc(e,t,n){const i=new lr("/.info/"+t),s=io(n);e.infoData_.updateSnapshot(i,s);const r=Ha(e.infoSyncTree_,i,s);Vc(e.eventQueue_,i,r)}function Qc(e){return e.nextWriteId_++}function Yc(e,t,n){let i;i=".info"===dr(t._path)?Ka(e.infoSyncTree_,t,n):Ka(e.serverSyncTree_,t,n),Uc(e.eventQueue_,t._path,i)}function Jc(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Ts(n,...t)}function Xc(e,t,n,i){t&&Us(()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let s=e;i&&(s+=": "+i);const r=new Error(s);r.code=e,t(r)}})}function Zc(e,t,n){return Ya(e.serverSyncTree_,t,n)||to.EMPTY_NODE}function eh(e,t=e.transactionQueueTree_){if(t||rh(e,t),yc(t)){const i=ih(e,t);n(i.length>0,"Sending zero length transaction queue");i.every(e=>0===e.status)&&function(e,t,i){const s=i.map(e=>e.currentWriteId),r=Zc(e,t,s);let o=r;const a=r.hash();for(let l=0;l<i.length;l++){const e=i[l];n(0===e.status,"tryToSendTransactionQueue_: items in queue should all be run."),e.status=1,e.retryCount++;const s=wr(t,e.path);o=o.updateChild(s,e.currentOutputSnapshotRaw)}const c=o.val(!0),h=t;e.server_.put(h.toString(),c,n=>{Jc(e,"transaction put response",{path:h.toString(),status:n});let s=[];if("ok"===n){const n=[];for(let t=0;t<i.length;t++)i[t].status=2,s=s.concat(Wa(e.serverSyncTree_,i[t].currentWriteId)),i[t].onComplete&&n.push(()=>i[t].onComplete(null,!0,i[t].currentOutputSnapshotResolved)),i[t].unwatcher();rh(e,_c(e.transactionQueueTree_,t)),eh(e,e.transactionQueueTree_),Vc(e.eventQueue_,t,s);for(let e=0;e<n.length;e++)Us(n[e])}else{if("datastale"===n)for(let e=0;e<i.length;e++)3===i[e].status?i[e].status=4:i[e].status=0;else{Es("transaction at "+h.toString()+" failed: "+n);for(let e=0;e<i.length;e++)i[e].status=4,i[e].abortReason=n}th(e,t)}},a)}(e,bc(t),i)}else wc(t)&&Tc(t,t=>{eh(e,t)})}function th(e,t){const i=nh(e,t),s=bc(i);return function(e,t,i){if(0===t.length)return;const s=[];let r=[];const o=t.filter(e=>0===e.status),a=o.map(e=>e.currentWriteId);for(let c=0;c<t.length;c++){const o=t[c],h=wr(i,o.path);let l,u=!1;if(n(null!==h,"rerunTransactionsUnderNode_: relativePath should not be null."),4===o.status)u=!0,l=o.abortReason,r=r.concat(Wa(e.serverSyncTree_,o.currentWriteId,!0));else if(0===o.status)if(o.retryCount>=25)u=!0,l="maxretry",r=r.concat(Wa(e.serverSyncTree_,o.currentWriteId,!0));else{const n=Zc(e,o.path,a);o.currentInputSnapshot=n;const i=t[c].update(n.val());if(void 0!==i){Pc("transaction failed: Data returned ",i,o.path);let t=io(i);"object"==typeof i&&null!=i&&P(i,".priority")||(t=t.updatePriority(n.getPriority()));const s=o.currentWriteId,c=Wc(e),h=pc(t,n,c);o.currentOutputSnapshotRaw=t,o.currentOutputSnapshotResolved=h,o.currentWriteId=Qc(e),a.splice(a.indexOf(s),1),r=r.concat(za(e.serverSyncTree_,o.path,h,o.currentWriteId,o.applyLocally)),r=r.concat(Wa(e.serverSyncTree_,s,!0))}else u=!0,l="nodata",r=r.concat(Wa(e.serverSyncTree_,o.currentWriteId,!0))}Vc(e.eventQueue_,i,r),r=[],u&&(t[c].status=2,function(e){setTimeout(e,Math.floor(0))}(t[c].unwatcher),t[c].onComplete&&("nodata"===l?s.push(()=>t[c].onComplete(null,!1,t[c].currentInputSnapshot)):s.push(()=>t[c].onComplete(new Error(l),!1,null))))}rh(e,e.transactionQueueTree_);for(let n=0;n<s.length;n++)Us(s[n]);eh(e,e.transactionQueueTree_)}(e,ih(e,i),s),s}function nh(e,t){let n,i=e.transactionQueueTree_;for(n=dr(t);null!==n&&void 0===yc(i);)i=_c(i,n),n=dr(t=pr(t));return i}function ih(e,t){const n=[];return sh(e,t,n),n.sort((e,t)=>e.order-t.order),n}function sh(e,t,n){const i=yc(t);if(i)for(let s=0;s<i.length;s++)n.push(i[s]);Tc(t,t=>{sh(e,t,n)})}function rh(e,t){const n=yc(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,vc(t,n.length>0?n:void 0)}Tc(t,t=>{rh(e,t)})}function oh(e,t){const n=bc(nh(e,t)),i=_c(e.transactionQueueTree_,t);return function(e,t){let n=e.parent;for(;null!==n;){if(t(n))return!0;n=n.parent}}(i,t=>{ah(e,t)}),ah(e,i),Ic(i,t=>{ah(e,t)}),n}function ah(e,t){const i=yc(t);if(i){const s=[];let r=[],o=-1;for(let t=0;t<i.length;t++)3===i[t].status||(1===i[t].status?(n(o===t-1,"All SENT items should be at beginning of queue."),o=t,i[t].status=3,i[t].abortReason="set"):(n(0===i[t].status,"Unexpected transaction status in abort"),i[t].unwatcher(),r=r.concat(Wa(e.serverSyncTree_,i[t].currentWriteId,!0)),i[t].onComplete&&s.push(i[t].onComplete.bind(null,new Error("set"),!1,null))));-1===o?vc(t,void 0):i.length=o+1,Vc(e.eventQueue_,bc(t),r);for(let e=0;e<s.length;e++)Us(s[e])}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * limitations under the License.
   */
class dh{constructor(e,t,n,i){this.eventType=e,this.eventRegistration=t,this.snapshot=n,this.prevName=i}getPath(){const e=this.snapshot.ref;return"value"===this.eventType?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+A(this.snapshot.exportVal())}}class fh{constructor(e,t,n){this.eventRegistration=e,this.error=t,this.path=n}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class gh{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return vr(this._path)?null:gr(this._path)}get ref(){return new mh(this._repo,this._path)}get _queryIdentifier(){const e=mo(this._queryParams),t=Ds(e);return"{}"===t?"default":t}get _queryObject(){return mo(this._queryParams)}isEqual(e){if(!((e=z(e))instanceof gh))return!1;const t=this._repo===e._repo,n=Ir(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class mh extends gh{constructor(e,t){super(e,t,new po,!1)}get parent(){const e=_r(this._path);return null===e?null:new mh(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class _h{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new lr(e),n=vh(this.ref,e);return new _h(this._node.getChild(t),n,Kr)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,(t,n)=>e(new _h(n,vh(this.ref,t),Kr)))}hasChild(e){const t=new lr(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function yh(e,t){return(e=z(e))._checkNotDeleted("ref"),void 0!==t?vh(e._root,t):e._root}function vh(e,t){var n,i,s;return null===dr((e=z(e))._path)?(n="child",i="path",(s=t)&&(s=s.replace(/^\/*\.info(\/|$)/,"/")),xc(n,i,s)):xc("child","path",t),new mh(e._repo,yr(e._path,t))}function wh(e,t){e=z(e),Oc("set",e._path),Rc("set",t,e._path,!1);const n=new v;return function(e,t,n,i,s){Jc(e,"set",{path:t.toString(),value:n,priority:i});const r=Wc(e),o=io(n,i),a=Ya(e.serverSyncTree_,t),c=pc(o,a,r),h=Qc(e),l=za(e.serverSyncTree_,t,c,h,!0);Fc(e.eventQueue_,l),e.server_.put(t.toString(),o.val(!0),(n,i)=>{const r="ok"===n;r||Es("set at "+t+" failed: "+n);const o=Wa(e.serverSyncTree_,h,!r);Vc(e.eventQueue_,t,o),Xc(0,s,n,i)});const u=oh(e,t);th(e,u),Vc(e.eventQueue_,u,[])}(e._repo,e._path,t,null,n.wrapCallback(()=>{})),n.promise}function Th(e,t){Dc("update",t,e._path);const n=new v;return function(e,t,n,i){Jc(e,"update",{path:t.toString(),value:n});let s=!0;const r=Wc(e),o={};if(Os(n,(n,i)=>{s=!1,o[n]=fc(yr(t,n),io(i),e.serverSyncTree_,r)}),s)Ts("update() called with empty data.  Don't do anything."),Xc(0,i,"ok",void 0);else{const s=Qc(e),r=$a(e.serverSyncTree_,t,o,s);Fc(e.eventQueue_,r),e.server_.merge(t.toString(),n,(n,r)=>{const o="ok"===n;o||Es("update at "+t+" failed: "+n);const a=Wa(e.serverSyncTree_,s,!o),c=a.length>0?th(e,t):t;Vc(e.eventQueue_,c,a),Xc(0,i,n,r)}),Os(n,n=>{const i=oh(e,yr(t,n));th(e,i)}),Vc(e.eventQueue_,t,[])}}(e._repo,e._path,t,n.wrapCallback(()=>{})),n.promise}function Ih(e){e=z(e);const t=new ph(()=>{}),n=new bh(t);return function(e,t,n){const i=Ja(e.serverSyncTree_,t);return null!=i?Promise.resolve(i):e.server_.get(t).then(i=>{const s=io(i).withIndex(t._queryParams.getIndex());let r;if(Qa(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())r=Ha(e.serverSyncTree_,t._path,s);else{const n=nc(e.serverSyncTree_,t);r=Ga(e.serverSyncTree_,t._path,s,n)}return Vc(e.eventQueue_,t._path,r),Ka(e.serverSyncTree_,t,n,null,!0),s},n=>(Jc(e,"get for query "+A(t)+" failed: "+n),Promise.reject(new Error(n))))}(e._repo,e,n).then(t=>new _h(t,new mh(e._repo,e._path),e._queryParams.getIndex()))}class bh{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new dh("value",this,new _h(e.snapshotNode,new mh(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new fh(this,e,t):null}matches(e){return e instanceof bh&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class Ch{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new fh(this,e,t):null}createEvent(e,t){n(null!=e.childName,"Child events should have a childName.");const i=vh(new mh(t._repo,t._path),e.childName),s=t._queryParams.getIndex();return new dh(e.type,this,new _h(e.snapshotNode,i,s),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Ch&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function Eh(e,t,n,i,s){const r=new ph(n,void 0),o="value"===t?new bh(r):new Ch(t,r);return function(e,t,n){let i;i=".info"===dr(t._path)?Qa(e.infoSyncTree_,t,n):Qa(e.serverSyncTree_,t,n),Uc(e.eventQueue_,t._path,i)}(e._repo,e,o),()=>Yc(e._repo,e,o)}!function(e){n(!Na,"__referenceConstructor has already been defined"),Na=e}(mh),function(e){n(!Aa,"__referenceConstructor has already been defined"),Aa=e}(mh);
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * limitations under the License.
   */
const Sh={};let kh=!1;function Nh(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||Cs("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ts("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a=ch(r,s),c=a.repoInfo;"undefined"!=typeof process&&os&&(o=os.FIREBASE_DATABASE_EMULATOR_HOST),o?(r=`http://${o}?ns=${c.namespace}`,a=ch(r,s),c=a.repoInfo):a.repoInfo.secure;const h=new js(e.name,e.options,t);Lc("Invalid Firebase Database URL",a),vr(a.path)||Cs("Database URL must point to the root of a Firebase Database (not including a child path).");const l=function(e,t,n,i){let s=Sh[t.name];s||(s={},Sh[t.name]=s);let r=s[e.toURLString()];r&&Cs("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new Bc(e,kh,n,i),s[e.toURLString()]=r,r}(c,e,h,new qs(e.name,n));return new Ah(l,e)}class Ah{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(zc(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new mh(this._repo,ur())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Sh[t];n&&n[e.key]===e||Cs(`Database ${t}(${e.repoInfo_}) has already been deleted.`),function(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Cs("Cannot call "+e+" on a deleted database.")}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * limitations under the License.
   */
const Rh={".sv":"timestamp"};Ar.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Ar.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},
/**
   * @license
   * Copyright 2021 Google LLC
   *
   ...
   * limitations under the License.
   */
function(e){hs=st,Ze(new $("database",(e,{instanceIdentifier:t})=>Nh(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t),"PUBLIC").setMultipleInstances(!0)),at(as,cs,e),at(as,cs,"esm2017")}();var Ph,Dh,xh="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{};
/** @license
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const Hh=new ee("@firebase/firestore");function Kh(){return Hh.logLevel}function Gh(e,...t){if(Hh.logLevel<=G.DEBUG){const n=t.map(Jh);Hh.debug(`Firestore (${Wh}): ${e}`,...n)}}function Qh(e,...t){if(Hh.logLevel<=G.ERROR){const n=t.map(Jh);Hh.error(`Firestore (${Wh}): ${e}`,...n)}}function Yh(e,...t){if(Hh.logLevel<=G.WARN){const n=t.map(Jh);Hh.warn(`Firestore (${Wh}): ${e}`,...n)}}function Jh(e){if("string"==typeof e)return e;try{
/**
      * @license
      * Copyright 2020 Google LLC
      *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function Xh(e="Unexpected state"){const t=`FIRESTORE (${Wh}) INTERNAL ASSERTION FAILED: `+e;throw Qh(t),new Error(t)}function Zh(e,t){e||Xh()}function el(e,t){return e}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const tl={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class nl extends E{constructor(e,t){super(e,t),this.code=e,this.message=t,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class sl{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class rl{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t($h.UNAUTHENTICATED))}shutdown(){}}class ol{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class al{constructor(e){this.t=e,this.currentUser=$h.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){Zh(void 0===this.o);let n=this.i;const i=e=>this.i!==n?(n=this.i,t(e)):Promise.resolve();let s=new il;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new il,e.enqueueRetryable(()=>i(this.currentUser))};const r=()=>{const t=s;e.enqueueRetryable(async()=>{await t.promise,await i(this.currentUser)})},o=e=>{Gh("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=e,this.o&&(this.auth.addAuthTokenListener(this.o),r())};this.t.onInit(e=>o(e)),setTimeout(()=>{if(!this.auth){const e=this.t.getImmediate({optional:!0});e?o(e):(Gh("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new il)}},0),r()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(t=>this.i!==e?(Gh("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):t?(Zh("string"==typeof t.accessToken),new sl(t.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Zh(null===e||"string"==typeof e),new $h(e)}}class cl{constructor(e,t,n){this.l=e,this.h=t,this.P=n,this.type="FirstParty",this.user=$h.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class hl{constructor(e,t,n){this.l=e,this.h=t,this.P=n}getToken(){return Promise.resolve(new cl(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t($h.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class ll{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class ul{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){Zh(void 0===this.o);const n=e=>{null!=e.error&&Gh("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${e.error.message}`);const n=e.token!==this.R;return this.R=e.token,Gh("FirebaseAppCheckTokenProvider",`Received ${n?"new":"existing"} token.`),n?t(e.token):Promise.resolve()};this.o=t=>{e.enqueueRetryable(()=>n(t))};const i=e=>{Gh("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=e,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(e=>i(e)),setTimeout(()=>{if(!this.appCheck){const e=this.A.getImmediate({optional:!0});e?i(e):Gh("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(e=>e?(Zh("string"==typeof e.token),this.R=e.token,new ll(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function dl(e){const t="undefined"!=typeof self&&(self.crypto||self.msCrypto),n=new Uint8Array(e);if(t&&"function"==typeof t.getRandomValues)t.getRandomValues(n);else for(let i=0;i<e;i++)n[i]=Math.floor(256*Math.random());return n}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class fl{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(256/62);let n="";for(;n.length<20;){const i=dl(40);for(let s=0;s<i.length;++s)n.length<20&&i[s]<t&&(n+=e.charAt(i[s]%62))}return n}}function pl(e,t){return e<t?-1:e>t?1:0}function gl(e,t,n){return e.length===t.length&&e.every((e,i)=>n(e,t[i]))}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class ml{constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new nl(tl.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new nl(tl.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<-62135596800)throw new nl(tl.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new nl(tl.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}static now(){return ml.fromMillis(Date.now())}static fromDate(e){return ml.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),n=Math.floor(1e6*(e-1e3*t));return new ml(t,n)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/1e6}_compareTo(e){return this.seconds===e.seconds?pl(this.nanoseconds,e.nanoseconds):pl(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{seconds:this.seconds,nanoseconds:this.nanoseconds}}valueOf(){const e=this.seconds- -62135596800;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class _l{constructor(e){this.timestamp=e}static fromTimestamp(e){return new _l(e)}static min(){return new _l(new ml(0,0))}static max(){return new _l(new ml(253402300799,999999999))}compareTo(e){return this.timestamp._compareTo(e.timestamp)}isEqual(e){return this.timestamp.isEqual(e.timestamp)}toMicroseconds(){return 1e6*this.timestamp.seconds+this.timestamp.nanoseconds/1e3}toString(){return"SnapshotVersion("+this.timestamp.toString()+")"}toTimestamp(){return this.timestamp}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class yl{constructor(e,t,n){void 0===t?t=0:t>e.length&&Xh(),void 0===n?n=e.length-t:n>e.length-t&&Xh(),this.segments=e,this.offset=t,this.len=n}get length(){return this.len}isEqual(e){return 0===yl.comparator(this,e)}child(e){const t=this.segments.slice(this.offset,this.limit());return e instanceof yl?e.forEach(e=>{t.push(e)}):t.push(e),this.construct(t)}limit(){return this.offset+this.length}popFirst(e){return e=void 0===e?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return 0===this.length}isPrefixOf(e){if(e.length<this.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}forEach(e){for(let t=this.offset,n=this.limit();t<n;t++)e(this.segments[t])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,t){const n=Math.min(e.length,t.length);for(let i=0;i<n;i++){const n=e.get(i),s=t.get(i);if(n<s)return-1;if(n>s)return 1}return e.length<t.length?-1:e.length>t.length?1:0}}class vl extends yl{construct(e,t,n){return new vl(e,t,n)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const t=[];for(const n of e){if(n.indexOf("//")>=0)throw new nl(tl.INVALID_ARGUMENT,`Invalid segment (${n}). Paths must not contain // in them.`);t.push(...n.split("/").filter(e=>e.length>0))}return new vl(t)}static emptyPath(){return new vl([])}}const wl=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class Tl extends yl{construct(e,t,n){return new Tl(e,t,n)}static isValidIdentifier(e){return wl.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),Tl.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return 1===this.length&&"__name__"===this.get(0)}static keyField(){return new Tl(["__name__"])}static fromServerFormat(e){const t=[];let n="",i=0;const s=()=>{if(0===n.length)throw new nl(tl.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);t.push(n),n=""};let r=!1;for(;i<e.length;){const t=e[i];if("\\"===t){if(i+1===e.length)throw new nl(tl.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const t=e[i+1];if("\\"!==t&&"."!==t&&"`"!==t)throw new nl(tl.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);n+=t,i+=2}else"`"===t?(r=!r,i++):"."!==t||r?(n+=t,i++):(s(),i++)}if(s(),r)throw new nl(tl.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new Tl(t)}static emptyPath(){return new Tl([])}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Il{constructor(e){this.path=e}static fromPath(e){return new Il(vl.fromString(e))}static fromName(e){return new Il(vl.fromString(e).popFirst(5))}static empty(){return new Il(vl.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return null!==e&&0===vl.comparator(this.path,e.path)}toString(){return this.path.toString()}static comparator(e,t){return vl.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new Il(new vl(e.slice()))}}function bl(e){return new Cl(e.readTime,e.key,-1)}class Cl{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new Cl(_l.min(),Il.empty(),-1)}static max(){return new Cl(_l.max(),Il.empty(),-1)}}function El(e,t){let n=e.readTime.compareTo(t.readTime);return 0!==n?n:(n=Il.comparator(e.documentKey,t.documentKey),0!==n?n:pl(e.largestBatchId,t.largestBatchId)
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */)}class Sl{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach(e=>e())}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */async function kl(e){if(e.code!==tl.FAILED_PRECONDITION||"The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab."!==e.message)throw e;Gh("LocalStore","Unexpectedly lost primary lease")}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Nl{constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e(e=>{this.isDone=!0,this.result=e,this.nextCallback&&this.nextCallback(e)},e=>{this.isDone=!0,this.error=e,this.catchCallback&&this.catchCallback(e)})}catch(e){return this.next(void 0,e)}next(e,t){return this.callbackAttached&&Xh(),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(t,this.error):this.wrapSuccess(e,this.result):new Nl((n,i)=>{this.nextCallback=t=>{this.wrapSuccess(e,t).next(n,i)},this.catchCallback=e=>{this.wrapFailure(t,e).next(n,i)}})}toPromise(){return new Promise((e,t)=>{this.next(e,t)})}wrapUserFunction(e){try{const t=e();return t instanceof Nl?t:Nl.resolve(t)}catch(t){return Nl.reject(t)}}wrapSuccess(e,t){return e?this.wrapUserFunction(()=>e(t)):Nl.resolve(t)}wrapFailure(e,t){return e?this.wrapUserFunction(()=>e(t)):Nl.reject(t)}static resolve(e){return new Nl((t,n)=>{t(e)})}static reject(e){return new Nl((t,n)=>{n(e)})}static waitFor(e){return new Nl((t,n)=>{let i=0,s=0,r=!1;e.forEach(e=>{++i,e.next(()=>{++s,r&&s===i&&t()},e=>n(e))}),r=!0,s===i&&t()})}static or(e){let t=Nl.resolve(!1);for(const n of e)t=t.next(e=>e?Nl.resolve(e):n());return t}static forEach(e,t){const n=[];return e.forEach((e,i)=>{n.push(t.call(this,e,i))}),this.waitFor(n)}static mapArray(e,t){return new Nl((n,i)=>{const s=e.length,r=new Array(s);let o=0;for(let a=0;a<s;a++){const c=a;t(e[c]).next(e=>{r[c]=e,++o,o===s&&n(r)},e=>i(e))}})}static doWhile(e,t){return new Nl((n,i)=>{const s=()=>{!0===e()?t().next(()=>{s()},i):n()};s()})}}function Al(e){return"IndexedDbTransactionError"===e.name}
/**
   * @license
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Rl{constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=e=>this.ie(e),this.se=e=>t.writeSequenceNumber(e))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}function Pl(e){return null==e}function Dl(e){return 0===e&&1/e==-1/0}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * limitations under the License.
   */
function xl(e){let t=0;for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t++;return t}function Ol(e,t){for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t(n,e[n])}function Ll(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class zl{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(e){try{return atob(e)}catch(t){throw"undefined"!=typeof DOMException&&t instanceof DOMException?new Bl("Invalid base64 string: "+t):t}}(e);return new zl(t)}static fromUint8Array(e){const t=function(e){let t="";for(let n=0;n<e.length;++n)t+=String.fromCharCode(e[n]);return t}(e);return new zl(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return e=this.binaryString,btoa(e);var e}toUint8Array(){return function(e){const t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return pl(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}zl.EMPTY_BYTE_STRING=new zl("");const $l=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Wl(e){if(Zh(!!e),"string"==typeof e){let t=0;const n=$l.exec(e);if(Zh(!!n),n[1]){let e=n[1];e=(e+"000000000").substr(0,9),t=Number(e)}const i=new Date(e);return{seconds:Math.floor(i.getTime()/1e3),nanos:t}}return{seconds:Hl(e.seconds),nanos:Hl(e.nanos)}}function Hl(e){return"number"==typeof e?e:"string"==typeof e?Number(e):0}function Kl(e){return"string"==typeof e?zl.fromBase64String(e):zl.fromUint8Array(e)}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function Gl(e){var t,n;return"server_timestamp"===(null===(n=((null===(t=null==e?void 0:e.mapValue)||void 0===t?void 0:t.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function Ql(e){const t=e.mapValue.fields.__previous_value__;return Gl(t)?Ql(t):t}function Yl(e){const t=Wl(e.mapValue.fields.__local_write_time__.timestampValue);return new ml(t.seconds,t.nanos)}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const Zl={};function eu(e){return"nullValue"in e?0:"booleanValue"in e?1:"integerValue"in e||"doubleValue"in e?2:"timestampValue"in e?3:"stringValue"in e?5:"bytesValue"in e?6:"referenceValue"in e?7:"geoPointValue"in e?8:"arrayValue"in e?9:"mapValue"in e?Gl(e)?4:function(e){return"__max__"===(((e.mapValue||{}).fields||{}).__type__||{}).stringValue}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */(e)?9007199254740991:function(e){var t,n;return"__vector__"===(null===(n=((null===(t=null==e?void 0:e.mapValue)||void 0===t?void 0:t.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}(e)?10:11:Xh()}function tu(e,t){if(e===t)return!0;const n=eu(e);if(n!==eu(t))return!1;switch(n){case 0:case 9007199254740991:return!0;case 1:return e.booleanValue===t.booleanValue;case 4:return Yl(e).isEqual(Yl(t));case 3:return function(e,t){if("string"==typeof e.timestampValue&&"string"==typeof t.timestampValue&&e.timestampValue.length===t.timestampValue.length)return e.timestampValue===t.timestampValue;const n=Wl(e.timestampValue),i=Wl(t.timestampValue);return n.seconds===i.seconds&&n.nanos===i.nanos}(e,t);case 5:return e.stringValue===t.stringValue;case 6:return i=t,Kl(e.bytesValue).isEqual(Kl(i.bytesValue));case 7:return e.referenceValue===t.referenceValue;case 8:return function(e,t){return Hl(e.geoPointValue.latitude)===Hl(t.geoPointValue.latitude)&&Hl(e.geoPointValue.longitude)===Hl(t.geoPointValue.longitude)}(e,t);case 2:return function(e,t){if("integerValue"in e&&"integerValue"in t)return Hl(e.integerValue)===Hl(t.integerValue);if("doubleValue"in e&&"doubleValue"in t){const n=Hl(e.doubleValue),i=Hl(t.doubleValue);return n===i?Dl(n)===Dl(i):isNaN(n)&&isNaN(i)}return!1}(e,t);case 9:return gl(e.arrayValue.values||[],t.arrayValue.values||[],tu);case 10:case 11:return function(e,t){const n=e.mapValue.fields||{},i=t.mapValue.fields||{};if(xl(n)!==xl(i))return!1;for(const s in n)if(n.hasOwnProperty(s)&&(void 0===i[s]||!tu(n[s],i[s])))return!1;return!0}(e,t);default:return Xh()}var i}function nu(e,t){return void 0!==(e.values||[]).find(e=>tu(e,t))}function iu(e,t){if(e===t)return 0;const n=eu(e),i=eu(t);if(n!==i)return pl(n,i);switch(n){case 0:case 9007199254740991:return 0;case 1:return pl(e.booleanValue,t.booleanValue);case 2:return function(e,t){const n=Hl(e.integerValue||e.doubleValue),i=Hl(t.integerValue||t.doubleValue);return n<i?-1:n>i?1:n===i?0:isNaN(n)?isNaN(i)?0:-1:1}(e,t);case 3:return su(e.timestampValue,t.timestampValue);case 4:return su(Yl(e),Yl(t));case 5:return pl(e.stringValue,t.stringValue);case 6:return function(e,t){const n=Kl(e),i=Kl(t);return n.compareTo(i)}(e.bytesValue,t.bytesValue);case 7:return function(e,t){const n=e.split("/"),i=t.split("/");for(let s=0;s<n.length&&s<i.length;s++){const e=pl(n[s],i[s]);if(0!==e)return e}return pl(n.length,i.length)}(e.referenceValue,t.referenceValue);case 8:return function(e,t){const n=pl(Hl(e.latitude),Hl(t.latitude));return 0!==n?n:pl(Hl(e.longitude),Hl(t.longitude))}(e.geoPointValue,t.geoPointValue);case 9:return ru(e.arrayValue,t.arrayValue);case 10:return function(e,t){var n,i,s,r;const o=e.fields||{},a=t.fields||{},c=null===(n=o.value)||void 0===n?void 0:n.arrayValue,h=null===(i=a.value)||void 0===i?void 0:i.arrayValue,l=pl((null===(s=null==c?void 0:c.values)||void 0===s?void 0:s.length)||0,(null===(r=null==h?void 0:h.values)||void 0===r?void 0:r.length)||0);return 0!==l?l:ru(c,h)}(e.mapValue,t.mapValue);case 11:return function(e,t){if(e===Zl&&t===Zl)return 0;if(e===Zl)return 1;if(t===Zl)return-1;const n=e.fields||{},i=Object.keys(n),s=t.fields||{},r=Object.keys(s);i.sort(),r.sort();for(let o=0;o<i.length&&o<r.length;++o){const e=pl(i[o],r[o]);if(0!==e)return e;const t=iu(n[i[o]],s[r[o]]);if(0!==t)return t}return pl(i.length,r.length)}(e.mapValue,t.mapValue);default:throw Xh()}}function su(e,t){if("string"==typeof e&&"string"==typeof t&&e.length===t.length)return pl(e,t);const n=Wl(e),i=Wl(t),s=pl(n.seconds,i.seconds);return 0!==s?s:pl(n.nanos,i.nanos)}function ru(e,t){const n=e.values||[],i=t.values||[];for(let s=0;s<n.length&&s<i.length;++s){const e=iu(n[s],i[s]);if(e)return e}return pl(n.length,i.length)}function ou(e){return au(e)}function au(e){return"nullValue"in e?"null":"booleanValue"in e?""+e.booleanValue:"integerValue"in e?""+e.integerValue:"doubleValue"in e?""+e.doubleValue:"timestampValue"in e?function(e){const t=Wl(e);return`time(${t.seconds},${t.nanos})`}(e.timestampValue):"stringValue"in e?e.stringValue:"bytesValue"in e?Kl(e.bytesValue).toBase64():"referenceValue"in e?function(e){return Il.fromName(e).toString()}(e.referenceValue):"geoPointValue"in e?function(e){return`geo(${e.latitude},${e.longitude})`}(e.geoPointValue):"arrayValue"in e?function(e){let t="[",n=!0;for(const i of e.values||[])n?n=!1:t+=",",t+=au(i);return t+"]"}(e.arrayValue):"mapValue"in e?function(e){const t=Object.keys(e.fields||{}).sort();let n="{",i=!0;for(const s of t)i?i=!1:n+=",",n+=`${s}:${au(e.fields[s])}`;return n+"}"}(e.mapValue):Xh()}function cu(e,t){return{referenceValue:`projects/${e.projectId}/databases/${e.database}/documents/${t.path.canonicalString()}`}}function hu(e){return!!e&&"integerValue"in e}function lu(e){return!!e&&"arrayValue"in e}function uu(e){return!!e&&"nullValue"in e}function du(e){return!!e&&"doubleValue"in e&&isNaN(Number(e.doubleValue))}function fu(e){return!!e&&"mapValue"in e}function pu(e){if(e.geoPointValue)return{geoPointValue:Object.assign({},e.geoPointValue)};if(e.timestampValue&&"object"==typeof e.timestampValue)return{timestampValue:Object.assign({},e.timestampValue)};if(e.mapValue){const t={mapValue:{fields:{}}};return Ol(e.mapValue.fields,(e,n)=>t.mapValue.fields[e]=pu(n)),t}if(e.arrayValue){const t={arrayValue:{values:[]}};for(let n=0;n<(e.arrayValue.values||[]).length;++n)t.arrayValue.values[n]=pu(e.arrayValue.values[n]);return t}return Object.assign({},e)}class gu{constructor(e){this.value=e}static empty(){return new gu({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!fu(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=pu(t)}setAll(e){let t=Tl.emptyPath(),n={},i=[];e.forEach((e,s)=>{if(!t.isImmediateParentOf(s)){const e=this.getFieldsMap(t);this.applyChanges(e,n,i),n={},i=[],t=s.popLast()}e?n[s.lastSegment()]=pu(e):i.push(s.lastSegment())});const s=this.getFieldsMap(t);this.applyChanges(s,n,i)}delete(e){const t=this.field(e.popLast());fu(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return tu(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let i=t.mapValue.fields[e.get(n)];fu(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=i),t=i}return t.mapValue.fields}applyChanges(e,t,n){Ol(t,(t,n)=>e[t]=n);for(const i of n)delete e[i]}clone(){return new gu(pu(this.value))}}function mu(e){const t=[];return Ol(e.fields,(e,n)=>{const i=new Tl([e]);if(fu(n)){const e=mu(n.mapValue).fields;if(0===e.length)t.push(i);else for(const n of e)t.push(i.child(n))}else t.push(i)}),new jl(t)
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class yu{constructor(e,t){this.position=e,this.inclusive=t}}function vu(e,t,n){let i=0;for(let s=0;s<e.position.length;s++){const r=t[s],o=e.position[s];if(i=r.field.isKeyField()?Il.comparator(Il.fromName(o.referenceValue),n.key):iu(o,n.data.field(r.field)),"desc"===r.dir&&(i*=-1),0!==i)break}return i}function wu(e,t){if(null===e)return null===t;if(null===t)return!1;if(e.inclusive!==t.inclusive||e.position.length!==t.position.length)return!1;for(let n=0;n<e.position.length;n++)if(!tu(e.position[n],t.position[n]))return!1;return!0}
/**
   * @license
   * Copyright 2022 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Tu{constructor(e,t="asc"){this.field=e,this.dir=t}}function Iu(e,t){return e.dir===t.dir&&e.field.isEqual(t.field)}
/**
   * @license
   * Copyright 2022 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class bu{}class Cu extends bu{constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}static create(e,t,n){return e.isKeyField()?"in"===t||"not-in"===t?this.createKeyFieldInFilter(e,t,n):new Pu(e,t,n):"array-contains"===t?new Lu(e,n):"in"===t?new Mu(e,n):"not-in"===t?new Fu(e,n):"array-contains-any"===t?new Uu(e,n):new Cu(e,t,n)}static createKeyFieldInFilter(e,t,n){return"in"===t?new Du(e,n):new xu(e,n)}matches(e){const t=e.data.field(this.field);return"!="===this.op?null!==t&&this.matchesComparison(iu(t,this.value)):null!==t&&eu(this.value)===eu(t)&&this.matchesComparison(iu(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return 0===e;case"!=":return 0!==e;case">":return e>0;case">=":return e>=0;default:return Xh()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Eu extends bu{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new Eu(e,t)}matches(e){return Su(this)?void 0===this.filters.find(t=>!t.matches(e)):void 0!==this.filters.find(t=>t.matches(e))}getFlattenedFilters(){return null!==this.ae||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Su(e){return"and"===e.op}function ku(e){return function(e){for(const t of e.filters)if(t instanceof Eu)return!1;return!0}(e)&&Su(e)}function Nu(e){if(e instanceof Cu)return e.field.canonicalString()+e.op.toString()+ou(e.value);if(ku(e))return e.filters.map(e=>Nu(e)).join(",");{const t=e.filters.map(e=>Nu(e)).join(",");return`${e.op}(${t})`}}function Au(e,t){return e instanceof Cu?(n=e,(i=t)instanceof Cu&&n.op===i.op&&n.field.isEqual(i.field)&&tu(n.value,i.value)):e instanceof Eu?function(e,t){return t instanceof Eu&&e.op===t.op&&e.filters.length===t.filters.length&&e.filters.reduce((e,n,i)=>e&&Au(n,t.filters[i]),!0)}(e,t):void Xh();var n,i}function Ru(e){return e instanceof Cu?`${(t=e).field.canonicalString()} ${t.op} ${ou(t.value)}`:e instanceof Eu?function(e){return e.op.toString()+" {"+e.getFilters().map(Ru).join(" ,")+"}"}(e):"Filter";var t}class Pu extends Cu{constructor(e,t,n){super(e,t,n),this.key=Il.fromName(n.referenceValue)}matches(e){const t=Il.comparator(e.key,this.key);return this.matchesComparison(t)}}class Du extends Cu{constructor(e,t){super(e,"in",t),this.keys=Ou("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class xu extends Cu{constructor(e,t){super(e,"not-in",t),this.keys=Ou("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function Ou(e,t){var n;return((null===(n=t.arrayValue)||void 0===n?void 0:n.values)||[]).map(e=>Il.fromName(e.referenceValue))}class Lu extends Cu{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return lu(t)&&nu(t.arrayValue,this.value)}}class Mu extends Cu{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return null!==t&&nu(this.value.arrayValue,t)}}class Fu extends Cu{constructor(e,t){super(e,"not-in",t)}matches(e){if(nu(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return null!==t&&!nu(this.value.arrayValue,t)}}class Uu extends Cu{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!lu(t)||!t.arrayValue.values)&&t.arrayValue.values.some(e=>nu(this.value.arrayValue,e))}}
/**
   * @license
   * Copyright 2019 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Vu{constructor(e,t=null,n=[],i=[],s=null,r=null,o=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=i,this.limit=s,this.startAt=r,this.endAt=o,this.ue=null}}function qu(e,t=null,n=[],i=[],s=null,r=null,o=null){return new Vu(e,t,n,i,s,r,o)}function ju(e){const t=el(e);if(null===t.ue){let e=t.path.canonicalString();null!==t.collectionGroup&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map(e=>Nu(e)).join(","),e+="|ob:",e+=t.orderBy.map(e=>{return(t=e).field.canonicalString()+t.dir;var t}).join(","),Pl(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map(e=>ou(e)).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map(e=>ou(e)).join(",")),t.ue=e}return t.ue}function Bu(e,t){if(e.limit!==t.limit)return!1;if(e.orderBy.length!==t.orderBy.length)return!1;for(let n=0;n<e.orderBy.length;n++)if(!Iu(e.orderBy[n],t.orderBy[n]))return!1;if(e.filters.length!==t.filters.length)return!1;for(let n=0;n<e.filters.length;n++)if(!Au(e.filters[n],t.filters[n]))return!1;return e.collectionGroup===t.collectionGroup&&!!e.path.isEqual(t.path)&&!!wu(e.startAt,t.startAt)&&wu(e.endAt,t.endAt)}function zu(e){return Il.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class $u{constructor(e,t=null,n=[],i=[],s=null,r="F",o=null,a=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=n,this.filters=i,this.limit=s,this.limitType=r,this.startAt=o,this.endAt=a,this.ce=null,this.le=null,this.he=null,this.startAt,this.endAt}}function Wu(e){return new $u(e)}function Hu(e){return 0===e.filters.length&&null===e.limit&&null==e.startAt&&null==e.endAt&&(0===e.explicitOrderBy.length||1===e.explicitOrderBy.length&&e.explicitOrderBy[0].field.isKeyField())}function Ku(e){return null!==e.collectionGroup}function Gu(e){const t=el(e);if(null===t.ce){t.ce=[];const e=new Set;for(const i of t.explicitOrderBy)t.ce.push(i),e.add(i.field.canonicalString());const n=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";(function(e){let t=new Vl(Tl.comparator);return e.filters.forEach(e=>{e.getFlattenedFilters().forEach(e=>{e.isInequality()&&(t=t.add(e.field))})}),t})(t).forEach(i=>{e.has(i.canonicalString())||i.isKeyField()||t.ce.push(new Tu(i,n))}),e.has(Tl.keyField().canonicalString())||t.ce.push(new Tu(Tl.keyField(),n))}return t.ce}function Qu(e){const t=el(e);return t.le||(t.le=function(e,t){if("F"===e.limitType)return qu(e.path,e.collectionGroup,t,e.filters,e.limit,e.startAt,e.endAt);{t=t.map(e=>{const t="desc"===e.dir?"asc":"desc";return new Tu(e.field,t)});const n=e.endAt?new yu(e.endAt.position,e.endAt.inclusive):null,i=e.startAt?new yu(e.startAt.position,e.startAt.inclusive):null;return qu(e.path,e.collectionGroup,t,e.filters,e.limit,n,i)}}(t,Gu(e))),t.le}function Yu(e,t){const n=e.filters.concat([t]);return new $u(e.path,e.collectionGroup,e.explicitOrderBy.slice(),n,e.limit,e.limitType,e.startAt,e.endAt)}function Ju(e,t,n){return new $u(e.path,e.collectionGroup,e.explicitOrderBy.slice(),e.filters.slice(),t,n,e.startAt,e.endAt)}function Xu(e,t){return Bu(Qu(e),Qu(t))&&e.limitType===t.limitType}function Zu(e){return`${ju(Qu(e))}|lt:${e.limitType}`}function ed(e){return`Query(target=${function(e){let t=e.path.canonicalString();return null!==e.collectionGroup&&(t+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(t+=`, filters: [${e.filters.map(e=>Ru(e)).join(", ")}]`),Pl(e.limit)||(t+=", limit: "+e.limit),e.orderBy.length>0&&(t+=`, orderBy: [${e.orderBy.map(e=>{return`${(t=e).field.canonicalString()} (${t.dir})`;var t}).join(", ")}]`),e.startAt&&(t+=", startAt: ",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(e=>ou(e)).join(",")),e.endAt&&(t+=", endAt: ",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(e=>ou(e)).join(",")),`Target(${t})`}(Qu(e))}; limitType=${e.limitType})`}function td(e,t){return t.isFoundDocument()&&function(e,t){const n=t.key.path;return null!==e.collectionGroup?t.key.hasCollectionId(e.collectionGroup)&&e.path.isPrefixOf(n):Il.isDocumentKey(e.path)?e.path.isEqual(n):e.path.isImmediateParentOf(n)}(e,t)&&function(e,t){for(const n of Gu(e))if(!n.field.isKeyField()&&null===t.data.field(n.field))return!1;return!0}(e,t)&&function(e,t){for(const n of e.filters)if(!n.matches(t))return!1;return!0}(e,t)&&(i=t,!((n=e).startAt&&!function(e,t,n){const i=vu(e,t,n);return e.inclusive?i<=0:i<0}(n.startAt,Gu(n),i)||n.endAt&&!function(e,t,n){const i=vu(e,t,n);return e.inclusive?i>=0:i>0}(n.endAt,Gu(n),i)));var n,i}function nd(e){return(t,n)=>{let i=!1;for(const s of Gu(e)){const e=id(s,t,n);if(0!==e)return e;i=i||s.field.isKeyField()}return 0}}function id(e,t,n){const i=e.field.isKeyField()?Il.comparator(t.key,n.key):function(e,t,n){const i=t.data.field(e),s=n.data.field(e);return null!==i&&null!==s?iu(i,s):Xh()}(e.field,t,n);switch(e.dir){case"asc":return i;case"desc":return-1*i;default:return Xh()}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const rd=new Ml(Il.comparator);function od(){return rd}const ad=new Ml(Il.comparator);function cd(...e){let t=ad;for(const n of e)t=t.insert(n.key,n);return t}function hd(e){let t=ad;return e.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function ld(){return dd()}function ud(){return dd()}function dd(){return new sd(e=>e.toString(),(e,t)=>e.isEqual(t))}const fd=new Ml(Il.comparator),pd=new Vl(Il.comparator);function gd(...e){let t=pd;for(const n of e)t=t.add(n);return t}const md=new Vl(pl);
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * limitations under the License.
   */
function _d(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Dl(t)?"-0":t}}function yd(e){return{integerValue:""+e}}function vd(e,t){return function(e){return"number"==typeof e&&Number.isInteger(e)&&!Dl(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}(t)?yd(t):_d(e,t)}
/**
   * @license
   * Copyright 2018 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class wd{constructor(){this._=void 0}}function Td(e,t,n){return e instanceof Cd?function(e,t){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:e.seconds,nanos:e.nanoseconds}}}};return t&&Gl(t)&&(t=Ql(t)),t&&(n.fields.__previous_value__=t),{mapValue:n}}(n,t):e instanceof Ed?Sd(e,t):e instanceof kd?Nd(e,t):function(e,t){const n=bd(e,t),i=Rd(n)+Rd(e.Pe);return hu(n)&&hu(e.Pe)?yd(i):_d(e.serializer,i)}(e,t)}function Id(e,t,n){return e instanceof Ed?Sd(e,t):e instanceof kd?Nd(e,t):n}function bd(e,t){return e instanceof Ad?hu(n=t)||(i=n)&&"doubleValue"in i?t:{integerValue:0}:null;var n,i}class Cd extends wd{}class Ed extends wd{constructor(e){super(),this.elements=e}}function Sd(e,t){const n=Pd(t);for(const i of e.elements)n.some(e=>tu(e,i))||n.push(i);return{arrayValue:{values:n}}}class kd extends wd{constructor(e){super(),this.elements=e}}function Nd(e,t){let n=Pd(t);for(const i of e.elements)n=n.filter(e=>!tu(e,i));return{arrayValue:{values:n}}}class Ad extends wd{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Rd(e){return Hl(e.integerValue||e.doubleValue)}function Pd(e){return lu(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Dd{constructor(e,t){this.field=e,this.transform=t}}class xd{constructor(e,t){this.version=e,this.transformResults=t}}class Od{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Od}static exists(e){return new Od(void 0,e)}static updateTime(e){return new Od(e)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Ld(e,t){return void 0!==e.updateTime?t.isFoundDocument()&&t.version.isEqual(e.updateTime):void 0===e.exists||e.exists===t.isFoundDocument()}class Md{}function Fd(e,t){if(!e.hasLocalMutations||t&&0===t.fields.length)return null;if(null===t)return e.isNoDocument()?new Kd(e.key,Od.none()):new Bd(e.key,e.data,Od.none());{const n=e.data,i=gu.empty();let s=new Vl(Tl.comparator);for(let e of t.fields)if(!s.has(e)){let t=n.field(e);null===t&&e.length>1&&(e=e.popLast(),t=n.field(e)),null===t?i.delete(e):i.set(e,t),s=s.add(e)}return new zd(e.key,i,new jl(s.toArray()),Od.none())}}function Ud(e,t,n){var i;e instanceof Bd?function(e,t,n){const i=e.value.clone(),s=Wd(e.fieldTransforms,t,n.transformResults);i.setAll(s),t.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(e,t,n):e instanceof zd?function(e,t,n){if(!Ld(e.precondition,t))return void t.convertToUnknownDocument(n.version);const i=Wd(e.fieldTransforms,t,n.transformResults),s=t.data;s.setAll($d(e)),s.setAll(i),t.convertToFoundDocument(n.version,s).setHasCommittedMutations()}(e,t,n):(i=n,t.convertToNoDocument(i.version).setHasCommittedMutations())}function Vd(e,t,n,i){return e instanceof Bd?function(e,t,n,i){if(!Ld(e.precondition,t))return n;const s=e.value.clone(),r=Hd(e.fieldTransforms,i,t);return s.setAll(r),t.convertToFoundDocument(t.version,s).setHasLocalMutations(),null}(e,t,n,i):e instanceof zd?function(e,t,n,i){if(!Ld(e.precondition,t))return n;const s=Hd(e.fieldTransforms,i,t),r=t.data;return r.setAll($d(e)),r.setAll(s),t.convertToFoundDocument(t.version,r).setHasLocalMutations(),null===n?null:n.unionWith(e.fieldMask.fields).unionWith(e.fieldTransforms.map(e=>e.field))}(e,t,n,i):(s=t,r=n,Ld(e.precondition,s)?(s.convertToNoDocument(s.version).setHasLocalMutations(),null):r);var s,r}function qd(e,t){let n=null;for(const i of e.fieldTransforms){const e=t.data.field(i.field),s=bd(i.transform,e||null);null!=s&&(null===n&&(n=gu.empty()),n.set(i.field,s))}return n||null}function jd(e,t){return e.type===t.type&&!!e.key.isEqual(t.key)&&!!e.precondition.isEqual(t.precondition)&&(n=e.fieldTransforms,i=t.fieldTransforms,!!(void 0===n&&void 0===i||n&&i&&gl(n,i,(e,t)=>function(e,t){return e.field.isEqual(t.field)&&(n=e.transform,i=t.transform,n instanceof Ed&&i instanceof Ed||n instanceof kd&&i instanceof kd?gl(n.elements,i.elements,tu):n instanceof Ad&&i instanceof Ad?tu(n.Pe,i.Pe):n instanceof Cd&&i instanceof Cd);var n,i}(e,t)))&&(0===e.type?e.value.isEqual(t.value):1!==e.type||e.data.isEqual(t.data)&&e.fieldMask.isEqual(t.fieldMask)));var n,i}class Bd extends Md{constructor(e,t,n,i=[]){super(),this.key=e,this.value=t,this.precondition=n,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class zd extends Md{constructor(e,t,n,i,s=[]){super(),this.key=e,this.data=t,this.fieldMask=n,this.precondition=i,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function $d(e){const t=new Map;return e.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const i=e.data.field(n);t.set(n,i)}}),t}function Wd(e,t,n){const i=new Map;Zh(e.length===n.length);for(let s=0;s<n.length;s++){const r=e[s],o=r.transform,a=t.data.field(r.field);i.set(r.field,Id(o,a,n[s]))}return i}function Hd(e,t,n){const i=new Map;for(const s of e){const e=s.transform,r=n.data.field(s.field);i.set(s.field,Td(e,r,t))}return i}class Kd extends Md{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Gd extends Md{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Qd{constructor(e,t,n,i){this.batchId=e,this.localWriteTime=t,this.baseMutations=n,this.mutations=i}applyToRemoteDocument(e,t){const n=t.mutationResults;for(let i=0;i<this.mutations.length;i++){const t=this.mutations[i];t.key.isEqual(e.key)&&Ud(t,e,n[i])}}applyToLocalView(e,t){for(const n of this.baseMutations)n.key.isEqual(e.key)&&(t=Vd(n,e,t,this.localWriteTime));for(const n of this.mutations)n.key.isEqual(e.key)&&(t=Vd(n,e,t,this.localWriteTime));return t}applyToLocalDocumentSet(e,t){const n=ud();return this.mutations.forEach(i=>{const s=e.get(i.key),r=s.overlayedDocument;let o=this.applyToLocalView(r,s.mutatedFields);o=t.has(i.key)?null:o;const a=Fd(r,o);null!==a&&n.set(i.key,a),r.isValidDocument()||r.convertToNoDocument(_l.min())}),n}keys(){return this.mutations.reduce((e,t)=>e.add(t.key),gd())}isEqual(e){return this.batchId===e.batchId&&gl(this.mutations,e.mutations,(e,t)=>jd(e,t))&&gl(this.baseMutations,e.baseMutations,(e,t)=>jd(e,t))}}class Yd{constructor(e,t,n,i){this.batch=e,this.commitVersion=t,this.mutationResults=n,this.docVersions=i}static from(e,t,n){Zh(e.mutations.length===n.length);let i=function(){return fd}();const s=e.mutations;for(let r=0;r<s.length;r++)i=i.insert(s[r].key,n[r].version);return new Yd(e,t,n,i)}}
/**
   * @license
   * Copyright 2022 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Jd{constructor(e,t){this.largestBatchId=e,this.mutation=t}getKey(){return this.mutation.key}isEqual(e){return null!==e&&this.mutation===e.mutation}toString(){return`Overlay{\n      largestBatchId: ${this.largestBatchId},\n      mutation: ${this.mutation.toString()}\n    }`}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */var Zd,ef;function tf(e){if(void 0===e)return Qh("GRPC error has no .code"),tl.UNKNOWN;switch(e){case Zd.OK:return tl.OK;case Zd.CANCELLED:return tl.CANCELLED;case Zd.UNKNOWN:return tl.UNKNOWN;case Zd.DEADLINE_EXCEEDED:return tl.DEADLINE_EXCEEDED;case Zd.RESOURCE_EXHAUSTED:return tl.RESOURCE_EXHAUSTED;case Zd.INTERNAL:return tl.INTERNAL;case Zd.UNAVAILABLE:return tl.UNAVAILABLE;case Zd.UNAUTHENTICATED:return tl.UNAUTHENTICATED;case Zd.INVALID_ARGUMENT:return tl.INVALID_ARGUMENT;case Zd.NOT_FOUND:return tl.NOT_FOUND;case Zd.ALREADY_EXISTS:return tl.ALREADY_EXISTS;case Zd.PERMISSION_DENIED:return tl.PERMISSION_DENIED;case Zd.FAILED_PRECONDITION:return tl.FAILED_PRECONDITION;case Zd.ABORTED:return tl.ABORTED;case Zd.OUT_OF_RANGE:return tl.OUT_OF_RANGE;case Zd.UNIMPLEMENTED:return tl.UNIMPLEMENTED;case Zd.DATA_LOSS:return tl.DATA_LOSS;default:return Xh()}}(ef=Zd||(Zd={}))[ef.OK=0]="OK",ef[ef.CANCELLED=1]="CANCELLED",ef[ef.UNKNOWN=2]="UNKNOWN",ef[ef.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",ef[ef.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",ef[ef.NOT_FOUND=5]="NOT_FOUND",ef[ef.ALREADY_EXISTS=6]="ALREADY_EXISTS",ef[ef.PERMISSION_DENIED=7]="PERMISSION_DENIED",ef[ef.UNAUTHENTICATED=16]="UNAUTHENTICATED",ef[ef.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",ef[ef.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",ef[ef.ABORTED=10]="ABORTED",ef[ef.OUT_OF_RANGE=11]="OUT_OF_RANGE",ef[ef.UNIMPLEMENTED=12]="UNIMPLEMENTED",ef[ef.INTERNAL=13]="INTERNAL",ef[ef.UNAVAILABLE=14]="UNAVAILABLE",ef[ef.DATA_LOSS=15]="DATA_LOSS";
/**
   * @license
   * Copyright 2022 Google LLC
   *
   ...
   * limitations under the License.
   */
const nf=new Ph([4294967295,4294967295],0);function sf(e){const t=(new TextEncoder).encode(e),n=new Dh;return n.update(t),new Uint8Array(n.digest())}function rf(e){const t=new DataView(e.buffer),n=t.getUint32(0,!0),i=t.getUint32(4,!0),s=t.getUint32(8,!0),r=t.getUint32(12,!0);return[new Ph([n,i],0),new Ph([s,r],0)]}class of{constructor(e,t,n){if(this.bitmap=e,this.padding=t,this.hashCount=n,t<0||t>=8)throw new af(`Invalid padding: ${t}`);if(n<0)throw new af(`Invalid hash count: ${n}`);if(e.length>0&&0===this.hashCount)throw new af(`Invalid hash count: ${n}`);if(0===e.length&&0!==t)throw new af(`Invalid padding when bitmap length is 0: ${t}`);this.Ie=8*e.length-t,this.Te=Ph.fromNumber(this.Ie)}Ee(e,t,n){let i=e.add(t.multiply(Ph.fromNumber(n)));return 1===i.compare(nf)&&(i=new Ph([i.getBits(0),i.getBits(1)],0)),i.modulo(this.Te).toNumber()}de(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(0===this.Ie)return!1;const t=sf(e),[n,i]=rf(t);for(let s=0;s<this.hashCount;s++){const e=this.Ee(n,i,s);if(!this.de(e))return!1}return!0}static create(e,t,n){const i=e%8==0?0:8-e%8,s=new Uint8Array(Math.ceil(e/8)),r=new of(s,i,t);return n.forEach(e=>r.insert(e)),r}insert(e){if(0===this.Ie)return;const t=sf(e),[n,i]=rf(t);for(let s=0;s<this.hashCount;s++){const e=this.Ee(n,i,s);this.Ae(e)}}Ae(e){const t=Math.floor(e/8),n=e%8;this.bitmap[t]|=1<<n}}class af extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class cf{constructor(e,t,n,i,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const i=new Map;return i.set(e,hf.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new cf(_l.min(),i,new Ml(pl),od(),gd())}}class hf{constructor(e,t,n,i,s){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new hf(n,t,gd(),gd(),gd())}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class lf{constructor(e,t,n,i){this.Re=e,this.removedTargetIds=t,this.key=n,this.Ve=i}}class uf{constructor(e,t){this.targetId=e,this.me=t}}class df{constructor(e,t,n=zl.EMPTY_BYTE_STRING,i=null){this.state=e,this.targetIds=t,this.resumeToken=n,this.cause=i}}class ff{constructor(){this.fe=0,this.ge=mf(),this.pe=zl.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return 0!==this.fe}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=gd(),t=gd(),n=gd();return this.ge.forEach((i,s)=>{switch(s){case 0:e=e.add(i);break;case 2:t=t.add(i);break;case 1:n=n.add(i);break;default:Xh()}}),new hf(this.pe,this.ye,e,t,n)}Ce(){this.we=!1,this.ge=mf()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,Zh(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class pf{constructor(e){this.Le=e,this.Be=new Map,this.ke=od(),this.qe=gf(),this.Qe=new Ml(pl)}Ke(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.$e(t,e.Ve):this.Ue(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.Ue(t,e.key,e.Ve)}We(e){this.forEachTarget(e,t=>{const n=this.Ge(t);switch(e.state){case 0:this.ze(t)&&n.De(e.resumeToken);break;case 1:n.Oe(),n.Se||n.Ce(),n.De(e.resumeToken);break;case 2:n.Oe(),n.Se||this.removeTarget(t);break;case 3:this.ze(t)&&(n.Ne(),n.De(e.resumeToken));break;case 4:this.ze(t)&&(this.je(t),n.De(e.resumeToken));break;default:Xh()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Be.forEach((e,n)=>{this.ze(n)&&t(n)})}He(e){const t=e.targetId,n=e.me.count,i=this.Je(t);if(i){const s=i.target;if(zu(s))if(0===n){const e=new Il(s.path);this.Ue(t,e,_u.newNoDocument(e,_l.min()))}else Zh(1===n);else{const i=this.Ye(t);if(i!==n){const n=this.Ze(e),s=n?this.Xe(n,e,i):1;if(0!==s){this.je(t);const e=2===s?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Qe=this.Qe.insert(t,e)}}}}}Ze(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:n="",padding:i=0},hashCount:s=0}=t;let r,o;try{r=Kl(n).toUint8Array()}catch(a){if(a instanceof Bl)return Yh("Decoding the base64 bloom filter in existence filter failed ("+a.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw a}try{o=new of(r,i,s)}catch(a){return Yh(a instanceof af?"BloomFilter error: ":"Applying bloom filter failed: ",a),null}return 0===o.Ie?null:o}Xe(e,t,n){return t.me.count===n-this.nt(e,t.targetId)?0:2}nt(e,t){const n=this.Le.getRemoteKeysForTarget(t);let i=0;return n.forEach(n=>{const s=this.Le.tt(),r=`projects/${s.projectId}/databases/${s.database}/documents/${n.path.canonicalString()}`;e.mightContain(r)||(this.Ue(t,n,null),i++)}),i}rt(e){const t=new Map;this.Be.forEach((n,i)=>{const s=this.Je(i);if(s){if(n.current&&zu(s.target)){const t=new Il(s.target.path);null!==this.ke.get(t)||this.it(i,t)||this.Ue(i,t,_u.newNoDocument(t,e))}n.be&&(t.set(i,n.ve()),n.Ce())}});let n=gd();this.qe.forEach((e,t)=>{let i=!0;t.forEachWhile(e=>{const t=this.Je(e);return!t||"TargetPurposeLimboResolution"===t.purpose||(i=!1,!1)}),i&&(n=n.add(e))}),this.ke.forEach((t,n)=>n.setReadTime(e));const i=new cf(e,t,this.Qe,this.ke,n);return this.ke=od(),this.qe=gf(),this.Qe=new Ml(pl),i}$e(e,t){if(!this.ze(e))return;const n=this.it(e,t.key)?2:0;this.Ge(e).Fe(t.key,n),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e))}Ue(e,t,n){if(!this.ze(e))return;const i=this.Ge(e);this.it(e,t)?i.Fe(t,1):i.Me(t),this.qe=this.qe.insert(t,this.st(t).delete(e)),n&&(this.ke=this.ke.insert(t,n))}removeTarget(e){this.Be.delete(e)}Ye(e){const t=this.Ge(e).ve();return this.Le.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.Ge(e).xe()}Ge(e){let t=this.Be.get(e);return t||(t=new ff,this.Be.set(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new Vl(pl),this.qe=this.qe.insert(e,t)),t}ze(e){const t=null!==this.Je(e);return t||Gh("WatchChangeAggregator","Detected inactive target",e),t}Je(e){const t=this.Be.get(e);return t&&t.Se?null:this.Le.ot(e)}je(e){this.Be.set(e,new ff),this.Le.getRemoteKeysForTarget(e).forEach(t=>{this.Ue(e,t,null)})}it(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function gf(){return new Ml(Il.comparator)}function mf(){return new Ml(Il.comparator)}const _f=(()=>({asc:"ASCENDING",desc:"DESCENDING"}))(),yf=(()=>({"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"}))(),vf=(()=>({and:"AND",or:"OR"}))();class wf{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Tf(e,t){return e.useProto3Json||Pl(t)?t:{value:t}}function If(e,t){return e.useProto3Json?`${new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+t.nanoseconds).slice(-9)}Z`:{seconds:""+t.seconds,nanos:t.nanoseconds}}function bf(e,t){return e.useProto3Json?t.toBase64():t.toUint8Array()}function Cf(e,t){return If(e,t.toTimestamp())}function Ef(e){return Zh(!!e),_l.fromTimestamp(function(e){const t=Wl(e);return new ml(t.seconds,t.nanos)}(e))}function Sf(e,t){return kf(e,t).canonicalString()}function kf(e,t){const n=(i=e,new vl(["projects",i.projectId,"databases",i.database])).child("documents");var i;return void 0===t?n:n.child(t)}function Nf(e){const t=vl.fromString(e);return Zh(Hf(t)),t}function Af(e,t){return Sf(e.databaseId,t.path)}function Rf(e,t){const n=Nf(t);if(n.get(1)!==e.databaseId.projectId)throw new nl(tl.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+e.databaseId.projectId);if(n.get(3)!==e.databaseId.database)throw new nl(tl.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+e.databaseId.database);return new Il(xf(n))}function Pf(e,t){return Sf(e.databaseId,t)}function Df(e){return new vl(["projects",e.databaseId.projectId,"databases",e.databaseId.database]).canonicalString()}function xf(e){return Zh(e.length>4&&"documents"===e.get(4)),e.popFirst(5)}function Of(e,t,n){return{name:Af(e,t),fields:n.value.mapValue.fields}}function Lf(e,t){return{documents:[Pf(e,t.path)]}}function Mf(e,t){const n={structuredQuery:{}},i=t.path;let s;null!==t.collectionGroup?(s=i,n.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(s=i.popLast(),n.structuredQuery.from=[{collectionId:i.lastSegment()}]),n.parent=Pf(e,s);const r=function(e){if(0!==e.length)return $f(Eu.create(e,"and"))}(t.filters);r&&(n.structuredQuery.where=r);const o=function(e){if(0!==e.length)return e.map(e=>{return{field:Bf((t=e).field),direction:Vf(t.dir)};var t})}(t.orderBy);o&&(n.structuredQuery.orderBy=o);const a=Tf(e,t.limit);return null!==a&&(n.structuredQuery.limit=a),t.startAt&&(n.structuredQuery.startAt={before:(c=t.startAt).inclusive,values:c.position}),t.endAt&&(n.structuredQuery.endAt=function(e){return{before:!e.inclusive,values:e.position}}(t.endAt)),{_t:n,parent:s};var c}function Ff(e){let t=function(e){const t=Nf(e);return 4===t.length?vl.emptyPath():xf(t)}(e.parent);const n=e.structuredQuery,i=n.from?n.from.length:0;let s=null;if(i>0){Zh(1===i);const e=n.from[0];e.allDescendants?s=e.collectionId:t=t.child(e.collectionId)}let r=[];n.where&&(r=function(e){const t=Uf(e);return t instanceof Eu&&ku(t)?t.getFilters():[t]}(n.where));let o=[];n.orderBy&&(o=n.orderBy.map(e=>{return new Tu(zf((t=e).field),function(e){switch(e){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(t.direction));var t}));let a=null;n.limit&&(a=function(e){let t;return t="object"==typeof e?e.value:e,Pl(t)?null:t}(n.limit));let c=null;n.startAt&&(c=function(e){const t=!!e.before,n=e.values||[];return new yu(n,t)}(n.startAt));let h=null;return n.endAt&&(h=function(e){const t=!e.before,n=e.values||[];return new yu(n,t)}(n.endAt)),function(e,t,n,i,s,r,o,a){return new $u(e,t,n,i,s,r,o,a)}(t,s,o,r,a,"F",c,h)}function Uf(e){return void 0!==e.unaryFilter?function(e){switch(e.unaryFilter.op){case"IS_NAN":const t=zf(e.unaryFilter.field);return Cu.create(t,"==",{doubleValue:NaN});case"IS_NULL":const n=zf(e.unaryFilter.field);return Cu.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=zf(e.unaryFilter.field);return Cu.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const s=zf(e.unaryFilter.field);return Cu.create(s,"!=",{nullValue:"NULL_VALUE"});default:return Xh()}}(e):void 0!==e.fieldFilter?(t=e,Cu.create(zf(t.fieldFilter.field),function(e){switch(e){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return Xh()}}(t.fieldFilter.op),t.fieldFilter.value)):void 0!==e.compositeFilter?function(e){return Eu.create(e.compositeFilter.filters.map(e=>Uf(e)),function(e){switch(e){case"AND":return"and";case"OR":return"or";default:return Xh()}}(e.compositeFilter.op))}(e):Xh();var t}function Vf(e){return _f[e]}function qf(e){return yf[e]}function jf(e){return vf[e]}function Bf(e){return{fieldPath:e.canonicalString()}}function zf(e){return Tl.fromServerFormat(e.fieldPath)}function $f(e){return e instanceof Cu?function(e){if("=="===e.op){if(du(e.value))return{unaryFilter:{field:Bf(e.field),op:"IS_NAN"}};if(uu(e.value))return{unaryFilter:{field:Bf(e.field),op:"IS_NULL"}}}else if("!="===e.op){if(du(e.value))return{unaryFilter:{field:Bf(e.field),op:"IS_NOT_NAN"}};if(uu(e.value))return{unaryFilter:{field:Bf(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Bf(e.field),op:qf(e.op),value:e.value}}}(e):e instanceof Eu?function(e){const t=e.getFilters().map(e=>$f(e));return 1===t.length?t[0]:{compositeFilter:{op:jf(e.op),filters:t}}}(e):Xh()}function Wf(e){const t=[];return e.fields.forEach(e=>t.push(e.canonicalString())),{fieldPaths:t}}function Hf(e){return e.length>=4&&"projects"===e.get(0)&&"databases"===e.get(2)}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Gf{constructor(e){this.ct=e}}function Qf(e){const t=Ff({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?Ju(t,t.limit,"L"):t}
/**
   * @license
   * Copyright 2019 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Xf{constructor(e){this.Ln=e}next(){return this.Ln+=2,this.Ln}static Bn(){return new Xf(0)}static kn(){return new Xf(-1)}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Zf{constructor(){this.changes=new sd(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,_u.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return void 0!==n?Nl.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class tp{constructor(e,t,n,i){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=n,this.indexManager=i}getDocument(e,t){let n=null;return this.documentOverlayCache.getOverlay(e,t).next(i=>(n=i,this.remoteDocumentCache.getEntry(e,t))).next(e=>(null!==n&&Vd(n.mutation,e,jl.empty(),ml.now()),e))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(t=>this.getLocalViewOfDocuments(e,t,gd()).next(()=>t))}getLocalViewOfDocuments(e,t,n=gd()){const i=ld();return this.populateOverlays(e,i,t).next(()=>this.computeViews(e,t,i,n).next(e=>{let t=cd();return e.forEach((e,n)=>{t=t.insert(e,n.overlayedDocument)}),t}))}getOverlayedDocuments(e,t){const n=ld();return this.populateOverlays(e,n,t).next(()=>this.computeViews(e,t,n,gd()))}populateOverlays(e,t,n){const i=[];return n.forEach(e=>{t.has(e)||i.push(e)}),this.documentOverlayCache.getOverlays(e,i).next(e=>{e.forEach((e,n)=>{t.set(e,n)})})}computeViews(e,t,n,i){let s=od();const r=dd(),o=dd();return t.forEach((e,t)=>{const o=n.get(t.key);i.has(t.key)&&(void 0===o||o.mutation instanceof zd)?s=s.insert(t.key,t):void 0!==o?(r.set(t.key,o.mutation.getFieldMask()),Vd(o.mutation,t,o.mutation.getFieldMask(),ml.now())):r.set(t.key,jl.empty())}),this.recalculateAndSaveOverlays(e,s).next(e=>(e.forEach((e,t)=>r.set(e,t)),t.forEach((e,t)=>{var n;return o.set(e,new ep(t,null!==(n=r.get(e))&&void 0!==n?n:null))}),o))}recalculateAndSaveOverlays(e,t){const n=dd();let i=new Ml((e,t)=>e-t),s=gd();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(e=>{for(const s of e)s.keys().forEach(e=>{const r=t.get(e);if(null===r)return;let o=n.get(e)||jl.empty();o=s.applyToLocalView(r,o),n.set(e,o);const a=(i.get(s.batchId)||gd()).add(e);i=i.insert(s.batchId,a)})}).next(()=>{const r=[],o=i.getReverseIterator();for(;o.hasNext();){const i=o.getNext(),a=i.key,c=i.value,h=ud();c.forEach(e=>{if(!s.has(e)){const i=Fd(t.get(e),n.get(e));null!==i&&h.set(e,i),s=s.add(e)}}),r.push(this.documentOverlayCache.saveOverlays(e,a,h))}return Nl.waitFor(r)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(t=>this.recalculateAndSaveOverlays(e,t))}getDocumentsMatchingQuery(e,t,n,i){return s=t,Il.isDocumentKey(s.path)&&null===s.collectionGroup&&0===s.filters.length?this.getDocumentsMatchingDocumentQuery(e,t.path):Ku(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,n,i):this.getDocumentsMatchingCollectionQuery(e,t,n,i);var s}getNextDocuments(e,t,n,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,n,i).next(s=>{const r=i-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,n.largestBatchId,i-s.size):Nl.resolve(ld());let o=-1,a=s;return r.next(t=>Nl.forEach(t,(t,n)=>(o<n.largestBatchId&&(o=n.largestBatchId),s.get(t)?Nl.resolve():this.remoteDocumentCache.getEntry(e,t).next(e=>{a=a.insert(t,e)}))).next(()=>this.populateOverlays(e,t,s)).next(()=>this.computeViews(e,a,t,gd())).next(e=>({batchId:o,changes:hd(e)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new Il(t)).next(e=>{let t=cd();return e.isFoundDocument()&&(t=t.insert(e.key,e)),t})}getDocumentsMatchingCollectionGroupQuery(e,t,n,i){const s=t.collectionGroup;let r=cd();return this.indexManager.getCollectionParents(e,s).next(o=>Nl.forEach(o,o=>{const a=(c=t,h=o.child(s),new $u(h,null,c.explicitOrderBy.slice(),c.filters.slice(),c.limit,c.limitType,c.startAt,c.endAt));var c,h;return this.getDocumentsMatchingCollectionQuery(e,a,n,i).next(e=>{e.forEach((e,t)=>{r=r.insert(e,t)})})}).next(()=>r))}getDocumentsMatchingCollectionQuery(e,t,n,i){let s;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,n.largestBatchId).next(r=>(s=r,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,n,s,i))).next(e=>{s.forEach((t,n)=>{const i=n.getKey();null===e.get(i)&&(e=e.insert(i,_u.newInvalidDocument(i)))});let n=cd();return e.forEach((e,i)=>{const r=s.get(e);void 0!==r&&Vd(r.mutation,i,jl.empty(),ml.now()),td(t,i)&&(n=n.insert(e,i))}),n})}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class np{constructor(e){this.serializer=e,this.hr=new Map,this.Pr=new Map}getBundleMetadata(e,t){return Nl.resolve(this.hr.get(t))}saveBundleMetadata(e,t){return this.hr.set(t.id,{id:(n=t).id,version:n.version,createTime:Ef(n.createTime)}),Nl.resolve();var n}getNamedQuery(e,t){return Nl.resolve(this.Pr.get(t))}saveNamedQuery(e,t){return this.Pr.set(t.name,{name:(n=t).name,query:Qf(n.bundledQuery),readTime:Ef(n.readTime)}),Nl.resolve();var n}}
/**
   * @license
   * Copyright 2022 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class ip{constructor(){this.overlays=new Ml(Il.comparator),this.Ir=new Map}getOverlay(e,t){return Nl.resolve(this.overlays.get(t))}getOverlays(e,t){const n=ld();return Nl.forEach(t,t=>this.getOverlay(e,t).next(e=>{null!==e&&n.set(t,e)})).next(()=>n)}saveOverlays(e,t,n){return n.forEach((n,i)=>{this.ht(e,t,i)}),Nl.resolve()}removeOverlaysForBatchId(e,t,n){const i=this.Ir.get(n);return void 0!==i&&(i.forEach(e=>this.overlays=this.overlays.remove(e)),this.Ir.delete(n)),Nl.resolve()}getOverlaysForCollection(e,t,n){const i=ld(),s=t.length+1,r=new Il(t.child("")),o=this.overlays.getIteratorFrom(r);for(;o.hasNext();){const e=o.getNext().value,r=e.getKey();if(!t.isPrefixOf(r.path))break;r.path.length===s&&e.largestBatchId>n&&i.set(e.getKey(),e)}return Nl.resolve(i)}getOverlaysForCollectionGroup(e,t,n,i){let s=new Ml((e,t)=>e-t);const r=this.overlays.getIterator();for(;r.hasNext();){const e=r.getNext().value;if(e.getKey().getCollectionGroup()===t&&e.largestBatchId>n){let t=s.get(e.largestBatchId);null===t&&(t=ld(),s=s.insert(e.largestBatchId,t)),t.set(e.getKey(),e)}}const o=ld(),a=s.getIterator();for(;a.hasNext()&&(a.getNext().value.forEach((e,t)=>o.set(e,t)),!(o.size()>=i)););return Nl.resolve(o)}ht(e,t,n){const i=this.overlays.get(n.key);if(null!==i){const e=this.Ir.get(i.largestBatchId).delete(n.key);this.Ir.set(i.largestBatchId,e)}this.overlays=this.overlays.insert(n.key,new Jd(t,n));let s=this.Ir.get(t);void 0===s&&(s=gd(),this.Ir.set(t,s)),this.Ir.set(t,s.add(n.key))}}
/**
   * @license
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class sp{constructor(){this.sessionToken=zl.EMPTY_BYTE_STRING}getSessionToken(e){return Nl.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,Nl.resolve()}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class rp{constructor(){this.Tr=new Vl(op.Er),this.dr=new Vl(op.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const n=new op(e,t);this.Tr=this.Tr.add(n),this.dr=this.dr.add(n)}Rr(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.Vr(new op(e,t))}mr(e,t){e.forEach(e=>this.removeReference(e,t))}gr(e){const t=new Il(new vl([])),n=new op(t,e),i=new op(t,e+1),s=[];return this.dr.forEachInRange([n,i],e=>{this.Vr(e),s.push(e.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new Il(new vl([])),n=new op(t,e),i=new op(t,e+1);let s=gd();return this.dr.forEachInRange([n,i],e=>{s=s.add(e.key)}),s}containsKey(e){const t=new op(e,0),n=this.Tr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class op{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return Il.comparator(e.key,t.key)||pl(e.wr,t.wr)}static Ar(e,t){return pl(e.wr,t.wr)||Il.comparator(e.key,t.key)}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class ap{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Sr=1,this.br=new Vl(op.Er)}checkEmpty(e){return Nl.resolve(0===this.mutationQueue.length)}addMutationBatch(e,t,n,i){const s=this.Sr;this.Sr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const r=new Qd(s,t,n,i);this.mutationQueue.push(r);for(const o of i)this.br=this.br.add(new op(o.key,s)),this.indexManager.addToCollectionParentIndex(e,o.key.path.popLast());return Nl.resolve(r)}lookupMutationBatch(e,t){return Nl.resolve(this.Dr(t))}getNextMutationBatchAfterBatchId(e,t){const n=t+1,i=this.vr(n),s=i<0?0:i;return Nl.resolve(this.mutationQueue.length>s?this.mutationQueue[s]:null)}getHighestUnacknowledgedBatchId(){return Nl.resolve(0===this.mutationQueue.length?-1:this.Sr-1)}getAllMutationBatches(e){return Nl.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const n=new op(t,0),i=new op(t,Number.POSITIVE_INFINITY),s=[];return this.br.forEachInRange([n,i],e=>{const t=this.Dr(e.wr);s.push(t)}),Nl.resolve(s)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new Vl(pl);return t.forEach(e=>{const t=new op(e,0),i=new op(e,Number.POSITIVE_INFINITY);this.br.forEachInRange([t,i],e=>{n=n.add(e.wr)})}),Nl.resolve(this.Cr(n))}getAllMutationBatchesAffectingQuery(e,t){const n=t.path,i=n.length+1;let s=n;Il.isDocumentKey(s)||(s=s.child(""));const r=new op(new Il(s),0);let o=new Vl(pl);return this.br.forEachWhile(e=>{const t=e.key.path;return!!n.isPrefixOf(t)&&(t.length===i&&(o=o.add(e.wr)),!0)},r),Nl.resolve(this.Cr(o))}Cr(e){const t=[];return e.forEach(e=>{const n=this.Dr(e);null!==n&&t.push(n)}),t}removeMutationBatch(e,t){Zh(0===this.Fr(t.batchId,"removed")),this.mutationQueue.shift();let n=this.br;return Nl.forEach(t.mutations,i=>{const s=new op(i.key,t.batchId);return n=n.delete(s),this.referenceDelegate.markPotentiallyOrphaned(e,i.key)}).next(()=>{this.br=n})}On(e){}containsKey(e,t){const n=new op(t,0),i=this.br.firstAfterOrEqual(n);return Nl.resolve(t.isEqual(i&&i.key))}performConsistencyCheck(e){return this.mutationQueue.length,Nl.resolve()}Fr(e,t){return this.vr(e)}vr(e){return 0===this.mutationQueue.length?0:e-this.mutationQueue[0].batchId}Dr(e){const t=this.vr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class cp{constructor(e){this.Mr=e,this.docs=new Ml(Il.comparator),this.size=0}setIndexManager(e){this.indexManager=e}addEntry(e,t){const n=t.key,i=this.docs.get(n),s=i?i.size:0,r=this.Mr(t);return this.docs=this.docs.insert(n,{document:t.mutableCopy(),size:r}),this.size+=r-s,this.indexManager.addToCollectionParentIndex(e,n.path.popLast())}removeEntry(e){const t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}getEntry(e,t){const n=this.docs.get(t);return Nl.resolve(n?n.document.mutableCopy():_u.newInvalidDocument(t))}getEntries(e,t){let n=od();return t.forEach(e=>{const t=this.docs.get(e);n=n.insert(e,t?t.document.mutableCopy():_u.newInvalidDocument(e))}),Nl.resolve(n)}getDocumentsMatchingQuery(e,t,n,i){let s=od();const r=t.path,o=new Il(r.child("")),a=this.docs.getIteratorFrom(o);for(;a.hasNext();){const{key:e,value:{document:o}}=a.getNext();if(!r.isPrefixOf(e.path))break;e.path.length>r.length+1||El(bl(o),n)<=0||(i.has(o.key)||td(t,o))&&(s=s.insert(o.key,o.mutableCopy()))}return Nl.resolve(s)}getAllFromCollectionGroup(e,t,n,i){Xh()}Or(e,t){return Nl.forEach(this.docs,e=>t(e))}newChangeBuffer(e){return new hp(this)}getSize(e){return Nl.resolve(this.size)}}class hp extends Zf{constructor(e){super(),this.cr=e}applyChanges(e){const t=[];return this.changes.forEach((n,i)=>{i.isValidDocument()?t.push(this.cr.addEntry(e,i)):this.cr.removeEntry(n)}),Nl.waitFor(t)}getFromCache(e,t){return this.cr.getEntry(e,t)}getAllFromCache(e,t){return this.cr.getEntries(e,t)}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class lp{constructor(e){this.persistence=e,this.Nr=new sd(e=>ju(e),Bu),this.lastRemoteSnapshotVersion=_l.min(),this.highestTargetId=0,this.Lr=0,this.Br=new rp,this.targetCount=0,this.kr=Xf.Bn()}forEachTarget(e,t){return this.Nr.forEach((e,n)=>t(n)),Nl.resolve()}getLastRemoteSnapshotVersion(e){return Nl.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(e){return Nl.resolve(this.Lr)}allocateTargetId(e){return this.highestTargetId=this.kr.next(),Nl.resolve(this.highestTargetId)}setTargetsMetadata(e,t,n){return n&&(this.lastRemoteSnapshotVersion=n),t>this.Lr&&(this.Lr=t),Nl.resolve()}Kn(e){this.Nr.set(e.target,e);const t=e.targetId;t>this.highestTargetId&&(this.kr=new Xf(t),this.highestTargetId=t),e.sequenceNumber>this.Lr&&(this.Lr=e.sequenceNumber)}addTargetData(e,t){return this.Kn(t),this.targetCount+=1,Nl.resolve()}updateTargetData(e,t){return this.Kn(t),Nl.resolve()}removeTargetData(e,t){return this.Nr.delete(t.target),this.Br.gr(t.targetId),this.targetCount-=1,Nl.resolve()}removeTargets(e,t,n){let i=0;const s=[];return this.Nr.forEach((r,o)=>{o.sequenceNumber<=t&&null===n.get(o.targetId)&&(this.Nr.delete(r),s.push(this.removeMatchingKeysForTargetId(e,o.targetId)),i++)}),Nl.waitFor(s).next(()=>i)}getTargetCount(e){return Nl.resolve(this.targetCount)}getTargetData(e,t){const n=this.Nr.get(t)||null;return Nl.resolve(n)}addMatchingKeys(e,t,n){return this.Br.Rr(t,n),Nl.resolve()}removeMatchingKeys(e,t,n){this.Br.mr(t,n);const i=this.persistence.referenceDelegate,s=[];return i&&t.forEach(t=>{s.push(i.markPotentiallyOrphaned(e,t))}),Nl.waitFor(s)}removeMatchingKeysForTargetId(e,t){return this.Br.gr(t),Nl.resolve()}getMatchingKeysForTargetId(e,t){const n=this.Br.yr(t);return Nl.resolve(n)}containsKey(e,t){return Nl.resolve(this.Br.containsKey(t))}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class up{constructor(e,t){this.qr={},this.overlays={},this.Qr=new Rl(0),this.Kr=!1,this.Kr=!0,this.$r=new sp,this.referenceDelegate=e(this),this.Ur=new lp(this),this.indexManager=new Yf,this.remoteDocumentCache=new cp(e=>this.referenceDelegate.Wr(e)),this.serializer=new Gf(t),this.Gr=new np(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new ip,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let n=this.qr[e.toKey()];return n||(n=new ap(t,this.referenceDelegate),this.qr[e.toKey()]=n),n}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,n){Gh("MemoryPersistence","Starting transaction:",e);const i=new dp(this.Qr.next());return this.referenceDelegate.zr(),n(i).next(e=>this.referenceDelegate.jr(i).next(()=>e)).toPromise().then(e=>(i.raiseOnCommittedEvent(),e))}Hr(e,t){return Nl.or(Object.values(this.qr).map(n=>()=>n.containsKey(e,t)))}}class dp extends Sl{constructor(e){super(),this.currentSequenceNumber=e}}class fp{constructor(e){this.persistence=e,this.Jr=new rp,this.Yr=null}static Zr(e){return new fp(e)}get Xr(){if(this.Yr)return this.Yr;throw Xh()}addReference(e,t,n){return this.Jr.addReference(n,t),this.Xr.delete(n.toString()),Nl.resolve()}removeReference(e,t,n){return this.Jr.removeReference(n,t),this.Xr.add(n.toString()),Nl.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),Nl.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(e=>this.Xr.add(e.toString()));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next(e=>{e.forEach(e=>this.Xr.add(e.toString()))}).next(()=>n.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Nl.forEach(this.Xr,n=>{const i=Il.fromPath(n);return this.ei(e,i).next(e=>{e||t.removeEntry(i,_l.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(e=>{e?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return Nl.or([()=>Nl.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class pp{constructor(e,t,n,i){this.targetId=e,this.fromCache=t,this.$i=n,this.Ui=i}static Wi(e,t){let n=gd(),i=gd();for(const s of t.docChanges)switch(s.type){case 0:n=n.add(s.doc.key);break;case 1:i=i.add(s.doc.key)}return new pp(e,t.fromCache,n,i)}}
/**
   * @license
   * Copyright 2023 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class mp{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=C()?8:function(e){const t=e.match(/Android ([\d.]+)/i),n=t?t[1].split(".").slice(0,2).join("."):"-1";return Number(n)}(T())>0?6:4}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,n,i){const s={result:null};return this.Yi(e,t).next(e=>{s.result=e}).next(()=>{if(!s.result)return this.Zi(e,t,i,n).next(e=>{s.result=e})}).next(()=>{if(s.result)return;const n=new gp;return this.Xi(e,t,n).next(i=>{if(s.result=i,this.zi)return this.es(e,t,n,i.size)})}).next(()=>s.result)}es(e,t,n,i){return n.documentReadCount<this.ji?(Kh()<=G.DEBUG&&Gh("QueryEngine","SDK will not create cache indexes for query:",ed(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),Nl.resolve()):(Kh()<=G.DEBUG&&Gh("QueryEngine","Query:",ed(t),"scans",n.documentReadCount,"local documents and returns",i,"documents as results."),n.documentReadCount>this.Hi*i?(Kh()<=G.DEBUG&&Gh("QueryEngine","The SDK decides to create cache indexes for query:",ed(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Qu(t))):Nl.resolve())}Yi(e,t){if(Hu(t))return Nl.resolve(null);let n=Qu(t);return this.indexManager.getIndexType(e,n).next(i=>0===i?null:(null!==t.limit&&1===i&&(t=Ju(t,null,"F"),n=Qu(t)),this.indexManager.getDocumentsMatchingTarget(e,n).next(i=>{const s=gd(...i);return this.Ji.getDocuments(e,s).next(i=>this.indexManager.getMinOffset(e,n).next(n=>{const r=this.ts(t,i);return this.ns(t,r,s,n.readTime)?this.Yi(e,Ju(t,null,"F")):this.rs(e,r,t,n)}))})))}Zi(e,t,n,i){return Hu(t)||i.isEqual(_l.min())?Nl.resolve(null):this.Ji.getDocuments(e,n).next(s=>{const r=this.ts(t,s);return this.ns(t,r,n,i)?Nl.resolve(null):(Kh()<=G.DEBUG&&Gh("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),ed(t)),this.rs(e,r,t,function(e,t){const n=e.toTimestamp().seconds,i=e.toTimestamp().nanoseconds+1,s=_l.fromTimestamp(1e9===i?new ml(n+1,0):new ml(n,i));return new Cl(s,Il.empty(),t)}(i,-1)).next(e=>e))})}ts(e,t){let n=new Vl(nd(e));return t.forEach((t,i)=>{td(e,i)&&(n=n.add(i))}),n}ns(e,t,n,i){if(null===e.limit)return!1;if(n.size!==t.size)return!0;const s="F"===e.limitType?t.last():t.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Xi(e,t,n){return Kh()<=G.DEBUG&&Gh("QueryEngine","Using full collection scan to execute query:",ed(t)),this.Ji.getDocumentsMatchingQuery(e,t,Cl.min(),n)}rs(e,t,n,i){return this.Ji.getDocumentsMatchingQuery(e,n,i).next(e=>(t.forEach(t=>{e=e.insert(t.key,t)}),e))}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class _p{constructor(e,t,n,i){this.persistence=e,this.ss=t,this.serializer=i,this.os=new Ml(pl),this._s=new sd(e=>ju(e),Bu),this.us=new Map,this.cs=e.getRemoteDocumentCache(),this.Ur=e.getTargetCache(),this.Gr=e.getBundleCache(),this.ls(n)}ls(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new tp(this.cs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.cs.setIndexManager(this.indexManager),this.ss.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.os))}}async function yp(e,t){const n=el(e);return await n.persistence.runTransaction("Handle user change","readonly",e=>{let i;return n.mutationQueue.getAllMutationBatches(e).next(s=>(i=s,n.ls(t),n.mutationQueue.getAllMutationBatches(e))).next(t=>{const s=[],r=[];let o=gd();for(const e of i){s.push(e.batchId);for(const t of e.mutations)o=o.add(t.key)}for(const e of t){r.push(e.batchId);for(const t of e.mutations)o=o.add(t.key)}return n.localDocuments.getDocuments(e,o).next(e=>({hs:e,removedBatchIds:s,addedBatchIds:r}))})})}function vp(e){const t=el(e);return t.persistence.runTransaction("Get last remote snapshot version","readonly",e=>t.Ur.getLastRemoteSnapshotVersion(e))}function wp(e,t){const n=el(e),i=t.snapshotVersion;let s=n.os;return n.persistence.runTransaction("Apply remote event","readwrite-primary",e=>{const r=n.cs.newChangeBuffer({trackRemovals:!0});s=n.os;const o=[];t.targetChanges.forEach((r,a)=>{const c=s.get(a);if(!c)return;o.push(n.Ur.removeMatchingKeys(e,r.removedDocuments,a).next(()=>n.Ur.addMatchingKeys(e,r.addedDocuments,a)));let h=c.withSequenceNumber(e.currentSequenceNumber);var l,u,d;null!==t.targetMismatches.get(a)?h=h.withResumeToken(zl.EMPTY_BYTE_STRING,_l.min()).withLastLimboFreeSnapshotVersion(_l.min()):r.resumeToken.approximateByteSize()>0&&(h=h.withResumeToken(r.resumeToken,i)),s=s.insert(a,h),u=h,d=r,(0===(l=c).resumeToken.approximateByteSize()||u.snapshotVersion.toMicroseconds()-l.snapshotVersion.toMicroseconds()>=3e8||d.addedDocuments.size+d.modifiedDocuments.size+d.removedDocuments.size>0)&&o.push(n.Ur.updateTargetData(e,h))});let a=od(),c=gd();if(t.documentUpdates.forEach(i=>{t.resolvedLimboDocuments.has(i)&&o.push(n.persistence.referenceDelegate.updateLimboDocument(e,i))}),o.push(function(e,t,n){let i=gd(),s=gd();return n.forEach(e=>i=i.add(e)),t.getEntries(e,i).next(e=>{let i=od();return n.forEach((n,r)=>{const o=e.get(n);r.isFoundDocument()!==o.isFoundDocument()&&(s=s.add(n)),r.isNoDocument()&&r.version.isEqual(_l.min())?(t.removeEntry(n,r.readTime),i=i.insert(n,r)):!o.isValidDocument()||r.version.compareTo(o.version)>0||0===r.version.compareTo(o.version)&&o.hasPendingWrites?(t.addEntry(r),i=i.insert(n,r)):Gh("LocalStore","Ignoring outdated watch update for ",n,". Current version:",o.version," Watch version:",r.version)}),{Ps:i,Is:s}})}(e,r,t.documentUpdates).next(e=>{a=e.Ps,c=e.Is})),!i.isEqual(_l.min())){const t=n.Ur.getLastRemoteSnapshotVersion(e).next(t=>n.Ur.setTargetsMetadata(e,e.currentSequenceNumber,i));o.push(t)}return Nl.waitFor(o).next(()=>r.apply(e)).next(()=>n.localDocuments.getLocalViewOfDocuments(e,a,c)).next(()=>a)}).then(e=>(n.os=s,e))}function Tp(e,t){const n=el(e);return n.persistence.runTransaction("Get next mutation batch","readonly",e=>(void 0===t&&(t=-1),n.mutationQueue.getNextMutationBatchAfterBatchId(e,t)))}async function Ip(e,t,n){const i=el(e),s=i.os.get(t),r=n?"readwrite":"readwrite-primary";try{n||await i.persistence.runTransaction("Release target",r,e=>i.persistence.referenceDelegate.removeTarget(e,s))}catch(o){if(!Al(o))throw o;Gh("LocalStore",`Failed to update sequence numbers for target ${t}: ${o}`)}i.os=i.os.remove(t),i._s.delete(s.target)}function bp(e,t,n){const i=el(e);let s=_l.min(),r=gd();return i.persistence.runTransaction("Execute query","readwrite",e=>function(e,t,n){const i=el(e),s=i._s.get(n);return void 0!==s?Nl.resolve(i.os.get(s)):i.Ur.getTargetData(t,n)}(i,e,Qu(t)).next(t=>{if(t)return s=t.lastLimboFreeSnapshotVersion,i.Ur.getMatchingKeysForTargetId(e,t.targetId).next(e=>{r=e})}).next(()=>i.ss.getDocumentsMatchingQuery(e,t,n?s:_l.min(),n?r:gd())).next(e=>(function(e,t,n){let i=e.us.get(t)||_l.min();n.forEach((e,t)=>{t.readTime.compareTo(i)>0&&(i=t.readTime)}),e.us.set(t,i)}(i,function(e){return e.collectionGroup||(e.path.length%2==1?e.path.lastSegment():e.path.get(e.path.length-2))}(t),e),{documents:e,Ts:r})))}class Cp{constructor(){this.activeTargetIds=md}fs(e){this.activeTargetIds=this.activeTargetIds.add(e)}gs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Vs(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class Ep{constructor(){this.so=new Cp,this.oo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,n){}addLocalQueryTarget(e,t=!0){return t&&this.so.fs(e),this.oo[e]||"not-current"}updateQueryState(e,t,n){this.oo[e]=t}removeLocalQueryTarget(e){this.so.gs(e)}isLocalQueryTarget(e){return this.so.activeTargetIds.has(e)}clearQueryState(e){delete this.oo[e]}getAllActiveQueryTargets(){return this.so.activeTargetIds}isActiveQueryTarget(e){return this.so.activeTargetIds.has(e)}start(){return this.so=new Cp,Promise.resolve()}handleUserChange(e,t,n){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}
/**
   * @license
   * Copyright 2019 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class kp{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){Gh("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.ho)e(0)}lo(){Gh("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.ho)e(1)}static D(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}
/**
   * @license
   * Copyright 2023 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */let Np=null;function Ap(){return null===Np?Np=268435456+Math.round(2147483648*Math.random()):Np++,"0x"+Np.toString(16)
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const Dp="WebChannelConnection";class xp extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=t+"://"+e.host,this.vo=`projects/${n}/databases/${i}`,this.Co="(default)"===this.databaseId.database?`project_id=${n}`:`project_id=${n}&database_id=${i}`}get Fo(){return!1}Mo(e,t,n,i,s){const r=Ap(),o=this.xo(e,t.toUriEncodedString());Gh("RestConnection",`Sending RPC '${e}' ${r}:`,o,n);const a={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(a,i,s),this.No(e,o,a,n).then(t=>(Gh("RestConnection",`Received RPC '${e}' ${r}: `,t),t),t=>{throw Yh("RestConnection",`RPC '${e}' ${r} failed with error: `,t,"url: ",o,"request:",n),t})}Lo(e,t,n,i,s,r){return this.Mo(e,t,n,i,s)}Oo(e,t,n){e["X-Goog-Api-Client"]="gl-js/ fire/"+Wh,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,n)=>e[n]=t),n&&n.headers.forEach((t,n)=>e[n]=t)}xo(e,t){const n=Rp[e];return`${this.Do}/v1/${t}:${n}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,n,i){const s=Ap();return new Promise((r,o)=>{const a=new Oh;a.setWithCredentials(!0),a.listenOnce(Mh.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case Fh.NO_ERROR:const t=a.getResponseJson();Gh(Dp,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(t)),r(t);break;case Fh.TIMEOUT:Gh(Dp,`RPC '${e}' ${s} timed out`),o(new nl(tl.DEADLINE_EXCEEDED,"Request time out"));break;case Fh.HTTP_ERROR:const n=a.getStatus();if(Gh(Dp,`RPC '${e}' ${s} failed with status:`,n,"response text:",a.getResponseText()),n>0){let e=a.getResponseJson();Array.isArray(e)&&(e=e[0]);const t=null==e?void 0:e.error;if(t&&t.status&&t.message){const e=function(e){const t=e.toLowerCase().replace(/_/g,"-");return Object.values(tl).indexOf(t)>=0?t:tl.UNKNOWN}(t.status);o(new nl(e,t.message))}else o(new nl(tl.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new nl(tl.UNAVAILABLE,"Connection failed."));break;default:Xh()}}finally{Gh(Dp,`RPC '${e}' ${s} completed.`)}});const c=JSON.stringify(i);Gh(Dp,`RPC '${e}' ${s} sending request:`,i),a.send(t,"POST",c,n,15)})}Bo(e,t,n){const i=Ap(),s=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],r=jh(),o=qh(),a={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;void 0!==c&&(a.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(a.useFetchStreams=!0),this.Oo(a.initMessageHeaders,t,n),a.encodeInitMessageHeaders=!0;const h=s.join("");Gh(Dp,`Creating RPC '${e}' stream ${i}: ${h}`,a);const l=r.createWebChannel(h,a);let u=!1,d=!1;const f=new Pp({Io:t=>{d?Gh(Dp,`Not sending because RPC '${e}' stream ${i} is closed:`,t):(u||(Gh(Dp,`Opening RPC '${e}' stream ${i} transport.`),l.open(),u=!0),Gh(Dp,`RPC '${e}' stream ${i} sending:`,t),l.send(t))},To:()=>l.close()}),p=(e,t,n)=>{e.listen(t,e=>{try{n(e)}catch(t){setTimeout(()=>{throw t},0)}})};return p(l,Lh.EventType.OPEN,()=>{d||(Gh(Dp,`RPC '${e}' stream ${i} transport opened.`),f.yo())}),p(l,Lh.EventType.CLOSE,()=>{d||(d=!0,Gh(Dp,`RPC '${e}' stream ${i} transport closed`),f.So())}),p(l,Lh.EventType.ERROR,t=>{d||(d=!0,Yh(Dp,`RPC '${e}' stream ${i} transport errored:`,t),f.So(new nl(tl.UNAVAILABLE,"The operation could not be completed")))}),p(l,Lh.EventType.MESSAGE,t=>{var n;if(!d){const s=t.data[0];Zh(!!s);const r=s,o=r.error||(null===(n=r[0])||void 0===n?void 0:n.error);if(o){Gh(Dp,`RPC '${e}' stream ${i} received error:`,o);const t=o.status;let n=function(e){const t=Zd[e];if(void 0!==t)return tf(t)}(t),s=o.message;void 0===n&&(n=tl.INTERNAL,s="Unknown error status: "+t+" with message "+o.message),d=!0,f.So(new nl(n,s)),l.close()}else Gh(Dp,`RPC '${e}' stream ${i} received:`,s),f.bo(s)}}),p(o,Vh.STAT_EVENT,t=>{t.stat===Uh.PROXY?Gh(Dp,`RPC '${e}' stream ${i} detected buffering proxy`):t.stat===Uh.NOPROXY&&Gh(Dp,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{f.wo()},0),f}}function Op(){return"undefined"!=typeof document?document:null}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function Lp(e){return new wf(e,!0)}
/**
   * @license
   * Copyright 2017 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Fp{constructor(e,t,n,i,s,r,o,a){this.ui=e,this.Ho=n,this.Jo=i,this.connection=s,this.authCredentialsProvider=r,this.appCheckCredentialsProvider=o,this.listener=a,this.state=0,this.Yo=0,this.Zo=null,this.Xo=null,this.stream=null,this.e_=0,this.t_=new Mp(e,t)}n_(){return 1===this.state||5===this.state||this.r_()}r_(){return 2===this.state||3===this.state}start(){this.e_=0,4!==this.state?this.auth():this.i_()}async stop(){this.n_()&&await this.close(0)}s_(){this.state=0,this.t_.reset()}o_(){this.r_()&&null===this.Zo&&(this.Zo=this.ui.enqueueAfterDelay(this.Ho,6e4,()=>this.__()))}a_(e){this.u_(),this.stream.send(e)}async __(){if(this.r_())return this.close(0)}u_(){this.Zo&&(this.Zo.cancel(),this.Zo=null)}c_(){this.Xo&&(this.Xo.cancel(),this.Xo=null)}async close(e,t){this.u_(),this.c_(),this.t_.cancel(),this.Yo++,4!==e?this.t_.reset():t&&t.code===tl.RESOURCE_EXHAUSTED?(Qh(t.toString()),Qh("Using maximum backoff delay to prevent overloading the backend."),this.t_.Wo()):t&&t.code===tl.UNAUTHENTICATED&&3!==this.state&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),null!==this.stream&&(this.l_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.mo(t)}l_(){}auth(){this.state=1;const e=this.h_(this.Yo),t=this.Yo;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([e,n])=>{this.Yo===t&&this.P_(e,n)},t=>{e(()=>{const e=new nl(tl.UNKNOWN,"Fetching auth token failed: "+t.message);return this.I_(e)})})}P_(e,t){const n=this.h_(this.Yo);this.stream=this.T_(e,t),this.stream.Eo(()=>{n(()=>this.listener.Eo())}),this.stream.Ro(()=>{n(()=>(this.state=2,this.Xo=this.ui.enqueueAfterDelay(this.Jo,1e4,()=>(this.r_()&&(this.state=3),Promise.resolve())),this.listener.Ro()))}),this.stream.mo(e=>{n(()=>this.I_(e))}),this.stream.onMessage(e=>{n(()=>1==++this.e_?this.E_(e):this.onNext(e))})}i_(){this.state=5,this.t_.Go(async()=>{this.state=0,this.start()})}I_(e){return Gh("PersistentStream",`close with error: ${e}`),this.stream=null,this.close(4,e)}h_(e){return t=>{this.ui.enqueueAndForget(()=>this.Yo===e?t():(Gh("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class Up extends Fp{constructor(e,t,n,i,s,r){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,n,i,r),this.serializer=s}T_(e,t){return this.connection.Bo("Listen",e,t)}E_(e){return this.onNext(e)}onNext(e){this.t_.reset();const t=function(e,t){let n;if("targetChange"in t){t.targetChange;const s="NO_CHANGE"===(i=t.targetChange.targetChangeType||"NO_CHANGE")?0:"ADD"===i?1:"REMOVE"===i?2:"CURRENT"===i?3:"RESET"===i?4:Xh(),r=t.targetChange.targetIds||[],o=function(e,t){return e.useProto3Json?(Zh(void 0===t||"string"==typeof t),zl.fromBase64String(t||"")):(Zh(void 0===t||t instanceof Buffer||t instanceof Uint8Array),zl.fromUint8Array(t||new Uint8Array))}(e,t.targetChange.resumeToken),a=t.targetChange.cause,c=a&&function(e){const t=void 0===e.code?tl.UNKNOWN:tf(e.code);return new nl(t,e.message||"")}(a);n=new df(s,r,o,c||null)}else if("documentChange"in t){t.documentChange;const i=t.documentChange;i.document,i.document.name,i.document.updateTime;const s=Rf(e,i.document.name),r=Ef(i.document.updateTime),o=i.document.createTime?Ef(i.document.createTime):_l.min(),a=new gu({mapValue:{fields:i.document.fields}}),c=_u.newFoundDocument(s,r,o,a),h=i.targetIds||[],l=i.removedTargetIds||[];n=new lf(h,l,c.key,c)}else if("documentDelete"in t){t.documentDelete;const i=t.documentDelete;i.document;const s=Rf(e,i.document),r=i.readTime?Ef(i.readTime):_l.min(),o=_u.newNoDocument(s,r),a=i.removedTargetIds||[];n=new lf([],a,o.key,o)}else if("documentRemove"in t){t.documentRemove;const i=t.documentRemove;i.document;const s=Rf(e,i.document),r=i.removedTargetIds||[];n=new lf([],r,s,null)}else{if(!("filter"in t))return Xh();{t.filter;const e=t.filter;e.targetId;const{count:i=0,unchangedNames:s}=e,r=new Xd(i,s),o=e.targetId;n=new uf(o,r)}}var i;return n}(this.serializer,e),n=function(e){if(!("targetChange"in e))return _l.min();const t=e.targetChange;return t.targetIds&&t.targetIds.length?_l.min():t.readTime?Ef(t.readTime):_l.min()}(e);return this.listener.d_(t,n)}A_(e){const t={};t.database=Df(this.serializer),t.addTarget=function(e,t){let n;const i=t.target;if(n=zu(i)?{documents:Lf(e,i)}:{query:Mf(e,i)._t},n.targetId=t.targetId,t.resumeToken.approximateByteSize()>0){n.resumeToken=bf(e,t.resumeToken);const i=Tf(e,t.expectedCount);null!==i&&(n.expectedCount=i)}else if(t.snapshotVersion.compareTo(_l.min())>0){n.readTime=If(e,t.snapshotVersion.toTimestamp());const i=Tf(e,t.expectedCount);null!==i&&(n.expectedCount=i)}return n}(this.serializer,e);const n=function(e,t){const n=function(e){switch(e){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return Xh()}}(t.purpose);return null==n?null:{"goog-listen-tags":n}}(this.serializer,e);n&&(t.labels=n),this.a_(t)}R_(e){const t={};t.database=Df(this.serializer),t.removeTarget=e,this.a_(t)}}class Vp extends Fp{constructor(e,t,n,i,s,r){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,n,i,r),this.serializer=s}get V_(){return this.e_>0}start(){this.lastStreamToken=void 0,super.start()}l_(){this.V_&&this.m_([])}T_(e,t){return this.connection.Bo("Write",e,t)}E_(e){return Zh(!!e.streamToken),this.lastStreamToken=e.streamToken,Zh(!e.writeResults||0===e.writeResults.length),this.listener.f_()}onNext(e){Zh(!!e.streamToken),this.lastStreamToken=e.streamToken,this.t_.reset();const t=function(e,t){return e&&e.length>0?(Zh(void 0!==t),e.map(e=>function(e,t){let n=e.updateTime?Ef(e.updateTime):Ef(t);return n.isEqual(_l.min())&&(n=Ef(t)),new xd(n,e.transformResults||[])}(e,t))):[]}(e.writeResults,e.commitTime),n=Ef(e.commitTime);return this.listener.g_(n,t)}p_(){const e={};e.database=Df(this.serializer),this.a_(e)}m_(e){const t={streamToken:this.lastStreamToken,writes:e.map(e=>function(e,t){let n;if(t instanceof Bd)n={update:Of(e,t.key,t.value)};else if(t instanceof Kd)n={delete:Af(e,t.key)};else if(t instanceof zd)n={update:Of(e,t.key,t.data),updateMask:Wf(t.fieldMask)};else{if(!(t instanceof Gd))return Xh();n={verify:Af(e,t.key)}}return t.fieldTransforms.length>0&&(n.updateTransforms=t.fieldTransforms.map(e=>function(e,t){const n=t.transform;if(n instanceof Cd)return{fieldPath:t.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof Ed)return{fieldPath:t.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof kd)return{fieldPath:t.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof Ad)return{fieldPath:t.field.canonicalString(),increment:n.Pe};throw Xh()}(0,e))),t.precondition.isNone||(n.currentDocument=(i=e,void 0!==(s=t.precondition).updateTime?{updateTime:Cf(i,s.updateTime)}:void 0!==s.exists?{exists:s.exists}:Xh())),n;var i,s}(this.serializer,e))};this.a_(t)}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class qp extends class{}{constructor(e,t,n,i){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=n,this.serializer=i,this.y_=!1}w_(){if(this.y_)throw new nl(tl.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(e,t,n,i){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,r])=>this.connection.Mo(e,kf(t,n),i,s,r)).catch(e=>{throw"FirebaseError"===e.name?(e.code===tl.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new nl(tl.UNKNOWN,e.toString())})}Lo(e,t,n,i,s){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([r,o])=>this.connection.Lo(e,kf(t,n),i,r,o,s)).catch(e=>{throw"FirebaseError"===e.name?(e.code===tl.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new nl(tl.UNKNOWN,e.toString())})}terminate(){this.y_=!0,this.connection.terminate()}}class jp{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){0===this.S_&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve())))}M_(e){"Online"===this.state?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.C_("Offline")))}set(e){this.x_(),this.S_=0,"Online"===e&&(this.D_=!1),this.C_(e)}C_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}F_(e){const t=`Could not reach Cloud Firestore backend. ${e}\nThis typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.D_?(Qh(t),this.D_=!1):Gh("OnlineStateTracker",t)}x_(){null!==this.b_&&(this.b_.cancel(),this.b_=null)}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Bp{constructor(e,t,n,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=s,this.k_._o(e=>{n.enqueueAndForget(async()=>{Jp(this)&&(Gh("RemoteStore","Restarting streams for network reachability change."),await async function(e){const t=el(e);t.L_.add(4),await $p(t),t.q_.set("Unknown"),t.L_.delete(4),await zp(t)}(this))})}),this.q_=new jp(n,i)}}async function zp(e){if(Jp(e))for(const t of e.B_)await t(!0)}async function $p(e){for(const t of e.B_)await t(!1)}function Wp(e,t){const n=el(e);n.N_.has(t.targetId)||(n.N_.set(t.targetId,t),Yp(n)?Qp(n):gg(n).r_()&&Kp(n,t))}function Hp(e,t){const n=el(e),i=gg(n);n.N_.delete(t),i.r_()&&Gp(n,t),0===n.N_.size&&(i.r_()?i.o_():Jp(n)&&n.q_.set("Unknown"))}function Kp(e,t){if(e.Q_.xe(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(_l.min())>0){const n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}gg(e).A_(t)}function Gp(e,t){e.Q_.xe(t),gg(e).R_(t)}function Qp(e){e.Q_=new pf({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),ot:t=>e.N_.get(t)||null,tt:()=>e.datastore.serializer.databaseId}),gg(e).start(),e.q_.v_()}function Yp(e){return Jp(e)&&!gg(e).n_()&&e.N_.size>0}function Jp(e){return 0===el(e).L_.size}function Xp(e){e.Q_=void 0}async function Zp(e){e.q_.set("Online")}async function eg(e){e.N_.forEach((t,n)=>{Kp(e,t)})}async function tg(e,t){Xp(e),Yp(e)?(e.q_.M_(t),Qp(e)):e.q_.set("Unknown")}async function ng(e,t,n){if(e.q_.set("Online"),t instanceof df&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const i of t.targetIds)e.N_.has(i)&&(await e.remoteSyncer.rejectListen(i,n),e.N_.delete(i),e.Q_.removeTarget(i))}(e,t)}catch(i){Gh("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),i),await ig(e,i)}else if(t instanceof lf?e.Q_.Ke(t):t instanceof uf?e.Q_.He(t):e.Q_.We(t),!n.isEqual(_l.min()))try{const t=await vp(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.Q_.rt(t);return n.targetChanges.forEach((n,i)=>{if(n.resumeToken.approximateByteSize()>0){const s=e.N_.get(i);s&&e.N_.set(i,s.withResumeToken(n.resumeToken,t))}}),n.targetMismatches.forEach((t,n)=>{const i=e.N_.get(t);if(!i)return;e.N_.set(t,i.withResumeToken(zl.EMPTY_BYTE_STRING,i.snapshotVersion)),Gp(e,t);const s=new Kf(i.target,t,n,i.sequenceNumber);Kp(e,s)}),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(s){Gh("RemoteStore","Failed to raise snapshot:",s),await ig(e,s)}}async function ig(e,t,n){if(!Al(t))throw t;e.L_.add(1),await $p(e),e.q_.set("Offline"),n||(n=()=>vp(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{Gh("RemoteStore","Retrying IndexedDB access"),await n(),e.L_.delete(1),await zp(e)})}function sg(e,t){return t().catch(n=>ig(e,n,t))}async function rg(e){const t=el(e),n=mg(t);let i=t.O_.length>0?t.O_[t.O_.length-1].batchId:-1;for(;og(t);)try{const e=await Tp(t.localStore,i);if(null===e){0===t.O_.length&&n.o_();break}i=e.batchId,ag(t,e)}catch(s){await ig(t,s)}cg(t)&&hg(t)}function og(e){return Jp(e)&&e.O_.length<10}function ag(e,t){e.O_.push(t);const n=mg(e);n.r_()&&n.V_&&n.m_(t.mutations)}function cg(e){return Jp(e)&&!mg(e).n_()&&e.O_.length>0}function hg(e){mg(e).start()}async function lg(e){mg(e).p_()}async function ug(e){const t=mg(e);for(const n of e.O_)t.m_(n.mutations)}async function dg(e,t,n){const i=e.O_.shift(),s=Yd.from(i,t,n);await sg(e,()=>e.remoteSyncer.applySuccessfulWrite(s)),await rg(e)}async function fg(e,t){t&&mg(e).V_&&await async function(e,t){if(function(e){switch(e){default:return Xh();case tl.CANCELLED:case tl.UNKNOWN:case tl.DEADLINE_EXCEEDED:case tl.RESOURCE_EXHAUSTED:case tl.INTERNAL:case tl.UNAVAILABLE:case tl.UNAUTHENTICATED:return!1;case tl.INVALID_ARGUMENT:case tl.NOT_FOUND:case tl.ALREADY_EXISTS:case tl.PERMISSION_DENIED:case tl.FAILED_PRECONDITION:case tl.ABORTED:case tl.OUT_OF_RANGE:case tl.UNIMPLEMENTED:case tl.DATA_LOSS:return!0}}(n=t.code)&&n!==tl.ABORTED){const n=e.O_.shift();mg(e).s_(),await sg(e,()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t)),await rg(e)}var n}(e,t),cg(e)&&hg(e)}async function pg(e,t){const n=el(e);n.asyncQueue.verifyOperationInProgress(),Gh("RemoteStore","RemoteStore received new credentials");const i=Jp(n);n.L_.add(3),await $p(n),i&&n.q_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.L_.delete(3),await zp(n)}function gg(e){return e.K_||(e.K_=function(e,t,n){const i=el(e);return i.w_(),new Up(t,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,n)}(e.datastore,e.asyncQueue,{Eo:Zp.bind(null,e),Ro:eg.bind(null,e),mo:tg.bind(null,e),d_:ng.bind(null,e)}),e.B_.push(async t=>{t?(e.K_.s_(),Yp(e)?Qp(e):e.q_.set("Unknown")):(await e.K_.stop(),Xp(e))})),e.K_}function mg(e){return e.U_||(e.U_=function(e,t,n){const i=el(e);return i.w_(),new Vp(t,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,n)}(e.datastore,e.asyncQueue,{Eo:()=>Promise.resolve(),Ro:lg.bind(null,e),mo:fg.bind(null,e),f_:ug.bind(null,e),g_:dg.bind(null,e)}),e.B_.push(async t=>{t?(e.U_.s_(),await rg(e)):(await e.U_.stop(),e.O_.length>0&&(Gh("RemoteStore",`Stopping write stream with ${e.O_.length} pending writes`),e.O_=[]))})),e.U_
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */}class _g{constructor(e,t,n,i,s){this.asyncQueue=e,this.timerId=t,this.targetTimeMs=n,this.op=i,this.removalCallback=s,this.deferred=new il,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(e=>{})}get promise(){return this.deferred.promise}static createAndSchedule(e,t,n,i,s){const r=Date.now()+n,o=new _g(e,t,r,i,s);return o.start(n),o}start(e){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){null!==this.timerHandle&&(this.clearTimeout(),this.deferred.reject(new nl(tl.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>null!==this.timerHandle?(this.clearTimeout(),this.op().then(e=>this.deferred.resolve(e))):Promise.resolve())}clearTimeout(){null!==this.timerHandle&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function yg(e,t){if(Qh("AsyncQueue",`${t}: ${e}`),Al(e))return new nl(tl.UNAVAILABLE,`${t}: ${e}`);throw e}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class vg{constructor(e){this.comparator=e?(t,n)=>e(t,n)||Il.comparator(t.key,n.key):(e,t)=>Il.comparator(e.key,t.key),this.keyedMap=cd(),this.sortedSet=new Ml(this.comparator)}static emptySet(e){return new vg(e.comparator)}has(e){return null!=this.keyedMap.get(e)}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const t=this.keyedMap.get(e);return t?this.sortedSet.indexOf(t):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((t,n)=>(e(t),!1))}add(e){const t=this.delete(e.key);return t.copy(t.keyedMap.insert(e.key,e),t.sortedSet.insert(e,null))}delete(e){const t=this.get(e);return t?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(t)):this}isEqual(e){if(!(e instanceof vg))return!1;if(this.size!==e.size)return!1;const t=this.sortedSet.getIterator(),n=e.sortedSet.getIterator();for(;t.hasNext();){const e=t.getNext().key,i=n.getNext().key;if(!e.isEqual(i))return!1}return!0}toString(){const e=[];return this.forEach(t=>{e.push(t.toString())}),0===e.length?"DocumentSet ()":"DocumentSet (\n  "+e.join("  \n")+"\n)"}copy(e,t){const n=new vg;return n.comparator=this.comparator,n.keyedMap=e,n.sortedSet=t,n}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class wg{constructor(){this.W_=new Ml(Il.comparator)}track(e){const t=e.doc.key,n=this.W_.get(t);n?0!==e.type&&3===n.type?this.W_=this.W_.insert(t,e):3===e.type&&1!==n.type?this.W_=this.W_.insert(t,{type:n.type,doc:e.doc}):2===e.type&&2===n.type?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):2===e.type&&0===n.type?this.W_=this.W_.insert(t,{type:0,doc:e.doc}):1===e.type&&0===n.type?this.W_=this.W_.remove(t):1===e.type&&2===n.type?this.W_=this.W_.insert(t,{type:1,doc:n.doc}):0===e.type&&1===n.type?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):Xh():this.W_=this.W_.insert(t,e)}G_(){const e=[];return this.W_.inorderTraversal((t,n)=>{e.push(n)}),e}}class Tg{constructor(e,t,n,i,s,r,o,a,c){this.query=e,this.docs=t,this.oldDocs=n,this.docChanges=i,this.mutatedKeys=s,this.fromCache=r,this.syncStateChanged=o,this.excludesMetadataChanges=a,this.hasCachedResults=c}static fromInitialDocuments(e,t,n,i,s){const r=[];return t.forEach(e=>{r.push({type:0,doc:e})}),new Tg(e,t,vg.emptySet(t),r,n,i,!0,!1,s)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Xu(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,n=e.docChanges;if(t.length!==n.length)return!1;for(let i=0;i<t.length;i++)if(t[i].type!==n[i].type||!t[i].doc.isEqual(n[i].doc))return!1;return!0}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Ig{constructor(){this.z_=void 0,this.j_=[]}H_(){return this.j_.some(e=>e.J_())}}class bg{constructor(){this.queries=Cg(),this.onlineState="Unknown",this.Y_=new Set}terminate(){!function(e,t){const n=el(e),i=n.queries;n.queries=Cg(),i.forEach((e,n)=>{for(const i of n.j_)i.onError(t)})}(this,new nl(tl.ABORTED,"Firestore shutting down"))}}function Cg(){return new sd(e=>Zu(e),Xu)}async function Eg(e,t){const n=el(e);let i=3;const s=t.query;let r=n.queries.get(s);r?!r.H_()&&t.J_()&&(i=2):(r=new Ig,i=t.J_()?0:1);try{switch(i){case 0:r.z_=await n.onListen(s,!0);break;case 1:r.z_=await n.onListen(s,!1);break;case 2:await n.onFirstRemoteStoreListen(s)}}catch(o){const e=yg(o,`Initialization of query '${ed(t.query)}' failed`);return void t.onError(e)}n.queries.set(s,r),r.j_.push(t),t.Z_(n.onlineState),r.z_&&t.X_(r.z_)&&Ag(n)}async function Sg(e,t){const n=el(e),i=t.query;let s=3;const r=n.queries.get(i);if(r){const e=r.j_.indexOf(t);e>=0&&(r.j_.splice(e,1),0===r.j_.length?s=t.J_()?0:1:!r.H_()&&t.J_()&&(s=2))}switch(s){case 0:return n.queries.delete(i),n.onUnlisten(i,!0);case 1:return n.queries.delete(i),n.onUnlisten(i,!1);case 2:return n.onLastRemoteStoreUnlisten(i);default:return}}function kg(e,t){const n=el(e);let i=!1;for(const s of t){const e=s.query,t=n.queries.get(e);if(t){for(const e of t.j_)e.X_(s)&&(i=!0);t.z_=s}}i&&Ag(n)}function Ng(e,t,n){const i=el(e),s=i.queries.get(t);if(s)for(const r of s.j_)r.onError(n);i.queries.delete(t)}function Ag(e){e.Y_.forEach(e=>{e.next()})}var Rg,Pg;(Pg=Rg||(Rg={})).ea="default",Pg.Cache="cache";class Dg{constructor(e,t,n){this.query=e,this.ta=t,this.na=!1,this.ra=null,this.onlineState="Unknown",this.options=n||{}}X_(e){if(!this.options.includeMetadataChanges){const t=[];for(const n of e.docChanges)3!==n.type&&t.push(n);e=new Tg(e.query,e.docs,e.oldDocs,t,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.na?this.ia(e)&&(this.ta.next(e),t=!0):this.sa(e,this.onlineState)&&(this.oa(e),t=!0),this.ra=e,t}onError(e){this.ta.error(e)}Z_(e){this.onlineState=e;let t=!1;return this.ra&&!this.na&&this.sa(this.ra,e)&&(this.oa(this.ra),t=!0),t}sa(e,t){if(!e.fromCache)return!0;if(!this.J_())return!0;const n="Offline"!==t;return(!this.options._a||!n)&&(!e.docs.isEmpty()||e.hasCachedResults||"Offline"===t)}ia(e){if(e.docChanges.length>0)return!0;const t=this.ra&&this.ra.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&!0===this.options.includeMetadataChanges}oa(e){e=Tg.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.na=!0,this.ta.next(e)}J_(){return this.options.source!==Rg.Cache}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class xg{constructor(e){this.key=e}}class Og{constructor(e){this.key=e}}class Lg{constructor(e,t){this.query=e,this.Ta=t,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=gd(),this.mutatedKeys=gd(),this.Aa=nd(e),this.Ra=new vg(this.Aa)}get Va(){return this.Ta}ma(e,t){const n=t?t.fa:new wg,i=t?t.Ra:this.Ra;let s=t?t.mutatedKeys:this.mutatedKeys,r=i,o=!1;const a="F"===this.query.limitType&&i.size===this.query.limit?i.last():null,c="L"===this.query.limitType&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal((e,t)=>{const h=i.get(e),l=td(this.query,t)?t:null,u=!!h&&this.mutatedKeys.has(h.key),d=!!l&&(l.hasLocalMutations||this.mutatedKeys.has(l.key)&&l.hasCommittedMutations);let f=!1;h&&l?h.data.isEqual(l.data)?u!==d&&(n.track({type:3,doc:l}),f=!0):this.ga(h,l)||(n.track({type:2,doc:l}),f=!0,(a&&this.Aa(l,a)>0||c&&this.Aa(l,c)<0)&&(o=!0)):!h&&l?(n.track({type:0,doc:l}),f=!0):h&&!l&&(n.track({type:1,doc:h}),f=!0,(a||c)&&(o=!0)),f&&(l?(r=r.add(l),s=d?s.add(e):s.delete(e)):(r=r.delete(e),s=s.delete(e)))}),null!==this.query.limit)for(;r.size>this.query.limit;){const e="F"===this.query.limitType?r.last():r.first();r=r.delete(e.key),s=s.delete(e.key),n.track({type:1,doc:e})}return{Ra:r,fa:n,ns:o,mutatedKeys:s}}ga(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,n,i){const s=this.Ra;this.Ra=e.Ra,this.mutatedKeys=e.mutatedKeys;const r=e.fa.G_();r.sort((e,t)=>function(e,t){const n=e=>{switch(e){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return Xh()}};return n(e)-n(t)}(e.type,t.type)||this.Aa(e.doc,t.doc)),this.pa(n),i=null!=i&&i;const o=t&&!i?this.ya():[],a=0===this.da.size&&this.current&&!i?1:0,c=a!==this.Ea;return this.Ea=a,0!==r.length||c?{snapshot:new Tg(this.query,e.Ra,s,r,e.mutatedKeys,0===a,c,!1,!!n&&n.resumeToken.approximateByteSize()>0),wa:o}:{wa:o}}Z_(e){return this.current&&"Offline"===e?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new wg,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(e){return!this.Ta.has(e)&&!!this.Ra.has(e)&&!this.Ra.get(e).hasLocalMutations}pa(e){e&&(e.addedDocuments.forEach(e=>this.Ta=this.Ta.add(e)),e.modifiedDocuments.forEach(e=>{}),e.removedDocuments.forEach(e=>this.Ta=this.Ta.delete(e)),this.current=e.current)}ya(){if(!this.current)return[];const e=this.da;this.da=gd(),this.Ra.forEach(e=>{this.Sa(e.key)&&(this.da=this.da.add(e.key))});const t=[];return e.forEach(e=>{this.da.has(e)||t.push(new Og(e))}),this.da.forEach(n=>{e.has(n)||t.push(new xg(n))}),t}ba(e){this.Ta=e.Ts,this.da=gd();const t=this.ma(e.documents);return this.applyChanges(t,!0)}Da(){return Tg.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,0===this.Ea,this.hasCachedResults)}}class Mg{constructor(e,t,n){this.query=e,this.targetId=t,this.view=n}}class Fg{constructor(e){this.key=e,this.va=!1}}class Ug{constructor(e,t,n,i,s,r){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=i,this.currentUser=s,this.maxConcurrentLimboResolutions=r,this.Ca={},this.Fa=new sd(e=>Zu(e),Xu),this.Ma=new Map,this.xa=new Set,this.Oa=new Ml(Il.comparator),this.Na=new Map,this.La=new rp,this.Ba={},this.ka=new Map,this.qa=Xf.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return!0===this.Qa}}async function Vg(e,t,n=!0){const i=om(e);let s;const r=i.Fa.get(t);return r?(i.sharedClientState.addLocalQueryTarget(r.targetId),s=r.view.Da()):s=await jg(i,t,n,!0),s}async function qg(e,t){const n=om(e);await jg(n,t,!0,!1)}async function jg(e,t,n,i){const s=await function(e,t){const n=el(e);return n.persistence.runTransaction("Allocate target","readwrite",e=>{let i;return n.Ur.getTargetData(e,t).next(s=>s?(i=s,Nl.resolve(i)):n.Ur.allocateTargetId(e).next(s=>(i=new Kf(t,s,"TargetPurposeListen",e.currentSequenceNumber),n.Ur.addTargetData(e,i).next(()=>i))))}).then(e=>{const i=n.os.get(e.targetId);return(null===i||e.snapshotVersion.compareTo(i.snapshotVersion)>0)&&(n.os=n.os.insert(e.targetId,e),n._s.set(t,e.targetId)),e})}(e.localStore,Qu(t)),r=s.targetId,o=e.sharedClientState.addLocalQueryTarget(r,n);let a;return i&&(a=await async function(e,t,n,i,s){e.Ka=(t,n,i)=>async function(e,t,n,i){let s=t.view.ma(n);s.ns&&(s=await bp(e.localStore,t.query,!1).then(({documents:e})=>t.view.ma(e,s)));const r=i&&i.targetChanges.get(t.targetId),o=i&&null!=i.targetMismatches.get(t.targetId),a=t.view.applyChanges(s,e.isPrimaryClient,r,o);return em(e,t.targetId,a.wa),a.snapshot}(e,t,n,i);const r=await bp(e.localStore,t,!0),o=new Lg(t,r.Ts),a=o.ma(r.documents),c=hf.createSynthesizedTargetChangeForCurrentChange(n,i&&"Offline"!==e.onlineState,s),h=o.applyChanges(a,e.isPrimaryClient,c);em(e,n,h.wa);const l=new Mg(t,n,o);return e.Fa.set(t,l),e.Ma.has(n)?e.Ma.get(n).push(t):e.Ma.set(n,[t]),h.snapshot}(e,t,r,"current"===o,s.resumeToken)),e.isPrimaryClient&&n&&Wp(e.remoteStore,s),a}async function Bg(e,t,n){const i=el(e),s=i.Fa.get(t),r=i.Ma.get(s.targetId);if(r.length>1)return i.Ma.set(s.targetId,r.filter(e=>!Xu(e,t))),void i.Fa.delete(t);i.isPrimaryClient?(i.sharedClientState.removeLocalQueryTarget(s.targetId),i.sharedClientState.isActiveQueryTarget(s.targetId)||await Ip(i.localStore,s.targetId,!1).then(()=>{i.sharedClientState.clearQueryState(s.targetId),n&&Hp(i.remoteStore,s.targetId),Xg(i,s.targetId)}).catch(kl)):(Xg(i,s.targetId),await Ip(i.localStore,s.targetId,!0))}async function zg(e,t){const n=el(e),i=n.Fa.get(t),s=n.Ma.get(i.targetId);n.isPrimaryClient&&1===s.length&&(n.sharedClientState.removeLocalQueryTarget(i.targetId),Hp(n.remoteStore,i.targetId))}async function $g(e,t,n){const i=function(e){const t=el(e);return t.remoteStore.remoteSyncer.applySuccessfulWrite=Gg.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=Qg.bind(null,t),t}(e);try{const e=await function(e,t){const n=el(e),i=ml.now(),s=t.reduce((e,t)=>e.add(t.key),gd());let r,o;return n.persistence.runTransaction("Locally write mutations","readwrite",e=>{let a=od(),c=gd();return n.cs.getEntries(e,s).next(e=>{a=e,a.forEach((e,t)=>{t.isValidDocument()||(c=c.add(e))})}).next(()=>n.localDocuments.getOverlayedDocuments(e,a)).next(s=>{r=s;const o=[];for(const e of t){const t=qd(e,r.get(e.key).overlayedDocument);null!=t&&o.push(new zd(e.key,t,mu(t.value.mapValue),Od.exists(!0)))}return n.mutationQueue.addMutationBatch(e,i,o,t)}).next(t=>{o=t;const i=t.applyToLocalDocumentSet(r,c);return n.documentOverlayCache.saveOverlays(e,t.batchId,i)})}).then(()=>({batchId:o.batchId,changes:hd(r)}))}(i.localStore,t);i.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let i=e.Ba[e.currentUser.toKey()];i||(i=new Ml(pl)),i=i.insert(t,n),e.Ba[e.currentUser.toKey()]=i}(i,e.batchId,n),await im(i,e.changes),await rg(i.remoteStore)}catch(s){const e=yg(s,"Failed to persist write");n.reject(e)}}async function Wg(e,t){const n=el(e);try{const e=await wp(n.localStore,t);t.targetChanges.forEach((e,t)=>{const i=n.Na.get(t);i&&(Zh(e.addedDocuments.size+e.modifiedDocuments.size+e.removedDocuments.size<=1),e.addedDocuments.size>0?i.va=!0:e.modifiedDocuments.size>0?Zh(i.va):e.removedDocuments.size>0&&(Zh(i.va),i.va=!1))}),await im(n,e,t)}catch(i){await kl(i)}}function Hg(e,t,n){const i=el(e);if(i.isPrimaryClient&&0===n||!i.isPrimaryClient&&1===n){const e=[];i.Fa.forEach((n,i)=>{const s=i.view.Z_(t);s.snapshot&&e.push(s.snapshot)}),function(e,t){const n=el(e);n.onlineState=t;let i=!1;n.queries.forEach((e,n)=>{for(const s of n.j_)s.Z_(t)&&(i=!0)}),i&&Ag(n)}(i.eventManager,t),e.length&&i.Ca.d_(e),i.onlineState=t,i.isPrimaryClient&&i.sharedClientState.setOnlineState(t)}}async function Kg(e,t,n){const i=el(e);i.sharedClientState.updateQueryState(t,"rejected",n);const s=i.Na.get(t),r=s&&s.key;if(r){let e=new Ml(Il.comparator);e=e.insert(r,_u.newNoDocument(r,_l.min()));const n=gd().add(r),s=new cf(_l.min(),new Map,new Ml(pl),e,n);await Wg(i,s),i.Oa=i.Oa.remove(r),i.Na.delete(t),nm(i)}else await Ip(i.localStore,t,!1).then(()=>Xg(i,t,n)).catch(kl)}async function Gg(e,t){const n=el(e),i=t.batch.batchId;try{const e=await function(e,t){const n=el(e);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",e=>{const i=t.batch.keys(),s=n.cs.newChangeBuffer({trackRemovals:!0});return function(e,t,n,i){const s=n.batch,r=s.keys();let o=Nl.resolve();return r.forEach(e=>{o=o.next(()=>i.getEntry(t,e)).next(t=>{const r=n.docVersions.get(e);Zh(null!==r),t.version.compareTo(r)<0&&(s.applyToRemoteDocument(t,n),t.isValidDocument()&&(t.setReadTime(n.commitVersion),i.addEntry(t)))})}),o.next(()=>e.mutationQueue.removeMutationBatch(t,s))}(n,e,t,s).next(()=>s.apply(e)).next(()=>n.mutationQueue.performConsistencyCheck(e)).next(()=>n.documentOverlayCache.removeOverlaysForBatchId(e,i,t.batch.batchId)).next(()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,function(e){let t=gd();for(let n=0;n<e.mutationResults.length;++n)e.mutationResults[n].transformResults.length>0&&(t=t.add(e.batch.mutations[n].key));return t}(t))).next(()=>n.localDocuments.getDocuments(e,i))})}(n.localStore,t);Jg(n,i,null),Yg(n,i),n.sharedClientState.updateMutationState(i,"acknowledged"),await im(n,e)}catch(s){await kl(s)}}async function Qg(e,t,n){const i=el(e);try{const e=await function(e,t){const n=el(e);return n.persistence.runTransaction("Reject batch","readwrite-primary",e=>{let i;return n.mutationQueue.lookupMutationBatch(e,t).next(t=>(Zh(null!==t),i=t.keys(),n.mutationQueue.removeMutationBatch(e,t))).next(()=>n.mutationQueue.performConsistencyCheck(e)).next(()=>n.documentOverlayCache.removeOverlaysForBatchId(e,i,t)).next(()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,i)).next(()=>n.localDocuments.getDocuments(e,i))})}(i.localStore,t);Jg(i,t,n),Yg(i,t),i.sharedClientState.updateMutationState(t,"rejected",n),await im(i,e)}catch(s){await kl(s)}}function Yg(e,t){(e.ka.get(t)||[]).forEach(e=>{e.resolve()}),e.ka.delete(t)}function Jg(e,t,n){const i=el(e);let s=i.Ba[i.currentUser.toKey()];if(s){const e=s.get(t);e&&(n?e.reject(n):e.resolve(),s=s.remove(t)),i.Ba[i.currentUser.toKey()]=s}}function Xg(e,t,n=null){e.sharedClientState.removeLocalQueryTarget(t);for(const i of e.Ma.get(t))e.Fa.delete(i),n&&e.Ca.$a(i,n);e.Ma.delete(t),e.isPrimaryClient&&e.La.gr(t).forEach(t=>{e.La.containsKey(t)||Zg(e,t)})}function Zg(e,t){e.xa.delete(t.path.canonicalString());const n=e.Oa.get(t);null!==n&&(Hp(e.remoteStore,n),e.Oa=e.Oa.remove(t),e.Na.delete(n),nm(e))}function em(e,t,n){for(const i of n)i instanceof xg?(e.La.addReference(i.key,t),tm(e,i)):i instanceof Og?(Gh("SyncEngine","Document no longer in limbo: "+i.key),e.La.removeReference(i.key,t),e.La.containsKey(i.key)||Zg(e,i.key)):Xh()}function tm(e,t){const n=t.key,i=n.path.canonicalString();e.Oa.get(n)||e.xa.has(i)||(Gh("SyncEngine","New document in limbo: "+n),e.xa.add(i),nm(e))}function nm(e){for(;e.xa.size>0&&e.Oa.size<e.maxConcurrentLimboResolutions;){const t=e.xa.values().next().value;e.xa.delete(t);const n=new Il(vl.fromString(t)),i=e.qa.next();e.Na.set(i,new Fg(n)),e.Oa=e.Oa.insert(n,i),Wp(e.remoteStore,new Kf(Qu(Wu(n.path)),i,"TargetPurposeLimboResolution",Rl.oe))}}async function im(e,t,n){const i=el(e),s=[],r=[],o=[];i.Fa.isEmpty()||(i.Fa.forEach((e,a)=>{o.push(i.Ka(a,t,n).then(e=>{var t;if((e||n)&&i.isPrimaryClient){const s=e?!e.fromCache:null===(t=null==n?void 0:n.targetChanges.get(a.targetId))||void 0===t?void 0:t.current;i.sharedClientState.updateQueryState(a.targetId,s?"current":"not-current")}if(e){s.push(e);const t=pp.Wi(a.targetId,e);r.push(t)}}))}),await Promise.all(o),i.Ca.d_(s),await async function(e,t){const n=el(e);try{await n.persistence.runTransaction("notifyLocalViewChanges","readwrite",e=>Nl.forEach(t,t=>Nl.forEach(t.$i,i=>n.persistence.referenceDelegate.addReference(e,t.targetId,i)).next(()=>Nl.forEach(t.Ui,i=>n.persistence.referenceDelegate.removeReference(e,t.targetId,i)))))}catch(i){if(!Al(i))throw i;Gh("LocalStore","Failed to update sequence numbers: "+i)}for(const s of t){const e=s.targetId;if(!s.fromCache){const t=n.os.get(e),i=t.snapshotVersion,s=t.withLastLimboFreeSnapshotVersion(i);n.os=n.os.insert(e,s)}}}(i.localStore,r))}async function sm(e,t){const n=el(e);if(!n.currentUser.isEqual(t)){Gh("SyncEngine","User change. New user:",t.toKey());const e=await yp(n.localStore,t);n.currentUser=t,s="'waitForPendingWrites' promise is rejected due to a user change.",(i=n).ka.forEach(e=>{e.forEach(e=>{e.reject(new nl(tl.CANCELLED,s))})}),i.ka.clear(),n.sharedClientState.handleUserChange(t,e.removedBatchIds,e.addedBatchIds),await im(n,e.hs)}var i,s}function rm(e,t){const n=el(e),i=n.Na.get(t);if(i&&i.va)return gd().add(i.key);{let e=gd();const i=n.Ma.get(t);if(!i)return e;for(const t of i){const i=n.Fa.get(t);e=e.unionWith(i.view.Va)}return e}}function om(e){const t=el(e);return t.remoteStore.remoteSyncer.applyRemoteEvent=Wg.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=rm.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=Kg.bind(null,t),t.Ca.d_=kg.bind(null,t.eventManager),t.Ca.$a=Ng.bind(null,t.eventManager),t}class am{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Lp(e.databaseInfo.databaseId),this.sharedClientState=this.Wa(e),this.persistence=this.Ga(e),await this.persistence.start(),this.localStore=this.za(e),this.gcScheduler=this.ja(e,this.localStore),this.indexBackfillerScheduler=this.Ha(e,this.localStore)}ja(e,t){return null}Ha(e,t){return null}za(e){return function(e,t,n,i){return new _p(e,t,n,i)}(this.persistence,new mp,e.initialUser,this.serializer)}Ga(e){return new up(fp.Zr,this.serializer)}Wa(e){return new Ep}async terminate(){var e,t;null===(e=this.gcScheduler)||void 0===e||e.stop(),null===(t=this.indexBackfillerScheduler)||void 0===t||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}am.provider={build:()=>new am};class cm{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=e=>Hg(this.syncEngine,e,1),this.remoteStore.remoteSyncer.handleCredentialChange=sm.bind(null,this.syncEngine),await async function(e,t){const n=el(e);t?(n.L_.delete(2),await zp(n)):t||(n.L_.add(2),await $p(n),n.q_.set("Unknown"))}(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return new bg}createDatastore(e){const t=Lp(e.databaseInfo.databaseId),n=(i=e.databaseInfo,new xp(i));var i;return function(e,t,n,i){return new qp(e,t,n,i)}(e.authCredentials,e.appCheckCredentials,n,t)}createRemoteStore(e){return t=this.localStore,n=this.datastore,i=e.asyncQueue,s=e=>Hg(this.syncEngine,e,0),r=kp.D()?new kp:new Sp,new Bp(t,n,i,s,r);var t,n,i,s,r}createSyncEngine(e,t){return function(e,t,n,i,s,r,o){const a=new Ug(e,t,n,i,s,r);return o&&(a.Qa=!0),a}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(e){const t=el(e);Gh("RemoteStore","RemoteStore shutting down."),t.L_.add(5),await $p(t),t.k_.shutdown(),t.q_.set("Unknown")}(this.remoteStore),null===(e=this.datastore)||void 0===e||e.terminate(),null===(t=this.eventManager)||void 0===t||t.terminate()}}cm.provider={build:()=>new cm};
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * limitations under the License.
   */
class hm{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ya(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ya(this.observer.error,e):Qh("Uncaught Error in snapshot listener:",e.toString()))}Za(){this.muted=!0}Ya(e,t){setTimeout(()=>{this.muted||e(t)},0)}}
/**
   * @license
   * Copyright 2017 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class lm{constructor(e,t,n,i,s){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=n,this.databaseInfo=i,this.user=$h.UNAUTHENTICATED,this.clientId=fl.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=s,this.authCredentials.start(n,async e=>{Gh("FirestoreClient","Received user=",e.uid),await this.authCredentialListener(e),this.user=e}),this.appCheckCredentials.start(n,e=>(Gh("FirestoreClient","Received new app check token=",e),this.appCheckCredentialListener(e,this.user)))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new il;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const n=yg(t,"Failed to shutdown persistence");e.reject(n)}}),e.promise}}async function um(e,t){e.asyncQueue.verifyOperationInProgress(),Gh("FirestoreClient","Initializing OfflineComponentProvider");const n=e.configuration;await t.initialize(n);let i=n.initialUser;e.setCredentialChangeListener(async e=>{i.isEqual(e)||(await yp(t.localStore,e),i=e)}),t.persistence.setDatabaseDeletedListener(()=>e.terminate()),e._offlineComponents=t}async function dm(e,t){e.asyncQueue.verifyOperationInProgress();const n=await async function(e){if(!e._offlineComponents)if(e._uninitializedComponentsProvider){Gh("FirestoreClient","Using user provided OfflineComponentProvider");try{await um(e,e._uninitializedComponentsProvider._offline)}catch(t){const s=t;if(!("FirebaseError"===(n=s).name?n.code===tl.FAILED_PRECONDITION||n.code===tl.UNIMPLEMENTED:!("undefined"!=typeof DOMException&&n instanceof DOMException)||22===n.code||20===n.code||11===n.code))throw s;Yh("Error using user provided cache. Falling back to memory cache: "+s),await um(e,new am)}}else Gh("FirestoreClient","Using default OfflineComponentProvider"),await um(e,new am);var n;return e._offlineComponents}(e);Gh("FirestoreClient","Initializing OnlineComponentProvider"),await t.initialize(n,e.configuration),e.setCredentialChangeListener(e=>pg(t.remoteStore,e)),e.setAppCheckTokenChangeListener((e,n)=>pg(t.remoteStore,n)),e._onlineComponents=t}async function fm(e){return e._onlineComponents||(e._uninitializedComponentsProvider?(Gh("FirestoreClient","Using user provided OnlineComponentProvider"),await dm(e,e._uninitializedComponentsProvider._online)):(Gh("FirestoreClient","Using default OnlineComponentProvider"),await dm(e,new cm))),e._onlineComponents}async function pm(e){const t=await fm(e),n=t.eventManager;return n.onListen=Vg.bind(null,t.syncEngine),n.onUnlisten=Bg.bind(null,t.syncEngine),n.onFirstRemoteStoreListen=qg.bind(null,t.syncEngine),n.onLastRemoteStoreUnlisten=zg.bind(null,t.syncEngine),n}
/**
   * @license
   * Copyright 2023 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function _m(e,t,n){if(!n)throw new nl(tl.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}function ym(e){if(!Il.isDocumentKey(e))throw new nl(tl.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${e} has ${e.length}.`)}function vm(e){if(Il.isDocumentKey(e))throw new nl(tl.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`)}function wm(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";{const n=(t=e).constructor?t.constructor.name:null;return n?`a custom ${n} object`:"an object"}}var t;return"function"==typeof e?"a function":Xh()}function Tm(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new nl(tl.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=wm(e);throw new nl(tl.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${n}`)}}return e}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * limitations under the License.
   */
class Im{constructor(e){var t,n;if(void 0===e.host){if(void 0!==e.ssl)throw new nl(tl.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=null===(t=e.ssl)||void 0===t||t;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,void 0===e.cacheSizeBytes)this.cacheSizeBytes=41943040;else{if(-1!==e.cacheSizeBytes&&e.cacheSizeBytes<1048576)throw new nl(tl.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}(function(e,t,n,i){if(!0===t&&!0===i)throw new nl(tl.INVALID_ARGUMENT,`${e} and ${n} cannot be used together.`)})("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:void 0===e.experimentalAutoDetectLongPolling?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=gm(null!==(n=e.experimentalLongPollingOptions)&&void 0!==n?n:{}),function(e){if(void 0!==e.timeoutSeconds){if(isNaN(e.timeoutSeconds))throw new nl(tl.INVALID_ARGUMENT,`invalid long polling timeout: ${e.timeoutSeconds} (must not be NaN)`);if(e.timeoutSeconds<5)throw new nl(tl.INVALID_ARGUMENT,`invalid long polling timeout: ${e.timeoutSeconds} (minimum allowed value is 5)`);if(e.timeoutSeconds>30)throw new nl(tl.INVALID_ARGUMENT,`invalid long polling timeout: ${e.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&(t=this.experimentalLongPollingOptions,n=e.experimentalLongPollingOptions,t.timeoutSeconds===n.timeoutSeconds)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams;var t,n}}class bm{constructor(e,t,n,i){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=n,this._app=i,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Im({}),this._settingsFrozen=!1,this._terminateTask="notTerminated"}get app(){if(!this._app)throw new nl(tl.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return"notTerminated"!==this._terminateTask}_setSettings(e){if(this._settingsFrozen)throw new nl(tl.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Im(e),void 0!==e.credentials&&(this._authCredentials=function(e){if(!e)return new rl;switch(e.type){case"firstParty":return new hl(e.sessionIndex||"0",e.iamToken||null,e.authTokenFactory||null);case"provider":return e.client;default:throw new nl(tl.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return"notTerminated"===this._terminateTask&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){"notTerminated"===this._terminateTask?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(e){const t=mm.get(e);t&&(Gh("ComponentProvider","Removing Datastore"),mm.delete(e),t.terminate())}(this),Promise.resolve()}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * limitations under the License.
   */
class Cm{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new Cm(this.firestore,e,this._query)}}class Em{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Sm(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Em(this.firestore,e,this._key)}}class Sm extends Cm{constructor(e,t,n){super(e,t,Wu(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Em(this.firestore,null,new Il(e))}withConverter(e){return new Sm(this.firestore,e,this._path)}}function km(e,t,...n){if(e=z(e),_m("collection","path",t),e instanceof bm){const i=vl.fromString(t,...n);return vm(i),new Sm(e,null,i)}{if(!(e instanceof Em||e instanceof Sm))throw new nl(tl.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=e._path.child(vl.fromString(t,...n));return vm(i),new Sm(e.firestore,null,i)}}function Nm(e,t,...n){if(e=z(e),1===arguments.length&&(t=fl.newId()),_m("doc","path",t),e instanceof bm){const i=vl.fromString(t,...n);return ym(i),new Em(e,null,new Il(i))}{if(!(e instanceof Em||e instanceof Sm))throw new nl(tl.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=e._path.child(vl.fromString(t,...n));return ym(i),new Em(e.firestore,e instanceof Sm?e.converter:null,new Il(i))}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Am{constructor(e=Promise.resolve()){this.Pu=[],this.Iu=!1,this.Tu=[],this.Eu=null,this.du=!1,this.Au=!1,this.Ru=[],this.t_=new Mp(this,"async_queue_retry"),this.Vu=()=>{const e=Op();e&&Gh("AsyncQueue","Visibility state changed to "+e.visibilityState),this.t_.jo()},this.mu=e;const t=Op();t&&"function"==typeof t.addEventListener&&t.addEventListener("visibilitychange",this.Vu)}get isShuttingDown(){return this.Iu}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.fu(),this.gu(e)}enterRestrictedMode(e){if(!this.Iu){this.Iu=!0,this.Au=e||!1;const t=Op();t&&"function"==typeof t.removeEventListener&&t.removeEventListener("visibilitychange",this.Vu)}}enqueue(e){if(this.fu(),this.Iu)return new Promise(()=>{});const t=new il;return this.gu(()=>this.Iu&&this.Au?Promise.resolve():(e().then(t.resolve,t.reject),t.promise)).then(()=>t.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Pu.push(e),this.pu()))}async pu(){if(0!==this.Pu.length){try{await this.Pu[0](),this.Pu.shift(),this.t_.reset()}catch(e){if(!Al(e))throw e;Gh("AsyncQueue","Operation failed with retryable error: "+e)}this.Pu.length>0&&this.t_.Go(()=>this.pu())}}gu(e){const t=this.mu.then(()=>(this.du=!0,e().catch(e=>{this.Eu=e,this.du=!1;throw Qh("INTERNAL UNHANDLED ERROR: ",function(e){let t=e.message||"";return e.stack&&(t=e.stack.includes(e.message)?e.stack:e.message+"\n"+e.stack),t}(e)),e}).then(e=>(this.du=!1,e))));return this.mu=t,t}enqueueAfterDelay(e,t,n){this.fu(),this.Ru.indexOf(e)>-1&&(t=0);const i=_g.createAndSchedule(this,e,t,n,e=>this.yu(e));return this.Tu.push(i),i}fu(){this.Eu&&Xh()}verifyOperationInProgress(){}async wu(){let e;do{e=this.mu,await e}while(e!==this.mu)}Su(e){for(const t of this.Tu)if(t.timerId===e)return!0;return!1}bu(e){return this.wu().then(()=>{this.Tu.sort((e,t)=>e.targetTimeMs-t.targetTimeMs);for(const t of this.Tu)if(t.skipDelay(),"all"!==e&&t.timerId===e)break;return this.wu()})}Du(e){this.Ru.push(e)}yu(e){const t=this.Tu.indexOf(e);this.Tu.splice(t,1)}}function Rm(e){return function(e,t){if("object"!=typeof e||null===e)return!1;const n=e;for(const i of t)if(i in n&&"function"==typeof n[i])return!0;return!1}(e,["next","error","complete"])}class Pm extends bm{constructor(e,t,n,i){super(e,t,n,i),this.type="firestore",this._queue=new Am,this._persistenceKey=(null==i?void 0:i.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Am(e),this._firestoreClient=void 0,await e}}}function Dm(e){if(e._terminated)throw new nl(tl.FAILED_PRECONDITION,"The client has already been terminated.");return e._firestoreClient||function(e){var t,n,i;const s=e._freezeSettings(),r=(o=e._databaseId,a=(null===(t=e._app)||void 0===t?void 0:t.options.appId)||"",c=e._persistenceKey,h=s,new Jl(o,a,c,h.host,h.ssl,h.experimentalForceLongPolling,h.experimentalAutoDetectLongPolling,gm(h.experimentalLongPollingOptions),h.useFetchStreams));var o,a,c,h;e._componentsProvider||(null===(n=s.localCache)||void 0===n?void 0:n._offlineComponentProvider)&&(null===(i=s.localCache)||void 0===i?void 0:i._onlineComponentProvider)&&(e._componentsProvider={_offline:s.localCache._offlineComponentProvider,_online:s.localCache._onlineComponentProvider}),e._firestoreClient=new lm(e._authCredentials,e._appCheckCredentials,e._queue,r,e._componentsProvider&&function(e){const t=null==e?void 0:e._online.build();return{_offline:null==e?void 0:e._offline.build(t),_online:t}}(e._componentsProvider))}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */(e),e._firestoreClient}class xm{constructor(e){this._byteString=e}static fromBase64String(e){try{return new xm(zl.fromBase64String(e))}catch(t){throw new nl(tl.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new xm(zl.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Om{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new nl(tl.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Tl(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class Mm{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new nl(tl.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new nl(tl.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return pl(this._lat,e._lat)||pl(this._long,e._long)}}
/**
   * @license
   * Copyright 2024 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const Um=/^__.*__$/;class Vm{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return null!==this.fieldMask?new zd(e,this.data,this.fieldMask,t,this.fieldTransforms):new Bd(e,this.data,t,this.fieldTransforms)}}class qm{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new zd(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function jm(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Xh()}}class Bm{constructor(e,t,n,i,s,r){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=i,void 0===s&&this.vu(),this.fieldTransforms=s||[],this.fieldMask=r||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(e){return new Bm(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),i=this.Fu({path:n,xu:!1});return i.Ou(e),i}Nu(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),i=this.Fu({path:n,xu:!1});return i.vu(),i}Lu(e){return this.Fu({path:void 0,xu:!0})}Bu(e){return i_(e,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}vu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Ou(this.path.get(e))}Ou(e){if(0===e.length)throw this.Bu("Document fields must not be empty");if(jm(this.Cu)&&Um.test(e))throw this.Bu('Document fields cannot begin and end with "__"')}}class zm{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||Lp(e)}Qu(e,t,n,i=!1){return new Bm({Cu:e,methodName:t,qu:n,path:Tl.emptyPath(),xu:!1,ku:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function $m(e){const t=e._freezeSettings(),n=Lp(e._databaseId);return new zm(e._databaseId,!!t.ignoreUndefinedProperties,n)}function Wm(e,t,n,i,s,r={}){const o=e.Qu(r.merge||r.mergeFields?2:0,t,n,s);Zm("Data must be an object, but it was:",o,i);const a=Jm(i,o);let c,h;if(r.merge)c=new jl(o.fieldMask),h=o.fieldTransforms;else if(r.mergeFields){const e=[];for(const i of r.mergeFields){const s=e_(t,i,n);if(!o.contains(s))throw new nl(tl.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);s_(e,s)||e.push(s)}c=new jl(e),h=o.fieldTransforms.filter(e=>c.covers(e.field))}else c=null,h=o.fieldTransforms;return new Vm(new gu(a),c,h)}class Hm extends Lm{_toFieldTransform(e){if(2!==e.Cu)throw 1===e.Cu?e.Bu(`${this._methodName}() can only appear at the top level of your update data`):e.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Hm}}class Km extends Lm{_toFieldTransform(e){return new Dd(e.path,new Cd)}isEqual(e){return e instanceof Km}}function Gm(e,t,n,i){const s=e.Qu(1,t,n);Zm("Data must be an object, but it was:",s,i);const r=[],o=gu.empty();Ol(i,(e,i)=>{const a=n_(t,e,n);i=z(i);const c=s.Nu(a);if(i instanceof Hm)r.push(a);else{const e=Ym(i,c);null!=e&&(r.push(a),o.set(a,e))}});const a=new jl(r);return new qm(o,a,s.fieldTransforms)}function Qm(e,t,n,i,s,r){const o=e.Qu(1,t,n),a=[e_(t,i,n)],c=[s];if(r.length%2!=0)throw new nl(tl.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let d=0;d<r.length;d+=2)a.push(e_(t,r[d])),c.push(r[d+1]);const h=[],l=gu.empty();for(let d=a.length-1;d>=0;--d)if(!s_(h,a[d])){const e=a[d];let t=c[d];t=z(t);const n=o.Nu(e);if(t instanceof Hm)h.push(e);else{const i=Ym(t,n);null!=i&&(h.push(e),l.set(e,i))}}const u=new jl(h);return new qm(l,u,o.fieldTransforms)}function Ym(e,t){if(Xm(e=z(e)))return Zm("Unsupported field value:",t,e),Jm(e,t);if(e instanceof Lm)return function(e,t){if(!jm(t.Cu))throw t.Bu(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.Bu(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.xu&&4!==t.Cu)throw t.Bu("Nested arrays are not supported");return function(e,t){const n=[];let i=0;for(const s of e){let e=Ym(s,t.Lu(i));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),i++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=z(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return vd(t.serializer,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=ml.fromDate(e);return{timestampValue:If(t.serializer,n)}}if(e instanceof ml){const n=new ml(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:If(t.serializer,n)}}if(e instanceof Mm)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof xm)return{bytesValue:bf(t.serializer,e._byteString)};if(e instanceof Em){const n=t.databaseId,i=e.firestore._databaseId;if(!i.isEqual(n))throw t.Bu(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:Sf(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof Fm)return n=t,{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:e.toArray().map(e=>{if("number"!=typeof e)throw n.Bu("VectorValues must only contain numeric values.");return _d(n.serializer,e)})}}}}};var n;throw t.Bu(`Unsupported field value: ${wm(e)}`)}(e,t)}function Jm(e,t){const n={};return Ll(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):Ol(e,(e,i)=>{const s=Ym(i,t.Mu(e));null!=s&&(n[e]=s)}),{mapValue:{fields:n}}}function Xm(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof ml||e instanceof Mm||e instanceof xm||e instanceof Em||e instanceof Lm||e instanceof Fm)}function Zm(e,t,n){if(!Xm(n)||("object"!=typeof(i=n)||null===i||Object.getPrototypeOf(i)!==Object.prototype&&null!==Object.getPrototypeOf(i))){const i=wm(n);throw"an object"===i?t.Bu(e+" a custom object"):t.Bu(e+" "+i)}var i}function e_(e,t,n){if((t=z(t))instanceof Om)return t._internalPath;if("string"==typeof t)return n_(e,t);throw i_("Field path arguments must be of type string or ",e,!1,void 0,n)}const t_=new RegExp("[~\\*/\\[\\]]");function n_(e,t,n){if(t.search(t_)>=0)throw i_(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new Om(...t.split("."))._internalPath}catch(i){throw i_(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function i_(e,t,n,i,s){const r=i&&!i.isEmpty(),o=void 0!==s;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(r||o)&&(c+=" (found",r&&(c+=` in field ${i}`),o&&(c+=` in document ${s}`),c+=")"),new nl(tl.INVALID_ARGUMENT,a+e+c)}function s_(e,t){return e.some(e=>e.isEqual(t))}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class r_{constructor(e,t,n,i,s){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=i,this._converter=s}get id(){return this._key.path.lastSegment()}get ref(){return new Em(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const e=new o_(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(a_("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class o_ extends r_{data(){return super.data()}}function a_(e,t){return"string"==typeof t?n_(e,t):t instanceof Om?t._internalPath:t._delegate._internalPath}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function c_(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new nl(tl.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class h_{}class l_ extends h_{}class u_ extends l_{constructor(e,t,n){super(),this._field=e,this._op=t,this._value=n,this.type="where"}static _create(e,t,n){return new u_(e,t,n)}_apply(e){const t=this._parse(e);return w_(e._query,t),new Cm(e.firestore,e.converter,Yu(e._query,t))}_parse(e){const t=$m(e.firestore),n=function(e,t,n,i,s,r,o){let a;if(s.isKeyField()){if("array-contains"===r||"array-contains-any"===r)throw new nl(tl.INVALID_ARGUMENT,`Invalid Query. You can't perform '${r}' queries on documentId().`);if("in"===r||"not-in"===r){v_(o,r);const t=[];for(const n of o)t.push(y_(i,e,n));a={arrayValue:{values:t}}}else a=y_(i,e,o)}else"in"!==r&&"not-in"!==r&&"array-contains-any"!==r||v_(o,r),a=function(e,t,n,i=!1){return Ym(n,e.Qu(i?4:3,t))}(n,t,o,"in"===r||"not-in"===r);return Cu.create(s,r,a)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value);return n}}function d_(e,t,n){const i=t,s=a_("where",e);return u_._create(s,i,n)}class f_ extends h_{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new f_(e,t)}_parse(e){const t=this._queryConstraints.map(t=>t._parse(e)).filter(e=>e.getFilters().length>0);return 1===t.length?t[0]:Eu.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return 0===t.getFilters().length?e:(function(e,t){let n=e;const i=t.getFlattenedFilters();for(const s of i)w_(n,s),n=Yu(n,s)}(e._query,t),new Cm(e.firestore,e.converter,Yu(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return"and"===this.type?"and":"or"}}class p_ extends l_{constructor(e,t){super(),this._field=e,this._direction=t,this.type="orderBy"}static _create(e,t){return new p_(e,t)}_apply(e){const t=function(e,t,n){if(null!==e.startAt)throw new nl(tl.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(null!==e.endAt)throw new nl(tl.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new Tu(t,n)}(e._query,this._field,this._direction);return new Cm(e.firestore,e.converter,function(e,t){const n=e.explicitOrderBy.concat([t]);return new $u(e.path,e.collectionGroup,n,e.filters.slice(),e.limit,e.limitType,e.startAt,e.endAt)}(e._query,t))}}function g_(e,t="asc"){const n=t,i=a_("orderBy",e);return p_._create(i,n)}class m_ extends l_{constructor(e,t,n){super(),this.type=e,this._limit=t,this._limitType=n}static _create(e,t,n){return new m_(e,t,n)}_apply(e){return new Cm(e.firestore,e.converter,Ju(e._query,this._limit,this._limitType))}}function __(e){return function(e,t){if(t<=0)throw new nl(tl.INVALID_ARGUMENT,`Function ${e}() requires a positive number, but it was: ${t}.`)}("limit",e),m_._create("limit",e,"F")}function y_(e,t,n){if("string"==typeof(n=z(n))){if(""===n)throw new nl(tl.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!Ku(t)&&-1!==n.indexOf("/"))throw new nl(tl.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);const i=t.path.child(vl.fromString(n));if(!Il.isDocumentKey(i))throw new nl(tl.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${i}' is not because it has an odd number of segments (${i.length}).`);return cu(e,new Il(i))}if(n instanceof Em)return cu(e,n._key);throw new nl(tl.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${wm(n)}.`)}function v_(e,t){if(!Array.isArray(e)||0===e.length)throw new nl(tl.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${t.toString()}' filters.`)}function w_(e,t){const n=function(e,t){for(const n of e)for(const e of n.getFlattenedFilters())if(t.indexOf(e.op)>=0)return e.op;return null}(e.filters,function(e){switch(e){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(t.op));if(null!==n)throw n===t.op?new nl(tl.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${t.op.toString()}' filter.`):new nl(tl.INVALID_ARGUMENT,`Invalid query. You cannot use '${t.op.toString()}' filters with '${n.toString()}' filters.`)}class T_{convertValue(e,t="none"){switch(eu(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Hl(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(Kl(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw Xh()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const n={};return Ol(e,(e,i)=>{n[e]=this.convertValue(i,t)}),n}convertVectorValue(e){var t,n,i;const s=null===(i=null===(n=null===(t=e.fields)||void 0===t?void 0:t.value.arrayValue)||void 0===n?void 0:n.values)||void 0===i?void 0:i.map(e=>Hl(e.doubleValue));return new Fm(s)}convertGeoPoint(e){return new Mm(Hl(e.latitude),Hl(e.longitude))}convertArray(e,t){return(e.values||[]).map(e=>this.convertValue(e,t))}convertServerTimestamp(e,t){switch(t){case"previous":const n=Ql(e);return null==n?null:this.convertValue(n,t);case"estimate":return this.convertTimestamp(Yl(e));default:return null}}convertTimestamp(e){const t=Wl(e);return new ml(t.seconds,t.nanos)}convertDocumentKey(e,t){const n=vl.fromString(e);Zh(Hf(n));const i=new Xl(n.get(1),n.get(3)),s=new Il(n.popFirst(5));return i.isEqual(t)||Qh(`Document ${s} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),s}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */}class b_{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class C_ extends r_{constructor(e,t,n,i,s,r){super(e,t,n,i,r),this._firestore=e,this._firestoreImpl=e,this.metadata=s}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new E_(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(a_("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class E_ extends C_{data(e={}){return super.data(e)}}class S_{constructor(e,t,n,i){this._firestore=e,this._userDataWriter=t,this._snapshot=i,this.metadata=new b_(i.hasPendingWrites,i.fromCache),this.query=n}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(n=>{e.call(t,new E_(this._firestore,this._userDataWriter,n.key,n,new b_(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new nl(tl.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(n=>{const i=new E_(e._firestore,e._userDataWriter,n.doc.key,n.doc,new b_(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter);return n.doc,{type:"added",doc:i,oldIndex:-1,newIndex:t++}})}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{const i=new E_(e._firestore,e._userDataWriter,t.doc.key,t.doc,new b_(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter);let s=-1,r=-1;return 0!==t.type&&(s=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(n=n.add(t.doc),r=n.indexOf(t.doc.key)),{type:k_(t.type),doc:i,oldIndex:s,newIndex:r}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function k_(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Xh()}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function N_(e){e=Tm(e,Em);const t=Tm(e.firestore,Pm);return function(e,t,n={}){const i=new il;return e.asyncQueue.enqueueAndForget(async()=>function(e,t,n,i,s){const r=new hm({next:a=>{r.Za(),t.enqueueAndForget(()=>Sg(e,o));const c=a.docs.has(n);!c&&a.fromCache?s.reject(new nl(tl.UNAVAILABLE,"Failed to get document because the client is offline.")):c&&a.fromCache&&i&&"server"===i.source?s.reject(new nl(tl.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):s.resolve(a)},error:e=>s.reject(e)}),o=new Dg(Wu(n.path),r,{includeMetadataChanges:!0,_a:!0});return Eg(e,o)}(await pm(e),e.asyncQueue,t,n,i)),i.promise}(Dm(t),e._key).then(n=>D_(t,e,n))}class A_ extends T_{constructor(e){super(),this.firestore=e}convertBytes(e){return new xm(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Em(this.firestore,null,t)}}function R_(e){e=Tm(e,Cm);const t=Tm(e.firestore,Pm),n=Dm(t),i=new A_(t);return c_(e._query),function(e,t,n={}){const i=new il;return e.asyncQueue.enqueueAndForget(async()=>function(e,t,n,i,s){const r=new hm({next:n=>{r.Za(),t.enqueueAndForget(()=>Sg(e,o)),n.fromCache&&"server"===i.source?s.reject(new nl(tl.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):s.resolve(n)},error:e=>s.reject(e)}),o=new Dg(n,r,{includeMetadataChanges:!0,_a:!0});return Eg(e,o)}(await pm(e),e.asyncQueue,t,n,i)),i.promise}(n,e._query).then(n=>new S_(t,i,e,n))}function P_(e,t){return function(e,t){const n=new il;return e.asyncQueue.enqueueAndForget(async()=>$g(await function(e){return fm(e).then(e=>e.syncEngine)}(e),t,n)),n.promise}(Dm(e),t)}function D_(e,t,n){const i=n.docs.get(t._key),s=new A_(e);return new C_(e,s,t._key,i,new b_(n.hasPendingWrites,n.fromCache),t.converter)}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */class x_{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=$m(e)}set(e,t,n){this._verifyNotCommitted();const i=O_(e,this._firestore),s=I_(i.converter,t,n),r=Wm(this._dataReader,"WriteBatch.set",i._key,s,null!==i.converter,n);return this._mutations.push(r.toMutation(i._key,Od.none())),this}update(e,t,n,...i){this._verifyNotCommitted();const s=O_(e,this._firestore);let r;return r="string"==typeof(t=z(t))||t instanceof Om?Qm(this._dataReader,"WriteBatch.update",s._key,t,n,i):Gm(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(r.toMutation(s._key,Od.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=O_(e,this._firestore);return this._mutations=this._mutations.concat(new Kd(t._key,Od.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new nl(tl.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function O_(e,t){if((e=z(e)).firestore!==t)throw new nl(tl.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */!function(e,t=!0){Wh=st,Ze(new $("firestore",(e,{instanceIdentifier:n,options:i})=>{const s=e.getProvider("app").getImmediate(),r=new Pm(new al(e.getProvider("auth-internal")),new ul(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new nl(tl.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Xl(e.options.projectId,t)}(s,n),s);return i=Object.assign({useFetchStreams:t},i),r._setSettings(i),r},"PUBLIC").setMultipleInstances(!0)),at(zh,"4.7.3",e),at(zh,"4.7.3","esm2017")}();const L_={apiKey:"AIzaSyBs9g8H0lL0SYR0FOs2FLkDAJE2bNTB-GE",authDomain:"efgame-634af.firebaseapp.com",databaseURL:"https://efgame-634af-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"efgame-634af",storageBucket:"efgame-634af.firebasestorage.app",messagingSenderId:"681595552501",appId:"1:681595552501:web:a24cb6e02e0c8063e7bbbc"},M_=rt(L_),F_=function(e=ot()){const t=et(e,"auth");if(t.isInitialized())return t.getImmediate();const n=
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * limitations under the License.
   */
function(e,t){const n=et(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(L(n.getOptions(),null!=t?t:{}))return e;Ct(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Zi,persistence:[pi,Jn,Zn]}),i=y("authTokenSyncURL");if(i&&"boolean"==typeof isSecureContext&&isSecureContext){const e=new URL(i,location.origin);if(location.origin===e.origin){const t=(s=e.toString(),async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>is)return;const i=null==t?void 0:t.token;ss!==i&&(ss=i,await fetch(s,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){z(e).beforeAuthStateChanged(t,n)}(n,t,()=>t(n.currentUser)),function(e,t,n,i){z(e).onIdTokenChanged(t,n,i)}(n,e=>t(e))}}var s;const r=g("auth");return r&&Pn(n,`http://${r}`),n}(M_),U_=function(e=ot(),t){const n=et(e,"database").getImmediate({identifier:t});if(!n._instanceStarted){const e=m("database");e&&function(e,t,n,i={}){e=z(e),e._checkNotDeleted("useEmulator"),e._instanceStarted&&Cs("Cannot call useEmulator() after instance has already been initialized.");const s=e._repoInternal;let r;if(s.repoInfo_.nodeAdmin)i.mockUserToken&&Cs('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new Bs(Bs.OWNER);else if(i.mockUserToken){const t="string"==typeof i.mockUserToken?i.mockUserToken:w(i.mockUserToken,e.app.options.projectId);r=new Bs(t)}!function(e,t,n,i){e.repoInfo_=new Ks(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),i&&(e.authTokenProvider_=i)}(s,t,n,r)}(n,...e)}return n}(M_),V_=function(e){const t="string"==typeof e?e:"(default)",n=et("object"==typeof e?e:ot(),"firestore").getImmediate({identifier:t});if(!n._initialized){const e=m("firestore");e&&function(e,t,n,i={}){var s;const r=(e=Tm(e,bm))._getSettings(),o=`${t}:${n}`;if("firestore.googleapis.com"!==r.host&&r.host!==o&&Yh("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),e._setSettings(Object.assign(Object.assign({},r),{host:o,ssl:!1})),i.mockUserToken){let t,n;if("string"==typeof i.mockUserToken)t=i.mockUserToken,n=$h.MOCK_USER;else{t=w(i.mockUserToken,null===(s=e._app)||void 0===s?void 0:s.options.projectId);const r=i.mockUserToken.sub||i.mockUserToken.user_id;if(!r)throw new nl(tl.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");n=new $h(r)}e._authCredentials=new ol(new sl(t,n))}}(n,...e)}return n}(M_);function q_(e){const t={once:t=>Ih(e).then(e=>j_(e)),on:(t,n)=>"value"===t?function(e,t){return Eh(e,"value",t)}(e,e=>n(j_(e))):"child_added"===t?function(e,t){return Eh(e,"child_added",t)}(e,e=>n(j_(e))):void 0,off(){var t;Yc((t=e)._repo,t,null)},set:t=>wh(e,t),update:t=>Th(e,t),push(t){const n=function(e,t){e=z(e),Oc("push",e._path),Rc("push",t,e._path,!0);const n=$c(e._repo),i=uh(n),s=vh(e,i),r=vh(e,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}(e);return void 0!==t?wh(n,t).then(()=>q_(n)):q_(n)},remove(){return Oc("remove",(t=e)._path),wh(t,null);var t},child:t=>q_(vh(e,t)),ref:e=>q_(yh(U_,e)),_ref:e,key:e.key};return t}function j_(e){return{val:()=>e.val(),exists:()=>e.exists(),key:e.key,ref:q_(e.ref),forEach(t){e.forEach(e=>{t(j_(e))})},numChildren:()=>e.size}}const B_={ref:e=>q_(yh(U_,e))};function z_(e){return{get:()=>N_(e).then(e=>$_(e)),set:(t,n)=>function(e,t,n){e=Tm(e,Em);const i=Tm(e.firestore,Pm),s=I_(e.converter,t,n);return P_(i,[Wm($m(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,Od.none())])}(e,t,n||{}),update:t=>function(e,t,n,...i){e=Tm(e,Em);const s=Tm(e.firestore,Pm),r=$m(s);let o;return o="string"==typeof(t=z(t))||t instanceof Om?Qm(r,"updateDoc",e._key,t,n,i):Gm(r,"updateDoc",e._key,t),P_(s,[o.toMutation(e._key,Od.exists(!0))])}(e,t),delete(){return P_(Tm((t=e).firestore,Pm),[new Kd(t._key,Od.none())]);var t},collection:t=>H_(km(e,t)),get id(){return e.id},get ref(){return e}}}function $_(e){return{data:()=>e.data(),exists:e.exists(),get id(){return e.id},get ref(){return e.ref}}}function W_(e){return{get empty(){return e.empty},get size(){return e.size},get docs(){return e.docs.map(e=>$_(e))},forEach(t){e.forEach(e=>t($_(e)))}}}function H_(e,t){const n=t?[...t]:[],i=e;function s(){return 0===n.length?i:function(e,t,...n){let i=[];t instanceof h_&&i.push(t),i=i.concat(n),function(e){const t=e.filter(e=>e instanceof f_).length,n=e.filter(e=>e instanceof u_).length;if(t>1||t>0&&n>0)throw new nl(tl.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(i);for(const s of i)e=s._apply(e);return e}(i,...n)}return{doc:t=>z_(t?Nm(e,t):Nm(e)),add:t=>function(e,t){const n=Tm(e.firestore,Pm),i=Nm(e),s=I_(e.converter,t);return P_(n,[Wm($m(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,Od.exists(!1))]).then(()=>i)}(e,t).then(e=>z_(e)),get:()=>R_(s()).then(e=>W_(e)),where:(t,i,s)=>H_(e,[...n,d_(t,i,s)]),orderBy:(t,i)=>H_(e,[...n,g_(t,i||"asc")]),limit:t=>H_(e,[...n,__(t)]),onSnapshot:(e,t)=>function(e,...t){var n,i,s;e=z(e);let r={includeMetadataChanges:!1,source:"default"},o=0;"object"!=typeof t[o]||Rm(t[o])||(r=t[o],o++);const a={includeMetadataChanges:r.includeMetadataChanges,source:r.source};if(Rm(t[o])){const e=t[o];t[o]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[o+1]=null===(i=e.error)||void 0===i?void 0:i.bind(e),t[o+2]=null===(s=e.complete)||void 0===s?void 0:s.bind(e)}let c,h,l;if(e instanceof Em)h=Tm(e.firestore,Pm),l=Wu(e._key.path),c={next:n=>{t[o]&&t[o](D_(h,e,n))},error:t[o+1],complete:t[o+2]};else{const n=Tm(e,Cm);h=Tm(n.firestore,Pm),l=n._query;const i=new A_(h);c={next:e=>{t[o]&&t[o](new S_(h,i,n,e))},error:t[o+1],complete:t[o+2]},c_(e._query)}return function(e,t,n,i){const s=new hm(i),r=new Dg(t,s,n);return e.asyncQueue.enqueueAndForget(async()=>Eg(await pm(e),r)),()=>{s.Za(),e.asyncQueue.enqueueAndForget(async()=>Sg(await pm(e),r))}}(Dm(h),l,a,c)}(s(),e?t=>e(W_(t)):void 0,t)}}const K_={collection:e=>H_(km(V_,e)),batch(){const e=(Dm(t=Tm(t=V_,Pm)),new x_(t,e=>P_(t,e)));
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * limitations under the License.
   */
var t;return{delete(t){e.delete(t.ref||t)},set(t,n,i){e.set(t.ref||t,n,i||{})},update(t,n){e.update(t.ref||t,n)},commit:()=>e.commit()}}},G_={signInAnonymously:()=>Wn(F_),signInWithPopup:e=>Ii(F_,e),onAuthStateChanged(e){return t=e,z(F_).onAuthStateChanged(t,n,i);var t,n,i},get currentUser(){return F_.currentUser}};async function Q_(){try{const e=Date.now(),t=B_.ref("rooms"),n=(await t.once("value")).val();if(!n)return;let i=0;const s=[];Object.entries(n).forEach(([n,r])=>{r.expiresAt&&r.expiresAt<e&&(console.log(`🗑️ 刪除過期房間: ${n}`),s.push(t.child(n).remove()),i++)}),await Promise.all(s),i>0&&console.log(`✅ 已清理 ${i} 個過期房間`)}catch(e){console.error("❌ 清理過期房間失敗:",e)}}window.firebaseServices={database:B_,auth:G_,firestore:K_,config:L_},window.firebase={database:()=>B_,auth:()=>G_,firestore:()=>K_,initializeApp(){},auth:Object.assign(function(){return G_},{GoogleAuthProvider:qn}),database:Object.assign(function(){return B_},{ServerValue:{TIMESTAMP:Rh}}),firestore:Object.assign(function(){return K_},{FieldValue:{serverTimestamp:()=>new Km("serverTimestamp"),delete:()=>new Hm("deleteField")}})},G_.signInAnonymously().then(()=>{console.log("✅ 匿名登入成功"),Q_(),setInterval(Q_,6e5)}).catch(e=>{console.error("❌ 匿名登入失敗:",e)}),console.log("🔥 Firebase modular SDK 已載入 (bundle)")}();
