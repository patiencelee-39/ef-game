      ...
      var GameController = (function () {
        ...
        function cacheDom() {
          ...
          dom.comboTransCtr = document.getElementById(
        ...
        function showRuleIntro(combo) {
          ...
          // 標題
          dom.ruleIntroTitle.textContent =
            field.icon + " " + (rule.name || ruleId);
        ...
        /** 玩家按下回應 */
        function onPress() {
          if (!_isPlaying || _isPaused || _responded || dom.btnSpace.disabled)
            return;
        ...
        function _fillTransition(ctr, nextCombo) {
          var prevCombo =
            _comboIndex > 0 ? _combos[_comboIndex - 1] : _combos[0];
        ...
        function _updateDifficultyBadge() {
          ...
          if (_prevDiffLevel > 0 && level !== _prevDiffLevel) {
            ...
            badge.classList.add(
              level > _prevDiffLevel ? "level-up" : "level-down",
            );
          }
        ...
        function bindEvents() {
          ...
          document.addEventListener("keydown", function (e) {
            if (e.code === "Space") {
              ...
              if (
                dom.wmContainer &&
                !dom.wmContainer.classList.contains("hidden")
              ) {
                var wmConfirmBtn =
                  dom.wmContainer.querySelector(".wm-confirm-btn");
